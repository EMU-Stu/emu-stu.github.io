var Tr=Object.defineProperty;var Ar=(a,n,e)=>n in a?Tr(a,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[n]=e;var _=(a,n,e)=>Ar(a,typeof n!="symbol"?n+"":n,e);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function e(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(r){if(r.ep)return;r.ep=!0;const s=e(r);fetch(r.href,s)}})();const Lr="/assets/emu-stu-logo-D3KqYaZd.png",xt=Lr,pn="EMU-Stu",Ft="应急管理大学开源技术组织",Cr="技术服务校园，开源贡献社区",ht="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z",Mr=[{label:"首页",href:"#",active:!0},{label:"技术博客",href:"/blog",active:!1}],Rr="https://github.com/EMU-Stu/EMU-Stu-Site",Zt={related:[{label:"学校官网",href:"https://www.ncist.edu.cn/"},{label:"教务系统",href:"https://jwc.ncist.edu.cn/"},{label:"图书馆",href:"https://lib.ncist.edu.cn/"}],bottom:[{label:"想知道此网站是如何实现的？点击查看文章",href:Rr,underline:!0}]};class Nr extends HTMLElement{constructor(){super(...arguments);_(this,"_menuOpen",!1)}connectedCallback(){this.classList.add("sticky","top-0","z-50","block","w-full"),this.render(),this.setupEventListeners()}render(){const e=window.location.pathname.includes("/blog")||window.location.pathname.includes("/article"),t=Mr.map(i=>{let o=i.href,l=i.active;return e?i.label==="首页"?(o="/",l=!1):i.label==="技术博客"&&(o="#",l=!0):i.label==="首页"?(o="#",l=!0):i.label==="技术博客"&&(o="/blog",l=!1),{label:i.label,href:o,active:l}}),r=t.map(i=>`
      <a
  ...
  `,document.head.appendChild(a)}class Or extends HTMLElement{constructor(){super(...arguments);_(this,"_dialog",null);_(this,"_titleElement",null);_(this,"_closing",!1);_(this,"_closeTimer",null)}static get observedAttributes(){return["max-width","subtitle","title"]}attributeChangedCallback(e,t,r){t!==r&&this.update()}connectedCallback(){$r(),this.render()}get titleText(){return this.getAttribute("title")||""}set titleText(e){this.setAttribute("title",e)}showModal(){if(this._dialog){if(this._closing){this._closing=!1,this._closeTimer!==null&&(clearTimeout(this._closeTimer),this._closeTimer=null),delete this._dialog.dataset.closing,document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden";return}this._dialog.showModal(),document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden"}}close(){!this._dialog||!this._dialog.open||this._closing||(this._closing=!0,this._dialog.dataset.closing="1",this._closeTimer=setTimeout(()=>{this._dialog&&(this._dialog.close(),delete this._dialog.dataset.closing),this._closing=!1,this._closeTimer=null},160))}update(){const e=this.getAttribute("title")||"",t=this.getAttribute("subtitle")||"",r=this.getAttribute("max-width")||"max-w-2xl";this._titleElement&&(this._titleElement.textContent=e);const s=this.querySelector(".dialog-subtitle");s&&(s.textContent=t,t?s.removeAttribute("style"):s.setAttribute("style","display: none;")),this._dialog&&(this._dialog.className=`bg-[#f5f6f8] dark:bg-[#151718] text-on-surface p-0 shadow-2xl ${r} w-[90%] md:w-full rounded-2xl border border-outline/10 dark:border-outline-variant/10 focus:outline-none overflow-hidden`)}render(){if(this._dialog)return;const e=this.getAttribute("title")||"",t=this.getAttribute("subtitle")||"",r=this.getAttribute("max-width")||"max-w-2xl",s=Array.from(this.childNodes);this.innerHTML="";const i=document.createElement("dialog");i.className=`bg-[#f5f6f8] dark:bg-[#151718] text-on-surface p-0 shadow-2xl ${r} w-[90%] md:w-full rounded-2xl border border-outline/10 dark:border-outline-variant/10 focus:outline-none overflow-hidden`,i.dataset.emu="1",this._dialog=i;const o=document.createElement("button");o.className="absolute top-4 right-4 flex items-center justify-center w-8 h-8 rounded-full bg-surface-container-highest/50 hover:bg-surface-container-highest text-on-surface-variant hover:text-on-surface transition-all duration-200 focus:outline-none z-10 cursor-pointer",o.setAttribute("aria-label","关闭浮窗"),o.innerHTML='<span class="material-symbols-outlined text-[20px]">close</span>',o.addEventListener("click",()=>this.close()),i.appendChild(o);const l=document.createElement("div");l.className="max-h-[90dvh] w-full overflow-y-auto overscroll-contain";const d=document.createElement("div");d.className="relative p-6 md:p-8 flex flex-col items-center";const u=document.createElement("div");u.className="text-center mb-8";const p=document.createElement("span");p.className="dialog-subtitle text-xs font-bold tracking-wider text-primary/70 dark:text-primary-fixed-dim/70 uppercase mb-1 block font-mono",p.textContent=t,t||(p.style.display="none"),u.appendChild(p);const h=document.createElement("h3");h.className="text-2xl font-extrabold text-on-surface tracking-tight",h.textContent=e,this._titleElement=h,u.appendChild(h),d.appendChild(u);const b=document.createElement("div");b.className="w-full flex flex-col items-center",s.forEach(m=>b.appendChild(m)),d.appendChild(b);const g=document.createElement("div");g.className="text-center w-full mt-6 pt-4 border-t border-outline-variant/10",g.innerHTML='<p class="text-[10px] text-on-surface-variant/60 font-mono">Powered by EMU-Stu 开源技术组织</p>',d.appendChild(g),l.appendChild(d),i.appendChild(l),this.appendChild(i),i.addEventListener("close",()=>{document.body.style.overflow="",document.documentElement.style.overflow="",this.dispatchEvent(new CustomEvent("close"))}),i.addEventListener("cancel",m=>{m.preventDefault(),this.close()}),i.addEventListener("click",m=>{m.target===i&&this.close()})}}customElements.define("emu-float",Or);const Wt="emu-lightbox-styles";function Ir(){if(document.getElementById(Wt))return;const a=document.createElement("style");a.id=Wt,a.textContent=`
    ...
    `,document.head.appendChild(a)}class Dr extends HTMLElement{constructor(){super(...arguments);_(this,"_open",()=>{});_(this,"_close",()=>{})}connectedCallback(){this.dataset.ready||(this.dataset.ready="1",Ir(),this._build())}open(e,t=""){this._open(e,t)}close(){this._close()}_build(){this.style.display="contents";const e=document.createElement("dialog");e.className="emu-lightbox-dialog",e.dataset.emu="1";const t=document.createElement("button");t.className="emu-lightbox-close",t.setAttribute("aria-label","关闭图片预览"),t.innerHTML='<span class="material-symbols-outlined" style="font-size:28px;">close</span>';const r=document.createElement("div");r.className="emu-lightbox-img-wrap";const s=document.createElement("img");s.className="emu-lightbox-img",s.alt="",r.appendChild(s),e.appendChild(t),e.appendChild(r),this.appendChild(e);const i=5;let o=1,l=0,d=0,u="none",p=0,h=0,b=0,g=0,m=0,v=0,w=0,S=!1,M=0,q=0,U=0,G="",W="";const Q=(R=!1)=>{s.style.transition=R?"transform 0.25s ease":"none",s.style.transform=`translate(${l}px, ${d}px) scale(${o})`},ie=()=>{const R=Math.max(0,(s.clientWidth*o-window.innerWidth)/2),O=Math.max(0,(s.clientHeight*o-window.innerHeight)/2);l=Math.min(R,Math.max(-R,l)),d=Math.min(O,Math.max(-O,d))},ue=()=>{o=1,l=0,d=0,u="none",s.style.transition="",s.style.transform=""},ge=(R,O,X,ee=!1)=>{const ae=Math.min(i,Math.max(1,X)),pe=window.innerWidth/2,P=window.innerHeight/2,I=ae/o;l=(R-pe)*(1-I)+I*l,d=(O-P)*(1-I)+I*d,o=ae,o<=1.001&&(o=1,l=0,d=0),ie(),Q(ee)};this._open=(R,O)=>{s.src=R,s.alt=O||"",ue(),e.open||(G=document.body.style.overflow,W=document.documentElement.style.overflow,document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden",e.showModal())},this._close=()=>{e.open&&e.close()},e.addEventListener("close",()=>{document.body.style.overflow=G,document.documentElement.style.overflow=W,ue()}),t.addEventListener("click",()=>this._close()),e.addEventListener("click",R=>{R.target===e&&this._close()}),s.addEventListener("touchstart",R=>{if(R.touches.length===2){u="pinch",S=!0;const O=R.touches[0],X=R.touches[1];p=Math.hypot(X.clientX-O.clientX,X.clientY-O.clientY),h=(O.clientX+X.clientX)/2,b=(O.clientY+X.clientY)/2,R.preventDefault()}else if(R.touches.length===1){const O=R.touches[0];v=g=O.clientX,w=m=O.clientY,S=!1,u=o>1?"pan":"none"}},{passive:!1}),s.addEventListener("touchmove",R=>{if(u==="pinch"&&R.touches.length>=2){const O=R.touches[0],X=R.touches[1],ee=Math.hypot(X.clientX-O.clientX,X.clientY-O.clientY),ae=(O.clientX+X.clientX)/2,pe=(O.clientY+X.clientY)/2;l+=ae-h,d+=pe-b;const P=Math.min(i,Math.max(1,o*ee/p)),I=window.innerWidth/2,H=window.innerHeight/2,F=P/o;l=(ae-I)*(1-F)+F*l,d=(pe-H)*(1-F)+F*d,o=P,p=ee,h=ae,b=pe,ie(),Q(!1),R.preventDefault()}else if(u==="pan"&&R.touches.length===1){const O=R.touches[0];l+=O.clientX-g,d+=O.clientY-m,g=O.clientX,m=O.clientY,(Math.abs(O.clientX-v)>6||Math.abs(O.clientY-w)>6)&&(S=!0),ie(),Q(!1),R.preventDefault()}},{passive:!1}),s.addEventListener("touchend",R=>{if(R.touches.length===0){const O=u==="pinch";if(u="none",!O&&!S){const X=Date.now(),ee=R.changedTouches[0];if(X-M<300&&Math.abs(ee.clientX-q)<30&&Math.abs(ee.clientY-U)<30){o>1?ue():ge(ee.clientX,ee.clientY,2.5,!0),M=0;return}M=X,q=ee.clientX,U=ee.clientY}o<=1.001?ue():(ie(),Q(!0))}else if(R.touches.length===1){const O=R.touches[0];v=g=O.clientX,w=m=O.clientY,u=o>1?"pan":"none"}},{passive:!1}),s.addEventListener("wheel",R=>{R.preventDefault();const O=Math.exp(-R.deltaY*.0015);ge(R.clientX,R.clientY,o*O,!1)},{passive:!1})}}customElements.define("emu-lightbox",Dr);let Be=null;function hn(a,n=""){(!Be||!Be.isConnected)&&(Be=document.createElement("emu-lightbox"),document.body.appendChild(Be)),Be.open(a,n)}if(typeof window<"u"){const a=()=>{};window.addEventListener("touchstart",a,{capture:!0,passive:!0}),window.addEventListener("touchmove",a,{capture:!0,passive:!0}),window.addEventListener("touchend",a,{capture:!0,passive:!0})}class Pr extends HTMLElement{connectedCallback(){this.render()}render(){const n=this.querySelector('[slot="content"]'),e=Array.from(this.childNodes).filter(p=>p!==n);this.innerHTML="",this.style.display||(this.style.display="inline-block"),this.style.verticalAlign||(this.style.verticalAlign="middle");const t=document.createElement("div");t.className="relative inline-flex items-center group/tooltip",e.forEach(p=>t.appendChild(p));const r=document.createElement("div");r.className="fixed p-3 bg-white dark:bg-[#1e2124] text-on-surface border border-outline-variant/30 dark:border-[#2f3336] rounded-xl shadow-lg invisible opacity-0 pointer-events-none transition-opacity duration-200 z-50 min-w-[260px] max-w-[calc(100vw-24px)] text-left text-xs whitespace-normal font-sans normal-case after:content-[''] after:absolute after:top-full after:left-0 after:w-full after:h-2";const s=document.createElement("div");if(s.className="absolute top-full w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-white dark:border-t-[#1e2124]",r.appendChild(s),n)n.removeAttribute("slot"),r.appendChild(n);else{const p=this.getAttribute("text")||"",h=document.createElement("span");h.textContent=p,r.appendChild(h)}t.appendChild(r),this.appendChild(t);let i=!1;const o=()=>{i=!0;const h=(t.firstElementChild||t).getBoundingClientRect();r.style.visibility="hidden",r.style.transition="none",r.style.position="fixed",r.style.left="-9999px",r.style.top="-9999px",r.style.transform="none";const b=r.getBoundingClientRect(),g=window.innerWidth||document.documentElement.clientWidth,m=h.left+(h.width-b.width)/2,v=h.top-b.height-8;let w=Math.max(12,m);w+b.width>g-12&&(w=g-12-b.width),r.style.left=`${w}px`,r.style.top=`${v}px`;const M=h.left+h.width/2-w,q=16,U=b.width-16,G=Math.max(q,Math.min(U,M));s.style.left=`${G}px`,s.style.transform="translateX(-50%)",requestAnimationFrame(()=>{requestAnimationFrame(()=>{i&&(r.style.transition="",r.style.visibility="visible",r.style.opacity="1",r.style.pointerEvents="auto")})})},l=()=>{i=!1,r.style.transition="",r.style.opacity="0",r.style.pointerEvents="none",setTimeout(()=>{i||(r.style.visibility="hidden")},200)},d=this.hasAttribute("manual-touch"),u=typeof window.matchMedia=="function"?window.matchMedia("(hover: hover)").matches:!0;d&&!u||(t.addEventListener("mouseenter",o),t.addEventListener("mouseleave",l)),d||t.addEventListener("touchstart",o,{passive:!0})}}customElements.define("emu-tooltip",Pr);class Br extends HTMLElement{connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
      <section
    ...
    `}setupEventListeners(){const n=this.querySelector("#hero-join-btn"),e=this.querySelector("#hero-projects-btn"),t=this.querySelector("#hero-portals-btn"),r=this.querySelector("#hero-labs-btn");n==null||n.addEventListener("click",()=>{var s;(s=document.querySelector("#about-section"))==null||s.scrollIntoView({behavior:"smooth"})}),e==null||e.addEventListener("click",()=>{var s;(s=document.querySelector("#projects-section"))==null||s.scrollIntoView({behavior:"smooth"})}),t==null||t.addEventListener("click",()=>{var s;(s=document.querySelector("#services-section"))==null||s.scrollIntoView({behavior:"smooth"})}),r==null||r.addEventListener("click",()=>{var s;(s=document.querySelector("#labs-section"))==null||s.scrollIntoView({behavior:"smooth"})})}}customElements.define("emu-hero",Br);const Hr="/assets/2025-2026-calendar--jsKTcZs.jpg",zr=Object.freeze(Object.defineProperty({__proto__:null,default:Hr},Symbol.toStringTag,{value:"Module"})),Ur="/assets/2025-2026-schedule-OcUtbm2V.jpg",jr=Object.freeze(Object.defineProperty({__proto__:null,default:Ur},Symbol.toStringTag,{value:"Module"})),qr=[{icon:"restaurant",title:"校园食堂",description:"今日吃什么？查看各大食堂菜谱与就餐反馈",href:"#",soon:!1},{icon:"diversity_3",title:"校园社团",description:"了解校园缤纷社团，发现你的兴趣所在",href:"#",soon:!1},{icon:"map",title:"校园地图",description:"手绘与数字校园地图，快速定位教学楼与宿舍",href:"#"},{icon:"download",title:"资料下载",description:"校园常用表格、课件、软件及办公模版快速下载",href:"#"},{icon:"calendar_month",title:"校历查询",description:"查看最新学期安排，合理规划学习与假期时间",href:"#calendar"}],Yt={newFeatureRequest:"https://acnpe6t9x5o7.feishu.cn/share/base/form/shrcn3EmVQLykJnNfFimFwNGRsg",featureFeedback:"https://acnpe6t9x5o7.feishu.cn/share/base/form/shrcn5HRkWpziz9ddvthLFAqbQE"},Gr="/assets/survey-qrcode-feature-feedbck-CXXN6x3o.png",Fr="/assets/survey-qrcode-new-feature-request-DULuK1K3.png",Kt=Object.assign({"../../assets/university_calendar/2025-2026-calendar.jpg":zr,"../../assets/university_calendar/2025-2026-schedule.jpg":jr});class Zr extends HTMLElement{connectedCallback(){this.render(),this.initFeedbackDialog(),this.initCalendarDialog()}render(){const n=qr.map(e=>`
      <emu-service-card
        icon="${e.icon}"
        title="${e.title}"
    ...
    `}open(){const e=this.querySelector("emu-float");e&&(e.showModal(),this.renderHeatmap(),this.setupTouchScrub(),this.scrollToLatest())}close(){const e=this.querySelector("emu-float");e==null||e.close()}cellTooltipHTML(e){const{val:t,additions:r,deletions:s,commits:i,commitsTracked:o,dateTracked:l}=this.getDayVal(e),d=t.toLocaleString(),u=o?`<strong>${i}</strong> 次`:'<span style="opacity:0.45;font-style:italic;">未统计</span>',p=l?`<strong>${d}</strong> 行${t>0?` (新增 +${r.toLocaleString()} / 删除 -${s.toLocaleString()})`:""}`:'<span style="opacity:0.45;font-style:italic;">未统计</span>',h=`提交次数：${u}<br/>变更代码：${p}`;return`<span class="block font-bold text-on-surface mb-1.5 font-mono text-[11px]">${e}</span><span class="block text-on-surface-variant/90 text-[11px] leading-relaxed">${h}</span>`}setupTouchScrub(){if(this._touchScrubReady)return;const e=this.querySelector("#dialog-heatmap-grid");if(!e)return;this._touchScrubReady=!0;const t=320,r=12,s=500;let i=null,o=!1,l=0,d=0,u=null;const p=()=>{i!==null&&(clearTimeout(i),i=null)},h=(w,S)=>{const M=document.elementFromPoint(w,S),q=M==null?void 0:M.closest("[data-date]");return q&&e.contains(q)?q:null},b=w=>{!w||w===u||(u=w,this.showTouchTip(w))};e.addEventListener("touchstart",w=>{if(w.touches.length!==1)return;const S=w.touches[0];l=S.clientX,d=S.clientY,o=!1,u=null,p(),i=setTimeout(()=>{o=!0,i=null,navigator.vibrate&&navigator.vibrate(10),b(h(l,d))},t)},{passive:!0}),e.addEventListener("touchmove",w=>{const S=w.touches[0];if(S){if(!o){Math.hypot(S.clientX-l,S.clientY-d)>r&&p();return}w.preventDefault(),b(h(S.clientX,S.clientY))}},{passive:!1});const g=()=>{p(),o&&(o=!1,u=null,this.hideTouchTip())};e.addEventListener("touchend",g),e.addEventListener("touchcancel",g);let m=null;const v=()=>{e.setAttribute("data-touch-suppress",""),m&&clearTimeout(m),m=setTimeout(()=>{e.removeAttribute("data-touch-suppress"),m=null},s)};if(!document.getElementById("heatmap-touch-suppress-style")){const w=document.createElement("style");w.id="heatmap-touch-suppress-style",w.textContent=`
      ...
      `,document.head.appendChild(w)}e.addEventListener("touchstart",v,{capture:!0,passive:!0}),e.addEventListener("touchend",v,{capture:!0,passive:!0})}ensureTouchTip(){if(this._touchTip)return this._touchTip;const e=document.createElement("div");e.className="fixed p-3 bg-white dark:bg-[#1e2124] text-on-surface border border-outline-variant/30 dark:border-[#2f3336] rounded-xl shadow-lg invisible opacity-0 pointer-events-none transition-opacity duration-150 z-50 text-left text-xs whitespace-normal font-sans normal-case",e.style.minWidth="180px",e.style.maxWidth="calc(100vw - 24px)";const t=document.createElement("div");t.className="absolute top-full w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-white dark:border-t-[#1e2124]",e.appendChild(t);const r=document.createElement("div");return r.className="p-0.5 select-none",e.appendChild(r),(this.querySelector("emu-float dialog")||this).appendChild(e),this._touchTip=e,this._touchTipArrow=t,this._touchTipBody=r,e}showTouchTip(e){const t=e.getAttribute("data-date");if(!t)return;const r=this.ensureTouchTip();this._touchTipBody.innerHTML=this.cellTooltipHTML(t),r.style.visibility="hidden",r.style.left="-9999px",r.style.top="-9999px";const s=e.getBoundingClientRect(),i=r.getBoundingClientRect(),o=window.innerWidth||document.documentElement.clientWidth,l=s.left+(s.width-i.width)/2;let d=Math.max(12,l);d+i.width>o-12&&(d=o-12-i.width);const u=s.top-i.height-8;r.style.left=`${d}px`,r.style.top=`${u}px`;const p=s.left+s.width/2,h=Math.max(16,Math.min(i.width-16,p-d));this._touchTipArrow.style.left=`${h}px`,this._touchTipArrow.style.transform="translateX(-50%)",r.style.visibility="visible",r.style.opacity="1"}hideTouchTip(){this._touchTip&&(this._touchTip.style.opacity="0",this._touchTip.style.visibility="hidden")}scrollToLatest(){setTimeout(()=>{const e=this.querySelector(".overflow-x-auto");e&&(e.scrollLeft=e.scrollWidth)},50)}getDayVal(e){var u,p,h,b;const t=this._historyData.find(g=>g.date===e);if(!t)return{val:0,additions:0,deletions:0,commits:0,commitsTracked:!1,dateTracked:!1,score:0};const r=((u=t.metrics)==null?void 0:u.additions)??t.total_additions??0,s=((p=t.metrics)==null?void 0:p.deletions)??t.total_deletions??0,i=((h=t.metrics)==null?void 0:h.lines_changed)??r+s;let o=0,l=!1;typeof((b=t.metrics)==null?void 0:b.commits)=="number"?(o=t.metrics.commits,l=!0):t.repos&&t.repos.some(m=>{var v;return typeof((v=m.metrics)==null?void 0:v.commits)=="number"})&&(o=t.repos.reduce((m,v)=>{var w;return m+(((w=v.metrics)==null?void 0:w.commits)??0)},0),l=!0);const d=o*20+Math.log2(i+1)*10;return{val:i,additions:r,deletions:s,commits:o,commitsTracked:l,dateTracked:!0,score:d}}calculateYearQuantiles(e){const t=[];if(e.forEach(s=>{const{score:i}=this.getDayVal(s);i>0&&t.push(i)}),t.length===0)return{q25:1,q50:2,q75:3};t.sort((s,i)=>s-i);const r=s=>{const i=Math.floor(t.length*s);return t[Math.min(i,t.length-1)]};return{q25:r(.25),q50:r(.5),q75:r(.75)}}renderHeatmap(){if(!this._dataLoaded){const I=this.querySelector("#dialog-heatmap-grid");I&&(I.innerHTML='<span class="text-xs text-on-surface-variant/70 py-6">正在加载活跃度数据...</span>');return}const e=480*60*1e3,t=new Date,r=new Date(t.getTime()+t.getTimezoneOffset()*60*1e3+e),s=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}-${String(r.getDate()).padStart(2,"0")}`,i=new Date(2025,4,1),o=r,l=i.getDay(),d=new Date(i.getTime()-l*24*60*60*1e3),u=o.getDay(),p=new Date(o.getTime()+(6-u)*24*60*60*1e3),h=[];let b=new Date(d);for(;b<=p;){const I=b.getFullYear(),H=String(b.getMonth()+1).padStart(2,"0"),F=String(b.getDate()).padStart(2,"0");h.push(`${I}-${H}-${F}`),b.setDate(b.getDate()+1)}const m=h.length/7,v="2025-05-01",w=h.filter(I=>I>=v&&I<=s);let S=0,M=0,q=0,U=0,G="";w.forEach(I=>{const{val:H,commits:F}=this.getDayVal(I);(H>0||F>0)&&(S+=H,M+=F,q++,H>U&&(U=H,G=I))});const W=this.calculateYearQuantiles(w),Q=[];for(let I=0;I<m;I++){const H=[];for(let F=0;F<7;F++)H.push(h[I*7+F]);Q.push(H)}let ie="",ue=-10,ge="";Q.forEach((I,H)=>{const ce=`${new Date(I[3]).getMonth()+1}月`;ce!==ge&&H-ue>=3&&H<m-1&&(ie+=`<div class="absolute text-[10px] text-on-surface-variant/50 font-mono select-none whitespace-nowrap" style="left: calc(${H} * (20px + 2px));">${ce}</div>`,ge=ce,ue=H)});let R="";Q.forEach(I=>{let H="";I.forEach(F=>{const ce=F>s;if(F<"2025-05-01"||ce)H+=`
          ...
          `}}),R+=`<div class="flex flex-col gap-[2px]">${H}</div>`});const O=this.querySelector("#dialog-heatmap-months");O&&(O.innerHTML=ie);const X=this.querySelector("#dialog-heatmap-grid");X&&(X.innerHTML=R);const ee=this.querySelector("#year-total-lines");ee&&(ee.textContent=`${S.toLocaleString()} 行`);const ae=this.querySelector("#year-total-commits");ae&&(ae.textContent=`${M.toLocaleString()} 次`);const pe=this.querySelector("#year-active-days");pe&&(pe.textContent=`${q} 天`);const P=this.querySelector("#year-max-lines");P&&(P.textContent=`${U.toLocaleString()} 行${G?` (${G})`:""}`)}}customElements.define("emu-contribution-heatmap",Kr);const Qt=[{name:"物联网实验室（AKA 数字孪生暨虚拟现实实验室）",code:"IoT-Lab",description:"开展物联网架构、嵌入式硬件开发与实时数据采集研究，结合数字孪生与虚拟现实技术实现物理世界的数字化映射。",department:"计算机科学与工程学院",professors:["陈超"],tags:["物联网","数字孪生","虚拟现实","嵌入式"],icon:"sensors",href:"https://emu-stu.github.io/IOT-lab-web/"},{name:"河北省安全生产与应急处置特种机器人重点实验室",code:"SER-Lab",description:"致力于应急救援、特种作业机器人的研发，开展智能环境感知、鲁棒控制及人机协作技术等关键课题攻关。",department:"应急管理学院",tags:["特种机器人","应急处置","智能控制","环境感知"],icon:"precision_manufacturing"},{name:"ArkLab方舟实验室",code:"Ark-Lab",description:"专注于学生技术创新与工程实践，覆盖全栈软件开发、算法研究及软硬件协同设计，培养核心技术人才。",department:"电子信息工程学院",tags:["软件工程","算法设计","技术创新","全栈开发"],icon:"sailing"},{name:"利刃网安攻防实验室",code:"Blade-Sec-Lab",description:"聚焦于网络空间安全，开展渗透测试、漏洞挖掘、红蓝对抗以及安全防御体系建设等核心攻防技术研究。",department:"计算机科学与工程学院",tags:["网络安全","漏洞挖掘","红蓝对抗","渗透测试"],icon:"shield_lock"}];class Qr extends HTMLElement{constructor(){super(...arguments);_(this,"_resizeObserver",null)}connectedCallback(){this.render(),this.setupResponsiveness()}disconnectedCallback(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null)}generateCardHtml(e){const t=e.tags.map(s=>`
        <span
    ...
    `}render(){const e=Qt.map(t=>this.generateCardHtml(t)).join("");this.innerHTML=`
      <style>
...
`,Jr=Object.freeze(Object.defineProperty({__proto__:null,default:Vr},Symbol.toStringTag,{value:"Module"}));function ea(a,n){var u;const e=((u=a.split("/").pop())==null?void 0:u.replace(".md",""))||"untitled",t=n.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n([\s\S]*)$/),r={};let s=n;if(t){const p=t[1];s=t[2],p.split(`
`).forEach(h=>{const b=h.trim();if(!b||b.startsWith("#"))return;const g=b.indexOf(":");if(g!==-1){const m=b.slice(0,g).trim();let v=b.slice(g+1).trim();(v.startsWith('"')&&v.endsWith('"')||v.startsWith("'")&&v.endsWith("'"))&&(v=v.slice(1,-1)),r[m]=v}})}const i=s.match(/^\s*#\s+(.+)$/m);let o=r.title;i&&(o||(o=i[1].trim()),s=s.replace(/^\s*#\s+.+$/m,"").trim()),o||(o=e);const l=p=>p.slice(0,300).replace(/[#*`~_\-]/g,"").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/\s+/g," ").trim().slice(0,150)+"...",d=r.excerpt||l(s);return{slug:r.slug||e,title:o,excerpt:d,category:r.category||"技术沉淀",subCategory:r.subCategory||"General",author:r.author||"Anonymous",authorAvatar:r.authorAvatar||(r.author?r.author[0].toUpperCase():"A"),date:r.date||new Date().toISOString().split("T")[0],readTime:r.readTime||`${Math.max(1,Math.ceil(s.length/500))} min`,content:s,filePath:a}}const Vt=Object.assign({"../../docs/articles/github_repo_code_change_stats_howto.md":Jr}),gn=[];for(const a in Vt)try{const n=Vt[a];let e="";if(typeof n=="string")e=n;else if(n&&typeof n.default=="string")e=n.default;else{console.warn(`[article.ts] Failed to load raw content for ${a}:`,n);continue}const t=ea(a,e);gn.push(t)}catch(n){console.error(`[article.ts] Error parsing markdown article at ${a}:`,n)}const gt=[...gn].sort((a,n)=>new Date(n.date).getTime()-new Date(a.date).getTime()),ta=gt.map(a=>({category:a.category,subCategory:a.subCategory,href:`/article?slug=${a.slug}`,title:a.title,excerpt:a.excerpt,authorAvatar:a.authorAvatar,author:a.author,date:a.date,readTime:a.readTime}));class na extends HTMLElement{constructor(){super(...arguments);_(this,"_currentCategory","全部");_(this,"_searchQuery","");_(this,"_currentPage",1);_(this,"_postsPerPage",4);_(this,"_categories",["全部","后端开发","前端架构","AI/ML","应急科技","开源治理"]);_(this,"_searchHandler",null);_(this,"_searchInput",null)}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this._searchHandler&&this._searchInput&&this._searchInput.removeEventListener("input",this._searchHandler)}getFilteredPosts(){return ta.filter(e=>{const t=this._currentCategory==="全部"||e.category===this._currentCategory,r=this._searchQuery.trim().toLowerCase(),s=!r||e.title.toLowerCase().includes(r)||e.excerpt.toLowerCase().includes(r);return t&&s})}generatePostHtml(e){return`
      <a 
        href="${e.href}" 
    ...
    `}refreshList(){const e=this.querySelector("#blog-posts-list"),t=this.querySelector("#blog-pagination-container"),r=this.getFilteredPosts(),s=Math.ceil(r.length/this._postsPerPage);this._currentPage>s&&s>0&&(this._currentPage=1);const i=(this._currentPage-1)*this._postsPerPage,o=r.slice(i,i+this._postsPerPage);e&&(e.style.opacity="0"),setTimeout(()=>{e&&(o.length>0?e.innerHTML=o.map(l=>this.generatePostHtml(l)).join(""):e.innerHTML=`
          ...
          `,e.style.opacity="1"),t&&(t.innerHTML=this.generatePaginationHtml(s),this.setupPaginationListeners())},200)}setupEventListeners(){var e;this.addEventListener("click",t=>{const s=t.target.closest(".category-tab");if(s){const i=s.dataset.category||"全部";this._currentCategory!==i&&(this._currentCategory=i,this._currentPage=1,this.querySelectorAll(".category-tab").forEach(l=>{l.className="category-tab px-4 py-2 text-sm font-semibold rounded-xl transition-all duration-300 bg-surface-container hover:bg-surface-container-high text-on-surface-variant dark:text-surface-variant dark:bg-surface-container/30 dark:hover:bg-surface-container/50",l.setAttribute("aria-selected","false")}),s.className="category-tab px-4 py-2 text-sm font-semibold rounded-xl transition-all duration-300 bg-primary text-on-primary shadow-sm dark:bg-primary-fixed dark:text-on-primary-fixed",s.setAttribute("aria-selected","true"),this.refreshList())}}),this._searchInput=this.querySelector("#blog-search-input"),this._searchHandler=()=>{this._searchInput&&(this._searchQuery=this._searchInput.value,this._currentPage=1,this.refreshList())},(e=this._searchInput)==null||e.addEventListener("input",this._searchHandler),this.setupPaginationListeners()}setupPaginationListeners(){const e=this.querySelector("#blog-prev-btn");e==null||e.addEventListener("click",()=>{this._currentPage>1&&(this._currentPage--,this.refreshList(),this.scrollToTop())});const t=this.querySelector("#blog-next-btn");t==null||t.addEventListener("click",()=>{const s=this.getFilteredPosts(),i=Math.ceil(s.length/this._postsPerPage);this._currentPage<i&&(this._currentPage++,this.refreshList(),this.scrollToTop())}),this.querySelectorAll(".page-num-btn").forEach(s=>{s.addEventListener("click",()=>{const i=parseInt(s.dataset.page||"1",10);this._currentPage!==i&&(this._currentPage=i,this.refreshList(),this.scrollToTop())})})}scrollToTop(){const e=this.querySelector("#blog-container");e&&e.scrollIntoView({behavior:"smooth",block:"start"})}}customElements.define("emu-blog",na);const ra="modulepreload",aa=function(a){return"/"+a},Jt={},sa=function(n,e,t){let r=Promise.resolve();if(e&&e.length>0){let i=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));r=i(e.map(d=>{if(d=aa(d),d in Jt)return;Jt[d]=!0;const u=d.endsWith(".css"),p=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":ra,u||(h.as="script"),h.crossOrigin="",h.href=d,l&&h.setAttribute("nonce",l),document.head.appendChild(h),u)return new Promise((b,g)=>{h.addEventListener("load",b),h.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return r.then(i=>{for(const o of i||[])o.status==="rejected"&&s(o.reason);return n().catch(s)})};function vt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Re=vt();function fn(a){Re=a}var Ce={exec:()=>null};function Ie(a){let n=[];return e=>{let t=Math.max(0,Math.min(3,e-1)),r=n[t];return r||(r=a(t),n[t]=r),r}}function z(a,n=""){let e=typeof a=="string"?a:a.source,t={replace:(r,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(le.caret,"$1"),e=e.replace(r,i),t},getRegex:()=>new RegExp(e,n)};return t}var ia=((a="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+a)}catch{return!1}})(),le={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:a=>new RegExp(`^( {0,3}${a})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:Ie(a=>new RegExp(`^ {0,${a}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:Ie(a=>new RegExp(`^ {0,${a}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}(?:\`\`\`|~~~)`)),headingBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}#`)),htmlBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}<(?:[a-z].*>|!--)`,"i")),blockquoteBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}>`))},oa=/^(?:[ \t]*(?:\n|$))+/,la=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ca=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,je=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,da=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,yt=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,mn=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,bn=z(mn).replace(/bull/g,yt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),ua=z(mn).replace(/bull/g,yt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),kt=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,pa=/^[^\n]+/,wt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ha=z(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",wt).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ga=z(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,yt).getRegex(),nt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Et=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,fa=z("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Et).replace("tag",nt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),xn=z(kt).replace("hr",je).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nt).getRegex(),ma=z(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",xn).getRegex(),_t={blockquote:ma,code:la,def:ha,fences:ca,heading:da,hr:je,html:fa,lheading:bn,list:ga,newline:oa,paragraph:xn,table:Ce,text:pa},en=z("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",je).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nt).getRegex(),ba={..._t,lheading:ua,table:en,paragraph:z(kt).replace("hr",je).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",en).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",nt).getRegex()},xa={..._t,html:z(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Et).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ce,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:z(kt).replace("hr",je).replace("heading",` *#{1,6} *[^
]`).replace("lheading",bn).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},va=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ya=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,vn=/^( {2,}|\\)\n(?!\s*$)/,ka=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,De=/[\p{P}\p{S}]/u,rt=/[\s\p{P}\p{S}]/u,St=/[^\s\p{P}\p{S}]/u,wa=z(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,rt).getRegex(),yn=/(?!~)[\p{P}\p{S}]/u,Ea=/(?!~)[\s\p{P}\p{S}]/u,_a=/(?:[^\s\p{P}\p{S}]|~)/u,Sa=z(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",ia?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),kn=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Ta=z(kn,"u").replace(/punct/g,De).getRegex(),Aa=z(kn,"u").replace(/punct/g,yn).getRegex(),wn="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",La=z(wn,"gu").replace(/notPunctSpace/g,St).replace(/punctSpace/g,rt).replace(/punct/g,De).getRegex(),Ca=z(wn,"gu").replace(/notPunctSpace/g,_a).replace(/punctSpace/g,Ea).replace(/punct/g,yn).getRegex(),Ma=z("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,St).replace(/punctSpace/g,rt).replace(/punct/g,De).getRegex(),Ra=z(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,De).getRegex(),Na="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",$a=z(Na,"gu").replace(/notPunctSpace/g,St).replace(/punctSpace/g,rt).replace(/punct/g,De).getRegex(),Oa=z(/\\(punct)/,"gu").replace(/punct/g,De).getRegex(),Ia=z(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Da=z(Et).replace("(?:-->|$)","-->").getRegex(),Pa=z("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Da).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ve=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,Ba=z(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Ve).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),En=z(/^!?\[(label)\]\[(ref)\]/).replace("label",Ve).replace("ref",wt).getRegex(),_n=z(/^!?\[(ref)\](?:\[\])?/).replace("ref",wt).getRegex(),Ha=z("reflink|nolink(?!\\()","g").replace("reflink",En).replace("nolink",_n).getRegex(),tn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Tt={_backpedal:Ce,anyPunctuation:Oa,autolink:Ia,blockSkip:Sa,br:vn,code:ya,del:Ce,delLDelim:Ce,delRDelim:Ce,emStrongLDelim:Ta,emStrongRDelimAst:La,emStrongRDelimUnd:Ma,escape:va,link:Ba,nolink:_n,punctuation:wa,reflink:En,reflinkSearch:Ha,tag:Pa,text:ka,url:Ce},za={...Tt,link:z(/^!?\[(label)\]\((.*?)\)/).replace("label",Ve).getRegex(),reflink:z(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ve).getRegex()},ft={...Tt,emStrongRDelimAst:Ca,emStrongLDelim:Aa,delLDelim:Ra,delRDelim:$a,url:z(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",tn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:z(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",tn).getRegex()},Ua={...ft,br:z(vn).replace("{2,}","*").getRegex(),text:z(ft.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ke={normal:_t,gfm:ba,pedantic:xa},He={normal:Tt,gfm:ft,breaks:Ua,pedantic:za},ja={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},nn=a=>ja[a];function ye(a,n){if(n){if(le.escapeTest.test(a))return a.replace(le.escapeReplace,nn)}else if(le.escapeTestNoEncode.test(a))return a.replace(le.escapeReplaceNoEncode,nn);return a}function rn(a){try{a=encodeURI(a).replace(le.percentDecode,"%")}catch{return null}return a}function an(a,n){var s;let e=a.replace(le.findPipe,(i,o,l)=>{let d=!1,u=o;for(;--u>=0&&l[u]==="\\";)d=!d;return d?"|":" |"}),t=e.split(le.splitPipe),r=0;if(t[0].trim()||t.shift(),t.length>0&&!((s=t.at(-1))!=null&&s.trim())&&t.pop(),n)if(t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;r<t.length;r++)t[r]=t[r].trim().replace(le.slashPipe,"|");return t}function Se(a,n,e){let t=a.length;if(t===0)return"";let r=0;for(;r<t&&a.charAt(t-r-1)===n;)r++;return a.slice(0,t-r)}function sn(a){let n=a.split(`
`),e=n.length-1;for(;e>=0&&le.blankLine.test(n[e]);)e--;return n.length-e<=2?a:n.slice(0,e+1).join(`
`)}function qa(a,n){if(a.indexOf(n[1])===-1)return-1;let e=0;for(let t=0;t<a.length;t++)if(a[t]==="\\")t++;else if(a[t]===n[0])e++;else if(a[t]===n[1]&&(e--,e<0))return t;return e>0?-2:-1}function Ga(a,n=0){let e=n,t="";for(let r of a)if(r==="	"){let s=4-e%4;t+=" ".repeat(s),e+=s}else t+=r,e++;return t}function on(a,n,e,t,r){let s=n.href,i=n.title||null,o=a[1].replace(r.other.outputLinkReplace,"$1");t.state.inLink=!0;let l={type:a[0].charAt(0)==="!"?"image":"link",raw:e,href:s,title:i,text:o,tokens:t.inlineTokens(o)};return t.state.inLink=!1,l}function Fa(a,n,e){let t=a.match(e.other.indentCodeCompensation);if(t===null)return n;let r=t[1];return n.split(`
`).map(s=>{let i=s.match(e.other.beginningSpace);if(i===null)return s;let[o]=i;return o.length>=r.length?s.slice(r.length):s}).join(`
`)}var Je=class{constructor(a){_(this,"options");_(this,"rules");_(this,"lexer");this.options=a||Re}space(a){let n=this.rules.block.newline.exec(a);if(n&&n[0].length>0)return{type:"space",raw:n[0]}}code(a){let n=this.rules.block.code.exec(a);if(n){let e=this.options.pedantic?n[0]:sn(n[0]),t=e.replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e,codeBlockStyle:"indented",text:t}}}fences(a){let n=this.rules.block.fences.exec(a);if(n){let e=n[0],t=Fa(e,n[3]||"",this.rules);return{type:"code",raw:e,lang:n[2]?n[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):n[2],text:t}}}heading(a){let n=this.rules.block.heading.exec(a);if(n){let e=n[2].trim();if(this.rules.other.endingHash.test(e)){let t=Se(e,"#");(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:"heading",raw:Se(n[0],`
`),depth:n[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(a){let n=this.rules.block.hr.exec(a);if(n)return{type:"hr",raw:Se(n[0],`
`)}}blockquote(a){let n=this.rules.block.blockquote.exec(a);if(n){let e=Se(n[0],`
`).split(`
...
`+e.join(`
`),m=this.blockquote(g);s[s.length-1]=m,t=t.substring(0,t.length-b.raw.length)+m.raw,r=r.substring(0,r.length-b.text.length)+m.text;break}else if((h==null?void 0:h.type)==="list"){let b=h,g=b.raw+`
`+e.join(`
`),m=this.list(g);s[s.length-1]=m,t=t.substring(0,t.length-h.raw.length)+m.raw,r=r.substring(0,r.length-b.raw.length)+m.raw,e=g.substring(s.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:t,tokens:s,text:r}}}list(a){let n=this.rules.block.list.exec(a);if(n){let e=n[1].trim(),t=e.length>1,r={type:"list",raw:"",ordered:t,start:t?+e.slice(0,-1):"",loose:!1,items:[]};e=t?`\\d{1,9}\\${e.slice(-1)}`:`\\${e}`,this.options.pedantic&&(e=t?e:"[*+-]");let s=this.rules.other.listItemRegex(e),i=!1;for(;a;){let l=!1,d="",u="";if(!(n=s.exec(a))||this.rules.block.hr.test(a))break;d=n[0],a=a.substring(d.length);let p=Ga(n[2].split(`
`,1)[0],n[1].length),h=a.split(`
`,1)[0],b=!p.trim(),g=0;if(this.options.pedantic?(g=2,u=p.trimStart()):b?g=n[1].length+1:(g=p.search(this.rules.other.nonSpaceChar),g=g>4?1:g,u=p.slice(g),g+=n[1].length),b&&this.rules.other.blankLine.test(h)&&(d+=h+`
`,a=a.substring(h.length+1),l=!0),!l){let m=this.rules.other.nextBulletRegex(g),v=this.rules.other.hrRegex(g),w=this.rules.other.fencesBeginRegex(g),S=this.rules.other.headingBeginRegex(g),M=this.rules.other.htmlBeginRegex(g),q=this.rules.other.blockquoteBeginRegex(g);for(;a;){let U=a.split(`
`,1)[0],G;if(h=U,this.options.pedantic?(h=h.replace(this.rules.other.listReplaceNesting,"  "),G=h):G=h.replace(this.rules.other.tabCharGlobal,"    "),w.test(h)||S.test(h)||M.test(h)||q.test(h)||m.test(h)||v.test(h))break;if(G.search(this.rules.other.nonSpaceChar)>=g||!h.trim())u+=`
`+G.slice(g);else{if(b||p.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||w.test(p)||S.test(p)||v.test(p))break;u+=`
`+h}b=!h.trim(),d+=U+`
`,a=a.substring(U.length+1),p=G.slice(g)}}r.loose||(i?r.loose=!0:this.rules.other.doubleBlankLine.test(d)&&(i=!0)),r.items.push({type:"list_item",raw:d,task:!!this.options.gfm&&this.rules.other.listIsTask.test(u),loose:!1,text:u,tokens:[]}),r.raw+=d}let o=r.items.at(-1);if(o)o.raw=o.raw.trimEnd(),o.text=o.text.trimEnd();else return;r.raw=r.raw.trimEnd();for(let l of r.items){this.lexer.state.top=!1,l.tokens=this.lexer.blockTokens(l.text,[]);let d=l.tokens[0];if(l.task&&((d==null?void 0:d.type)==="text"||(d==null?void 0:d.type)==="paragraph")){l.text=l.text.replace(this.rules.other.listReplaceTask,""),d.raw=d.raw.replace(this.rules.other.listReplaceTask,""),d.text=d.text.replace(this.rules.other.listReplaceTask,"");for(let p=this.lexer.inlineQueue.length-1;p>=0;p--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[p].src)){this.lexer.inlineQueue[p].src=this.lexer.inlineQueue[p].src.replace(this.rules.other.listReplaceTask,"");break}let u=this.rules.other.listTaskCheckbox.exec(l.raw);if(u){let p={type:"checkbox",raw:u[0]+" ",checked:u[0]!=="[ ]"};l.checked=p.checked,r.loose?l.tokens[0]&&["paragraph","text"].includes(l.tokens[0].type)&&"tokens"in l.tokens[0]&&l.tokens[0].tokens?(l.tokens[0].raw=p.raw+l.tokens[0].raw,l.tokens[0].text=p.raw+l.tokens[0].text,l.tokens[0].tokens.unshift(p)):l.tokens.unshift({type:"paragraph",raw:p.raw,text:p.raw,tokens:[p]}):l.tokens.unshift(p)}}else l.task&&(l.task=!1);if(!r.loose){let u=l.tokens.filter(h=>h.type==="space"),p=u.length>0&&u.some(h=>this.rules.other.anyLine.test(h.raw));r.loose=p}}if(r.loose)for(let l of r.items){l.loose=!0;for(let d of l.tokens)d.type==="text"&&(d.type="paragraph")}return r}}html(a){let n=this.rules.block.html.exec(a);if(n){let e=sn(n[0]);return{type:"html",block:!0,raw:e,pre:n[1]==="pre"||n[1]==="script"||n[1]==="style",text:e}}}def(a){let n=this.rules.block.def.exec(a);if(n){let e=n[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),t=n[2]?n[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",r=n[3]?n[3].substring(1,n[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):n[3];return{type:"def",tag:e,raw:Se(n[0],`
`),href:t,title:r}}}table(a){var i;let n=this.rules.block.table.exec(a);if(!n||!this.rules.other.tableDelimiter.test(n[2]))return;let e=an(n[1]),t=n[2].replace(this.rules.other.tableAlignChars,"").split("|"),r=(i=n[3])!=null&&i.trim()?n[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],s={type:"table",raw:Se(n[0],`
`),header:[],align:[],rows:[]};if(e.length===t.length){for(let o of t)this.rules.other.tableAlignRight.test(o)?s.align.push("right"):this.rules.other.tableAlignCenter.test(o)?s.align.push("center"):this.rules.other.tableAlignLeft.test(o)?s.align.push("left"):s.align.push(null);for(let o=0;o<e.length;o++)s.header.push({text:e[o],tokens:this.lexer.inline(e[o]),header:!0,align:s.align[o]});for(let o of r)s.rows.push(an(o,s.header.length).map((l,d)=>({text:l,tokens:this.lexer.inline(l),header:!1,align:s.align[d]})));return s}}lheading(a){let n=this.rules.block.lheading.exec(a);if(n){let e=n[1].trim();return{type:"heading",raw:Se(n[0],`
...
`)?"":`
`)+l.raw,u.text+=`
`+l.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):e.push(l);continue}if(n){this.infiniteLoopError(n.charCodeAt(0));break}}return this.state.top=!0,e}inline(n,e=[]){return this.inlineQueue.push({src:n,tokens:e}),e}inlineTokens(n,e=[]){var d,u,p,h,b;this.tokenizer.lexer=this;let t=n,r=null;if(this.tokens.links){let g=Object.keys(this.tokens.links);if(g.length>0)for(;(r=this.tokenizer.rules.inline.reflinkSearch.exec(t))!==null;)g.includes(r[0].slice(r[0].lastIndexOf("[")+1,-1))&&(t=t.slice(0,r.index)+"["+"a".repeat(r[0].length-2)+"]"+t.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(r=this.tokenizer.rules.inline.anyPunctuation.exec(t))!==null;)t=t.slice(0,r.index)+"++"+t.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let s;for(;(r=this.tokenizer.rules.inline.blockSkip.exec(t))!==null;)s=r[2]?r[2].length:0,t=t.slice(0,r.index+s)+"["+"a".repeat(r[0].length-s-2)+"]"+t.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);t=((u=(d=this.options.hooks)==null?void 0:d.emStrongMask)==null?void 0:u.call({lexer:this},t))??t;let i=!1,o="",l=1/0;for(;n;){if(n.length<l)l=n.length;else{this.infiniteLoopError(n.charCodeAt(0));break}i||(o=""),i=!1;let g;if((h=(p=this.options.extensions)==null?void 0:p.inline)!=null&&h.some(v=>(g=v.call({lexer:this},n,e))?(n=n.substring(g.raw.length),e.push(g),!0):!1))continue;if(g=this.tokenizer.escape(n)){n=n.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.tag(n)){n=n.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.link(n)){n=n.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.reflink(n,this.tokens.links)){n=n.substring(g.raw.length);let v=e.at(-1);g.type==="text"&&(v==null?void 0:v.type)==="text"?(v.raw+=g.raw,v.text+=g.text):e.push(g);continue}if(g=this.tokenizer.emStrong(n,t,o)){n=n.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.codespan(n)){n=n.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.br(n)){n=n.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.del(n,t,o)){n=n.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.autolink(n)){n=n.substring(g.raw.length),e.push(g);continue}if(!this.state.inLink&&(g=this.tokenizer.url(n))){n=n.substring(g.raw.length),e.push(g);continue}let m=n;if((b=this.options.extensions)!=null&&b.startInline){let v=1/0,w=n.slice(1),S;this.options.extensions.startInline.forEach(M=>{S=M.call({lexer:this},w),typeof S=="number"&&S>=0&&(v=Math.min(v,S))}),v<1/0&&v>=0&&(m=n.substring(0,v+1))}if(g=this.tokenizer.inlineText(m)){n=n.substring(g.raw.length),g.raw.slice(-1)!=="_"&&(o=g.raw.slice(-1)),i=!0;let v=e.at(-1);(v==null?void 0:v.type)==="text"?(v.raw+=g.raw,v.text+=g.text):e.push(g);continue}if(n){this.infiniteLoopError(n.charCodeAt(0));break}}return e}infiniteLoopError(n){let e="Infinite loop on byte: "+n;if(this.options.silent)console.error(e);else throw new Error(e)}},et=class{constructor(a){_(this,"options");_(this,"parser");this.options=a||Re}space(a){return""}code({text:a,lang:n,escaped:e}){var s;let t=(s=(n||"").match(le.notSpaceStart))==null?void 0:s[0],r=a.replace(le.endingNewline,"")+`
`;return t?'<pre><code class="language-'+ye(t)+'">'+(e?r:ye(r,!0))+`</code></pre>
`:"<pre><code>"+(e?r:ye(r,!0))+`</code></pre>
...
`}strong({tokens:a}){return`<strong>${this.parser.parseInline(a)}</strong>`}em({tokens:a}){return`<em>${this.parser.parseInline(a)}</em>`}codespan({text:a}){return`<code>${ye(a,!0)}</code>`}br(a){return"<br>"}del({tokens:a}){return`<del>${this.parser.parseInline(a)}</del>`}link({href:a,title:n,tokens:e}){let t=this.parser.parseInline(e),r=rn(a);if(r===null)return t;a=r;let s='<a href="'+a+'"';return n&&(s+=' title="'+ye(n)+'"'),s+=">"+t+"</a>",s}image({href:a,title:n,text:e,tokens:t}){t&&(e=this.parser.parseInline(t,this.parser.textRenderer));let r=rn(a);if(r===null)return ye(e);a=r;let s=`<img src="${a}" alt="${ye(e)}"`;return n&&(s+=` title="${ye(n)}"`),s+=">",s}text(a){return"tokens"in a&&a.tokens?this.parser.parseInline(a.tokens):"escaped"in a&&a.escaped?a.text:ye(a.text)}},At=class{strong({text:a}){return a}em({text:a}){return a}codespan({text:a}){return a}del({text:a}){return a}html({text:a}){return a}text({text:a}){return a}link({text:a}){return""+a}image({text:a}){return""+a}br(){return""}checkbox({raw:a}){return a}},be=class bt{constructor(n){_(this,"options");_(this,"renderer");_(this,"textRenderer");this.options=n||Re,this.options.renderer=this.options.renderer||new et,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new At}static parse(n,e){return new bt(e).parse(n)}static parseInline(n,e){return new bt(e).parseInline(n)}parse(n){var t,r;this.renderer.parser=this;let e="";for(let s=0;s<n.length;s++){let i=n[s];if((r=(t=this.options.extensions)==null?void 0:t.renderers)!=null&&r[i.type]){let l=i,d=this.options.extensions.renderers[l.type].call({parser:this},l);if(d!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(l.type)){e+=d||"";continue}}let o=i;switch(o.type){case"space":{e+=this.renderer.space(o);break}case"hr":{e+=this.renderer.hr(o);break}case"heading":{e+=this.renderer.heading(o);break}case"code":{e+=this.renderer.code(o);break}case"table":{e+=this.renderer.table(o);break}case"blockquote":{e+=this.renderer.blockquote(o);break}case"list":{e+=this.renderer.list(o);break}case"checkbox":{e+=this.renderer.checkbox(o);break}case"html":{e+=this.renderer.html(o);break}case"def":{e+=this.renderer.def(o);break}case"paragraph":{e+=this.renderer.paragraph(o);break}case"text":{e+=this.renderer.text(o);break}default:{let l='Token with "'+o.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return e}parseInline(n,e=this.renderer){var r,s;this.renderer.parser=this;let t="";for(let i=0;i<n.length;i++){let o=n[i];if((s=(r=this.options.extensions)==null?void 0:r.renderers)!=null&&s[o.type]){let d=this.options.extensions.renderers[o.type].call({parser:this},o);if(d!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(o.type)){t+=d||"";continue}}let l=o;switch(l.type){case"escape":{t+=e.text(l);break}case"html":{t+=e.html(l);break}case"link":{t+=e.link(l);break}case"image":{t+=e.image(l);break}case"checkbox":{t+=e.checkbox(l);break}case"strong":{t+=e.strong(l);break}case"em":{t+=e.em(l);break}case"codespan":{t+=e.codespan(l);break}case"br":{t+=e.br(l);break}case"del":{t+=e.del(l);break}case"text":{t+=e.text(l);break}default:{let d='Token with "'+l.type+'" type was not found.';if(this.options.silent)return console.error(d),"";throw new Error(d)}}}return t}},Qe,ze=(Qe=class{constructor(a){_(this,"options");_(this,"block");this.options=a||Re}preprocess(a){return a}postprocess(a){return a}processAllTokens(a){return a}emStrongMask(a){return a}provideLexer(a=this.block){return a?me.lex:me.lexInline}provideParser(a=this.block){return a?be.parse:be.parseInline}},_(Qe,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),_(Qe,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),Qe),Za=class{constructor(...a){_(this,"defaults",vt());_(this,"options",this.setOptions);_(this,"parse",this.parseMarkdown(!0));_(this,"parseInline",this.parseMarkdown(!1));_(this,"Parser",be);_(this,"Renderer",et);_(this,"TextRenderer",At);_(this,"Lexer",me);_(this,"Tokenizer",Je);_(this,"Hooks",ze);this.use(...a)}walkTokens(a,n){var t,r;let e=[];for(let s of a)switch(e=e.concat(n.call(this,s)),s.type){case"table":{let i=s;for(let o of i.header)e=e.concat(this.walkTokens(o.tokens,n));for(let o of i.rows)for(let l of o)e=e.concat(this.walkTokens(l.tokens,n));break}case"list":{let i=s;e=e.concat(this.walkTokens(i.items,n));break}default:{let i=s;(r=(t=this.defaults.extensions)==null?void 0:t.childTokens)!=null&&r[i.type]?this.defaults.extensions.childTokens[i.type].forEach(o=>{let l=i[o].flat(1/0);e=e.concat(this.walkTokens(l,n))}):i.tokens&&(e=e.concat(this.walkTokens(i.tokens,n)))}}return e}use(...a){let n=this.defaults.extensions||{renderers:{},childTokens:{}};return a.forEach(e=>{let t={...e};if(t.async=this.defaults.async||t.async||!1,e.extensions&&(e.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){let s=n.renderers[r.name];s?n.renderers[r.name]=function(...i){let o=r.renderer.apply(this,i);return o===!1&&(o=s.apply(this,i)),o}:n.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let s=n[r.level];s?s.unshift(r.tokenizer):n[r.level]=[r.tokenizer],r.start&&(r.level==="block"?n.startBlock?n.startBlock.push(r.start):n.startBlock=[r.start]:r.level==="inline"&&(n.startInline?n.startInline.push(r.start):n.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(n.childTokens[r.name]=r.childTokens)}),t.extensions=n),e.renderer){let r=this.defaults.renderer||new et(this.defaults);for(let s in e.renderer){if(!(s in r))throw new Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let i=s,o=e.renderer[i],l=r[i];r[i]=(...d)=>{let u=o.apply(r,d);return u===!1&&(u=l.apply(r,d)),u||""}}t.renderer=r}if(e.tokenizer){let r=this.defaults.tokenizer||new Je(this.defaults);for(let s in e.tokenizer){if(!(s in r))throw new Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let i=s,o=e.tokenizer[i],l=r[i];r[i]=(...d)=>{let u=o.apply(r,d);return u===!1&&(u=l.apply(r,d)),u}}t.tokenizer=r}if(e.hooks){let r=this.defaults.hooks||new ze;for(let s in e.hooks){if(!(s in r))throw new Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let i=s,o=e.hooks[i],l=r[i];ze.passThroughHooks.has(s)?r[i]=d=>{if(this.defaults.async&&ze.passThroughHooksRespectAsync.has(s))return(async()=>{let p=await o.call(r,d);return l.call(r,p)})();let u=o.call(r,d);return l.call(r,u)}:r[i]=(...d)=>{if(this.defaults.async)return(async()=>{let p=await o.apply(r,d);return p===!1&&(p=await l.apply(r,d)),p})();let u=o.apply(r,d);return u===!1&&(u=l.apply(r,d)),u}}t.hooks=r}if(e.walkTokens){let r=this.defaults.walkTokens,s=e.walkTokens;t.walkTokens=function(i){let o=[];return o.push(s.call(this,i)),r&&(o=o.concat(r.call(this,i))),o}}this.defaults={...this.defaults,...t}}),this}setOptions(a){return this.defaults={...this.defaults,...a},this}lexer(a,n){return me.lex(a,n??this.defaults)}parser(a,n){return be.parse(a,n??this.defaults)}parseMarkdown(a){return(n,e)=>{let t={...e},r={...this.defaults,...t},s=this.onError(!!r.silent,!!r.async);if(this.defaults.async===!0&&t.async===!1)return s(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof n>"u"||n===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof n!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(n)+", string expected"));if(r.hooks&&(r.hooks.options=r,r.hooks.block=a),r.async)return(async()=>{let i=r.hooks?await r.hooks.preprocess(n):n,o=await(r.hooks?await r.hooks.provideLexer(a):a?me.lex:me.lexInline)(i,r),l=r.hooks?await r.hooks.processAllTokens(o):o;r.walkTokens&&await Promise.all(this.walkTokens(l,r.walkTokens));let d=await(r.hooks?await r.hooks.provideParser(a):a?be.parse:be.parseInline)(l,r);return r.hooks?await r.hooks.postprocess(d):d})().catch(s);try{r.hooks&&(n=r.hooks.preprocess(n));let i=(r.hooks?r.hooks.provideLexer(a):a?me.lex:me.lexInline)(n,r);r.hooks&&(i=r.hooks.processAllTokens(i)),r.walkTokens&&this.walkTokens(i,r.walkTokens);let o=(r.hooks?r.hooks.provideParser(a):a?be.parse:be.parseInline)(i,r);return r.hooks&&(o=r.hooks.postprocess(o)),o}catch(i){return s(i)}}}onError(a,n){return e=>{if(e.message+=`
Please report this to https://github.com/markedjs/marked.`,a){let t="<p>An error occurred:</p><pre>"+ye(e.message+"",!0)+"</pre>";return n?Promise.resolve(t):t}if(n)return Promise.reject(e);throw e}}},Me=new Za;function j(a,n){return Me.parse(a,n)}j.options=j.setOptions=function(a){return Me.setOptions(a),j.defaults=Me.defaults,fn(j.defaults),j};j.getDefaults=vt;j.defaults=Re;j.use=function(...a){return Me.use(...a),j.defaults=Me.defaults,fn(j.defaults),j};j.walkTokens=function(a,n){return Me.walkTokens(a,n)};j.parseInline=Me.parseInline;j.Parser=be;j.parser=be.parse;j.Renderer=et;j.TextRenderer=At;j.Lexer=me;j.lexer=me.lex;j.Tokenizer=Je;j.Hooks=ze;j.parse=j;j.options;j.setOptions;j.use;j.walkTokens;j.parseInline;be.parse;me.lex;const ln=[{type:"note",icon:'<svg class="octicon octicon-info mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>'},{type:"tip",icon:'<svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>'},{type:"important",icon:'<svg class="octicon octicon-report mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>'},{type:"warning",icon:'<svg class="octicon octicon-alert mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>'},{type:"caution",icon:'<svg class="octicon octicon-stop mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M4.47.22A.749.749 0 0 1 5 0h6c.199 0 .389.079.53.22l4.25 4.25c.141.14.22.331.22.53v6a.749.749 0 0 1-.22.53l-4.25 4.25A.749.749 0 0 1 11 16H5a.749.749 0 0 1-.53-.22L.22 11.53A.749.749 0 0 1 0 11V5c0-.199.079-.389.22-.53Zm.84 1.28L1.5 5.31v5.38l3.81 3.81h5.38l3.81-3.81V5.31L10.69 1.5ZM8 4a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 4Zm0 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>'}];function Xa(a){return a.length?Object.values([...ln,...a].reduce((n,e)=>(n[e.type]=e,n),{})):ln}function cn(a){return`^(?:\\[!${a.toUpperCase()}])\\s*?
*`}function Wa(a){return a.slice(0,1).toUpperCase()+a.slice(1).toLowerCase()}function Ya(a={}){const{className:n="markdown-alert",variants:e=[]}=a,t=Xa(e);return{walkTokens(r){var s,i,o,l;if(r.type!=="blockquote")return;const d=t.find(({type:u})=>new RegExp(cn(u)).test(r.text));if(d){const{type:u,icon:p,title:h=Wa(u),titleClassName:b=`${n}-title`}=d,g=new RegExp(cn(u));Object.assign(r,{type:"alert",meta:{className:n,variant:u,icon:p,title:h,titleClassName:b}});const m=(s=r.tokens)==null?void 0:s[0];if((i=m.raw)!=null&&i.replace(g,"").trim()){const v=m.tokens[0];Object.assign(v,{raw:v.raw.replace(g,""),text:v.text.replace(g,"")}),((o=m.tokens[1])==null?void 0:o.type)==="br"&&m.tokens.splice(1,1)}else(l=r.tokens)==null||l.shift()}},extensions:[{name:"alert",level:"block",renderer({meta:r,tokens:s=[]}){let i=`<div class="${r.className} ${r.className}-${r.variant}">
`;return i+=`<p class="${r.titleClassName}">`,i+=r.icon,i+=r.title,i+=`</p>
`,i+=this.parser.parse(s),i+=`</div>
`,i}}]}}function Ka(a){return a&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a}var pt,dn;function Qa(){if(dn)return pt;dn=1;function a(c){return c instanceof Map?c.clear=c.delete=c.set=function(){throw new Error("map is read-only")}:c instanceof Set&&(c.add=c.clear=c.delete=function(){throw new Error("set is read-only")}),Object.freeze(c),Object.getOwnPropertyNames(c).forEach(f=>{const y=c[f],N=typeof y;(N==="object"||N==="function")&&!Object.isFrozen(y)&&a(y)}),c}class n{constructor(f){f.data===void 0&&(f.data={}),this.data=f.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function e(c){return c.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function t(c,...f){const y=Object.create(null);for(const N in c)y[N]=c[N];return f.forEach(function(N){for(const V in N)y[V]=N[V]}),y}const r="</span>",s=c=>!!c.scope,i=(c,{prefix:f})=>{if(c.startsWith("language:"))return c.replace("language:","language-");if(c.includes(".")){const y=c.split(".");return[`${f}${y.shift()}`,...y.map((N,V)=>`${N}${"_".repeat(V+1)}`)].join(" ")}return`${f}${c}`};class o{constructor(f,y){this.buffer="",this.classPrefix=y.classPrefix,f.walk(this)}addText(f){this.buffer+=e(f)}openNode(f){if(!s(f))return;const y=i(f.scope,{prefix:this.classPrefix});this.span(y)}closeNode(f){s(f)&&(this.buffer+=r)}value(){return this.buffer}span(f){this.buffer+=`<span class="${f}">`}}const l=(c={})=>{const f={children:[]};return Object.assign(f,c),f};class d{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(f){this.top.children.push(f)}openNode(f){const y=l({scope:f});this.add(y),this.stack.push(y)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(f){return this.constructor._walk(f,this.rootNode)}static _walk(f,y){return typeof y=="string"?f.addText(y):y.children&&(f.openNode(y),y.children.forEach(N=>this._walk(f,N)),f.closeNode(y)),f}static _collapse(f){typeof f!="string"&&f.children&&(f.children.every(y=>typeof y=="string")?f.children=[f.children.join("")]:f.children.forEach(y=>{d._collapse(y)}))}}class u extends d{constructor(f){super(),this.options=f}addText(f){f!==""&&this.add(f)}startScope(f){this.openNode(f)}endScope(){this.closeNode()}__addSublanguage(f,y){const N=f.root;y&&(N.scope=`language:${y}`),this.add(N)}toHTML(){return new o(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function p(c){return c?typeof c=="string"?c:c.source:null}function h(c){return m("(?=",c,")")}function b(c){return m("(?:",c,")*")}function g(c){return m("(?:",c,")?")}function m(...c){return c.map(y=>p(y)).join("")}function v(c){const f=c[c.length-1];return typeof f=="object"&&f.constructor===Object?(c.splice(c.length-1,1),f):{}}function w(...c){return"("+(v(c).capture?"":"?:")+c.map(N=>p(N)).join("|")+")"}function S(c){return new RegExp(c.toString()+"|").exec("").length-1}function M(c,f){const y=c&&c.exec(f);return y&&y.index===0}const q=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function U(c,{joinWith:f}){let y=0;return c.map(N=>{y+=1;const V=y;let J=p(N),T="";for(;J.length>0;){const E=q.exec(J);if(!E){T+=J;break}T+=J.substring(0,E.index),J=J.substring(E.index+E[0].length),E[0][0]==="\\"&&E[1]?T+="\\"+String(Number(E[1])+V):(T+=E[0],E[0]==="("&&y++)}return T}).map(N=>`(${N})`).join(f)}const G=/\b\B/,W="[a-zA-Z]\\w*",Q="[a-zA-Z_]\\w*",ie="\\b\\d+(\\.\\d+)?",ue="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",ge="\\b(0b[01]+)",R="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",O=(c={})=>{const f=/^#![ ]*\//;return c.binary&&(c.begin=m(f,/.*\b/,c.binary,/\b.*/)),t({scope:"meta",begin:f,end:/$/,relevance:0,"on:begin":(y,N)=>{y.index!==0&&N.ignoreMatch()}},c)},X={begin:"\\\\[\\s\\S]",relevance:0},ee={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[X]},ae={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[X]},pe={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},P=function(c,f,y={}){const N=t({scope:"comment",begin:c,end:f,contains:[]},y);N.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const V=w("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return N.contains.push({begin:m(/[ ]+/,"(",V,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),N},I=P("//","$"),H=P("/\\*","\\*/"),F=P("#","$"),ce={scope:"number",begin:ie,relevance:0},we={scope:"number",begin:ue,relevance:0},Ne={scope:"number",begin:ge,relevance:0},Te={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[X,{begin:/\[/,end:/\]/,relevance:0,contains:[X]}]},Lt={scope:"title",begin:W,relevance:0},zn={scope:"title",begin:Q,relevance:0},Un={begin:"\\.\\s*"+Q,relevance:0};var qe=Object.freeze({__proto__:null,APOS_STRING_MODE:ee,BACKSLASH_ESCAPE:X,BINARY_NUMBER_MODE:Ne,BINARY_NUMBER_RE:ge,COMMENT:P,C_BLOCK_COMMENT_MODE:H,C_LINE_COMMENT_MODE:I,C_NUMBER_MODE:we,C_NUMBER_RE:ue,END_SAME_AS_BEGIN:function(c){return Object.assign(c,{"on:begin":(f,y)=>{y.data._beginMatch=f[1]},"on:end":(f,y)=>{y.data._beginMatch!==f[1]&&y.ignoreMatch()}})},HASH_COMMENT_MODE:F,IDENT_RE:W,MATCH_NOTHING_RE:G,METHOD_GUARD:Un,NUMBER_MODE:ce,NUMBER_RE:ie,PHRASAL_WORDS_MODE:pe,QUOTE_STRING_MODE:ae,REGEXP_MODE:Te,RE_STARTERS_RE:R,SHEBANG:O,TITLE_MODE:Lt,UNDERSCORE_IDENT_RE:Q,UNDERSCORE_TITLE_MODE:zn});function jn(c,f){c.input[c.index-1]==="."&&f.ignoreMatch()}function qn(c,f){c.className!==void 0&&(c.scope=c.className,delete c.className)}function Gn(c,f){f&&c.beginKeywords&&(c.begin="\\b("+c.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",c.__beforeBegin=jn,c.keywords=c.keywords||c.beginKeywords,delete c.beginKeywords,c.relevance===void 0&&(c.relevance=0))}function Fn(c,f){Array.isArray(c.illegal)&&(c.illegal=w(...c.illegal))}function Zn(c,f){if(c.match){if(c.begin||c.end)throw new Error("begin & end are not supported with match");c.begin=c.match,delete c.match}}function Xn(c,f){c.relevance===void 0&&(c.relevance=1)}const Wn=(c,f)=>{if(!c.beforeMatch)return;if(c.starts)throw new Error("beforeMatch cannot be used with starts");const y=Object.assign({},c);Object.keys(c).forEach(N=>{delete c[N]}),c.keywords=y.keywords,c.begin=m(y.beforeMatch,h(y.begin)),c.starts={relevance:0,contains:[Object.assign(y,{endsParent:!0})]},c.relevance=0,delete y.beforeMatch},Yn=["of","and","for","in","not","or","if","then","parent","list","value"],Kn="keyword";function Ct(c,f,y=Kn){const N=Object.create(null);return typeof c=="string"?V(y,c.split(" ")):Array.isArray(c)?V(y,c):Object.keys(c).forEach(function(J){Object.assign(N,Ct(c[J],f,J))}),N;function V(J,T){f&&(T=T.map(E=>E.toLowerCase())),T.forEach(function(E){const C=E.split("|");N[C[0]]=[J,Qn(C[0],C[1])]})}}function Qn(c,f){return f?Number(f):Vn(c)?0:1}function Vn(c){return Yn.includes(c.toLowerCase())}const Mt={},Ae=c=>{console.error(c)},Rt=(c,...f)=>{console.log(`WARN: ${c}`,...f)},$e=(c,f)=>{Mt[`${c}/${f}`]||(console.log(`Deprecated as of ${c}. ${f}`),Mt[`${c}/${f}`]=!0)},Ge=new Error;function Nt(c,f,{key:y}){let N=0;const V=c[y],J={},T={};for(let E=1;E<=f.length;E++)T[E+N]=V[E],J[E+N]=!0,N+=S(f[E-1]);c[y]=T,c[y]._emit=J,c[y]._multi=!0}function Jn(c){if(Array.isArray(c.begin)){if(c.skip||c.excludeBegin||c.returnBegin)throw Ae("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ge;if(typeof c.beginScope!="object"||c.beginScope===null)throw Ae("beginScope must be object"),Ge;Nt(c,c.begin,{key:"beginScope"}),c.begin=U(c.begin,{joinWith:""})}}function er(c){if(Array.isArray(c.end)){if(c.skip||c.excludeEnd||c.returnEnd)throw Ae("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ge;if(typeof c.endScope!="object"||c.endScope===null)throw Ae("endScope must be object"),Ge;Nt(c,c.end,{key:"endScope"}),c.end=U(c.end,{joinWith:""})}}function tr(c){c.scope&&typeof c.scope=="object"&&c.scope!==null&&(c.beginScope=c.scope,delete c.scope)}function nr(c){tr(c),typeof c.beginScope=="string"&&(c.beginScope={_wrap:c.beginScope}),typeof c.endScope=="string"&&(c.endScope={_wrap:c.endScope}),Jn(c),er(c)}function rr(c){function f(T,E){return new RegExp(p(T),"m"+(c.case_insensitive?"i":"")+(c.unicodeRegex?"u":"")+(E?"g":""))}class y{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(E,C){C.position=this.position++,this.matchIndexes[this.matchAt]=C,this.regexes.push([C,E]),this.matchAt+=S(E)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const E=this.regexes.map(C=>C[1]);this.matcherRe=f(U(E,{joinWith:"|"}),!0),this.lastIndex=0}exec(E){this.matcherRe.lastIndex=this.lastIndex;const C=this.matcherRe.exec(E);if(!C)return null;const re=C.findIndex((Pe,it)=>it>0&&Pe!==void 0),te=this.matchIndexes[re];return C.splice(0,re),Object.assign(C,te)}}class N{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(E){if(this.multiRegexes[E])return this.multiRegexes[E];const C=new y;return this.rules.slice(E).forEach(([re,te])=>C.addRule(re,te)),C.compile(),this.multiRegexes[E]=C,C}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(E,C){this.rules.push([E,C]),C.type==="begin"&&this.count++}exec(E){const C=this.getMatcher(this.regexIndex);C.lastIndex=this.lastIndex;let re=C.exec(E);if(this.resumingScanAtSamePosition()&&!(re&&re.index===this.lastIndex)){const te=this.getMatcher(0);te.lastIndex=this.lastIndex+1,re=te.exec(E)}return re&&(this.regexIndex+=re.position+1,this.regexIndex===this.count&&this.considerAll()),re}}function V(T){const E=new N;return T.contains.forEach(C=>E.addRule(C.begin,{rule:C,type:"begin"})),T.terminatorEnd&&E.addRule(T.terminatorEnd,{type:"end"}),T.illegal&&E.addRule(T.illegal,{type:"illegal"}),E}function J(T,E){const C=T;if(T.isCompiled)return C;[qn,Zn,nr,Wn].forEach(te=>te(T,E)),c.compilerExtensions.forEach(te=>te(T,E)),T.__beforeBegin=null,[Gn,Fn,Xn].forEach(te=>te(T,E)),T.isCompiled=!0;let re=null;return typeof T.keywords=="object"&&T.keywords.$pattern&&(T.keywords=Object.assign({},T.keywords),re=T.keywords.$pattern,delete T.keywords.$pattern),re=re||/\w+/,T.keywords&&(T.keywords=Ct(T.keywords,c.case_insensitive)),C.keywordPatternRe=f(re,!0),E&&(T.begin||(T.begin=/\B|\b/),C.beginRe=f(C.begin),!T.end&&!T.endsWithParent&&(T.end=/\B|\b/),T.end&&(C.endRe=f(C.end)),C.terminatorEnd=p(C.end)||"",T.endsWithParent&&E.terminatorEnd&&(C.terminatorEnd+=(T.end?"|":"")+E.terminatorEnd)),T.illegal&&(C.illegalRe=f(T.illegal)),T.contains||(T.contains=[]),T.contains=[].concat(...T.contains.map(function(te){return ar(te==="self"?T:te)})),T.contains.forEach(function(te){J(te,C)}),T.starts&&J(T.starts,E),C.matcher=V(C),C}if(c.compilerExtensions||(c.compilerExtensions=[]),c.contains&&c.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return c.classNameAliases=t(c.classNameAliases||{}),J(c)}function $t(c){return c?c.endsWithParent||$t(c.starts):!1}function ar(c){return c.variants&&!c.cachedVariants&&(c.cachedVariants=c.variants.map(function(f){return t(c,{variants:null},f)})),c.cachedVariants?c.cachedVariants:$t(c)?t(c,{starts:c.starts?t(c.starts):null}):Object.isFrozen(c)?t(c):c}var sr="11.11.1";class ir extends Error{constructor(f,y){super(f),this.name="HTMLInjectionError",this.html=y}}const st=e,Ot=t,It=Symbol("nomatch"),or=7,Dt=function(c){const f=Object.create(null),y=Object.create(null),N=[];let V=!0;const J="Could not find the language '{}', did you forget to load/include a language module?",T={disableAutodetect:!0,name:"Plain text",contains:[]};let E={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function C(x){return E.noHighlightRe.test(x)}function re(x){let L=x.className+" ";L+=x.parentNode?x.parentNode.className:"";const B=E.languageDetectRe.exec(L);if(B){const Y=Ee(B[1]);return Y||(Rt(J.replace("{}",B[1])),Rt("Falling back to no-highlight mode for this block.",x)),Y?B[1]:"no-highlight"}return L.split(/\s+/).find(Y=>C(Y)||Ee(Y))}function te(x,L,B){let Y="",ne="";typeof L=="object"?(Y=x,B=L.ignoreIllegals,ne=L.language):($e("10.7.0","highlight(lang, code, ...args) has been deprecated."),$e("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),ne=x,Y=L),B===void 0&&(B=!0);const fe={code:Y,language:ne};Ze("before:highlight",fe);const _e=fe.result?fe.result:Pe(fe.language,fe.code,B);return _e.code=fe.code,Ze("after:highlight",_e),_e}function Pe(x,L,B,Y){const ne=Object.create(null);function fe(k,A){return k.keywords[A]}function _e(){if(!$.keywords){se.addText(K);return}let k=0;$.keywordPatternRe.lastIndex=0;let A=$.keywordPatternRe.exec(K),D="";for(;A;){D+=K.substring(k,A.index);const Z=ve.case_insensitive?A[0].toLowerCase():A[0],oe=fe($,Z);if(oe){const[ke,_r]=oe;if(se.addText(D),D="",ne[Z]=(ne[Z]||0)+1,ne[Z]<=or&&(Ye+=_r),ke.startsWith("_"))D+=A[0];else{const Sr=ve.classNameAliases[ke]||ke;xe(A[0],Sr)}}else D+=A[0];k=$.keywordPatternRe.lastIndex,A=$.keywordPatternRe.exec(K)}D+=K.substring(k),se.addText(D)}function Xe(){if(K==="")return;let k=null;if(typeof $.subLanguage=="string"){if(!f[$.subLanguage]){se.addText(K);return}k=Pe($.subLanguage,K,!0,Gt[$.subLanguage]),Gt[$.subLanguage]=k._top}else k=ot(K,$.subLanguage.length?$.subLanguage:null);$.relevance>0&&(Ye+=k.relevance),se.__addSublanguage(k._emitter,k.language)}function he(){$.subLanguage!=null?Xe():_e(),K=""}function xe(k,A){k!==""&&(se.startScope(A),se.addText(k),se.endScope())}function zt(k,A){let D=1;const Z=A.length-1;for(;D<=Z;){if(!k._emit[D]){D++;continue}const oe=ve.classNameAliases[k[D]]||k[D],ke=A[D];oe?xe(ke,oe):(K=ke,_e(),K=""),D++}}function Ut(k,A){return k.scope&&typeof k.scope=="string"&&se.openNode(ve.classNameAliases[k.scope]||k.scope),k.beginScope&&(k.beginScope._wrap?(xe(K,ve.classNameAliases[k.beginScope._wrap]||k.beginScope._wrap),K=""):k.beginScope._multi&&(zt(k.beginScope,A),K="")),$=Object.create(k,{parent:{value:$}}),$}function jt(k,A,D){let Z=M(k.endRe,D);if(Z){if(k["on:end"]){const oe=new n(k);k["on:end"](A,oe),oe.isMatchIgnored&&(Z=!1)}if(Z){for(;k.endsParent&&k.parent;)k=k.parent;return k}}if(k.endsWithParent)return jt(k.parent,A,D)}function vr(k){return $.matcher.regexIndex===0?(K+=k[0],1):(ut=!0,0)}function yr(k){const A=k[0],D=k.rule,Z=new n(D),oe=[D.__beforeBegin,D["on:begin"]];for(const ke of oe)if(ke&&(ke(k,Z),Z.isMatchIgnored))return vr(A);return D.skip?K+=A:(D.excludeBegin&&(K+=A),he(),!D.returnBegin&&!D.excludeBegin&&(K=A)),Ut(D,k),D.returnBegin?0:A.length}function kr(k){const A=k[0],D=L.substring(k.index),Z=jt($,k,D);if(!Z)return It;const oe=$;$.endScope&&$.endScope._wrap?(he(),xe(A,$.endScope._wrap)):$.endScope&&$.endScope._multi?(he(),zt($.endScope,k)):oe.skip?K+=A:(oe.returnEnd||oe.excludeEnd||(K+=A),he(),oe.excludeEnd&&(K=A));do $.scope&&se.closeNode(),!$.skip&&!$.subLanguage&&(Ye+=$.relevance),$=$.parent;while($!==Z.parent);return Z.starts&&Ut(Z.starts,k),oe.returnEnd?0:A.length}function wr(){const k=[];for(let A=$;A!==ve;A=A.parent)A.scope&&k.unshift(A.scope);k.forEach(A=>se.openNode(A))}let We={};function qt(k,A){const D=A&&A[0];if(K+=k,D==null)return he(),0;if(We.type==="begin"&&A.type==="end"&&We.index===A.index&&D===""){if(K+=L.slice(A.index,A.index+1),!V){const Z=new Error(`0 width match regex (${x})`);throw Z.languageName=x,Z.badRule=We.rule,Z}return 1}if(We=A,A.type==="begin")return yr(A);if(A.type==="illegal"&&!B){const Z=new Error('Illegal lexeme "'+D+'" for mode "'+($.scope||"<unnamed>")+'"');throw Z.mode=$,Z}else if(A.type==="end"){const Z=kr(A);if(Z!==It)return Z}if(A.type==="illegal"&&D==="")return K+=`
`,1;if(dt>1e5&&dt>A.index*3)throw new Error("potential infinite loop, way more iterations than matches");return K+=D,D.length}const ve=Ee(x);if(!ve)throw Ae(J.replace("{}",x)),new Error('Unknown language: "'+x+'"');const Er=rr(ve);let ct="",$=Y||Er;const Gt={},se=new E.__emitter(E);wr();let K="",Ye=0,Le=0,dt=0,ut=!1;try{if(ve.__emitTokens)ve.__emitTokens(L,se);else{for($.matcher.considerAll();;){dt++,ut?ut=!1:$.matcher.considerAll(),$.matcher.lastIndex=Le;const k=$.matcher.exec(L);if(!k)break;const A=L.substring(Le,k.index),D=qt(A,k);Le=k.index+D}qt(L.substring(Le))}return se.finalize(),ct=se.toHTML(),{language:x,value:ct,relevance:Ye,illegal:!1,_emitter:se,_top:$}}catch(k){if(k.message&&k.message.includes("Illegal"))return{language:x,value:st(L),illegal:!0,relevance:0,_illegalBy:{message:k.message,index:Le,context:L.slice(Le-100,Le+100),mode:k.mode,resultSoFar:ct},_emitter:se};if(V)return{language:x,value:st(L),illegal:!1,relevance:0,errorRaised:k,_emitter:se,_top:$};throw k}}function it(x){const L={value:st(x),illegal:!1,relevance:0,_top:T,_emitter:new E.__emitter(E)};return L._emitter.addText(x),L}function ot(x,L){L=L||E.languages||Object.keys(f);const B=it(x),Y=L.filter(Ee).filter(Ht).map(he=>Pe(he,x,!1));Y.unshift(B);const ne=Y.sort((he,xe)=>{if(he.relevance!==xe.relevance)return xe.relevance-he.relevance;if(he.language&&xe.language){if(Ee(he.language).supersetOf===xe.language)return 1;if(Ee(xe.language).supersetOf===he.language)return-1}return 0}),[fe,_e]=ne,Xe=fe;return Xe.secondBest=_e,Xe}function lr(x,L,B){const Y=L&&y[L]||B;x.classList.add("hljs"),x.classList.add(`language-${Y}`)}function lt(x){let L=null;const B=re(x);if(C(B))return;if(Ze("before:highlightElement",{el:x,language:B}),x.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",x);return}if(x.children.length>0&&(E.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(x)),E.throwUnescapedHTML))throw new ir("One of your code blocks includes unescaped HTML.",x.innerHTML);L=x;const Y=L.textContent,ne=B?te(Y,{language:B,ignoreIllegals:!0}):ot(Y);x.innerHTML=ne.value,x.dataset.highlighted="yes",lr(x,B,ne.language),x.result={language:ne.language,re:ne.relevance,relevance:ne.relevance},ne.secondBest&&(x.secondBest={language:ne.secondBest.language,relevance:ne.secondBest.relevance}),Ze("after:highlightElement",{el:x,result:ne,text:Y})}function cr(x){E=Ot(E,x)}const dr=()=>{Fe(),$e("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function ur(){Fe(),$e("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let Pt=!1;function Fe(){function x(){Fe()}if(document.readyState==="loading"){Pt||window.addEventListener("DOMContentLoaded",x,!1),Pt=!0;return}document.querySelectorAll(E.cssSelector).forEach(lt)}function pr(x,L){let B=null;try{B=L(c)}catch(Y){if(Ae("Language definition for '{}' could not be registered.".replace("{}",x)),V)Ae(Y);else throw Y;B=T}B.name||(B.name=x),f[x]=B,B.rawDefinition=L.bind(null,c),B.aliases&&Bt(B.aliases,{languageName:x})}function hr(x){delete f[x];for(const L of Object.keys(y))y[L]===x&&delete y[L]}function gr(){return Object.keys(f)}function Ee(x){return x=(x||"").toLowerCase(),f[x]||f[y[x]]}function Bt(x,{languageName:L}){typeof x=="string"&&(x=[x]),x.forEach(B=>{y[B.toLowerCase()]=L})}function Ht(x){const L=Ee(x);return L&&!L.disableAutodetect}function fr(x){x["before:highlightBlock"]&&!x["before:highlightElement"]&&(x["before:highlightElement"]=L=>{x["before:highlightBlock"](Object.assign({block:L.el},L))}),x["after:highlightBlock"]&&!x["after:highlightElement"]&&(x["after:highlightElement"]=L=>{x["after:highlightBlock"](Object.assign({block:L.el},L))})}function mr(x){fr(x),N.push(x)}function br(x){const L=N.indexOf(x);L!==-1&&N.splice(L,1)}function Ze(x,L){const B=x;N.forEach(function(Y){Y[B]&&Y[B](L)})}function xr(x){return $e("10.7.0","highlightBlock will be removed entirely in v12.0"),$e("10.7.0","Please use highlightElement now."),lt(x)}Object.assign(c,{highlight:te,highlightAuto:ot,highlightAll:Fe,highlightElement:lt,highlightBlock:xr,configure:cr,initHighlighting:dr,initHighlightingOnLoad:ur,registerLanguage:pr,unregisterLanguage:hr,listLanguages:gr,getLanguage:Ee,registerAliases:Bt,autoDetection:Ht,inherit:Ot,addPlugin:mr,removePlugin:br}),c.debugMode=function(){V=!1},c.safeMode=function(){V=!0},c.versionString=sr,c.regex={concat:m,lookahead:h,either:w,optional:g,anyNumberOfTimes:b};for(const x in qe)typeof qe[x]=="object"&&a(qe[x]);return Object.assign(c,qe),c},Oe=Dt({});return Oe.newInstance=()=>Dt({}),pt=Oe,Oe.HighlightJS=Oe,Oe.default=Oe,pt}var Va=Qa();const de=Ka(Va),un="[A-Za-z$_][0-9A-Za-z$_]*",Ja=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends","using"],es=["true","false","null","undefined","NaN","Infinity"],Sn=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Tn=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],An=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],ts=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],ns=[].concat(An,Sn,Tn);function Ln(a){const n=a.regex,e=(P,{after:I})=>{const H="</"+P[0].slice(1);return P.input.indexOf(H,I)!==-1},t=un,r={begin:"<>",end:"</>"},s=/<[A-Za-z0-9\\._:-]+\s*\/>/,i={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(P,I)=>{const H=P[0].length+P.index,F=P.input[H];if(F==="<"||F===","){I.ignoreMatch();return}F===">"&&(e(P,{after:H})||I.ignoreMatch());let ce;const we=P.input.substring(H);if(ce=we.match(/^\s*=/)){I.ignoreMatch();return}if((ce=we.match(/^\s+extends\s+/))&&ce.index===0){I.ignoreMatch();return}}},o={$pattern:un,keyword:Ja,literal:es,built_in:ns,"variable.language":ts},l="[0-9](_?[0-9])*",d=`\\.(${l})`,u="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",p={className:"number",variants:[{begin:`(\\b(${u})((${d})|\\.)?|(${d}))[eE][+-]?(${l})\\b`},{begin:`\\b(${u})\\b((${d})\\b|\\.)?|(${d})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},h={className:"subst",begin:"\\$\\{",end:"\\}",keywords:o,contains:[]},b={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"xml"}},g={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"css"}},m={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"graphql"}},v={className:"string",begin:"`",end:"`",contains:[a.BACKSLASH_ESCAPE,h]},S={className:"comment",variants:[a.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:t+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),a.C_BLOCK_COMMENT_MODE,a.C_LINE_COMMENT_MODE]},M=[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,b,g,m,v,{match:/\$\d+/},p];h.contains=M.concat({begin:/\{/,end:/\}/,keywords:o,contains:["self"].concat(M)});const q=[].concat(S,h.contains),U=q.concat([{begin:/(\s*)\(/,end:/\)/,keywords:o,contains:["self"].concat(q)}]),G={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:U},W={variants:[{match:[/class/,/\s+/,t,/\s+/,/extends/,/\s+/,n.concat(t,"(",n.concat(/\./,t),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,t],scope:{1:"keyword",3:"title.class"}}]},Q={relevance:0,match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...Sn,...Tn]}},ie={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},ue={variants:[{match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[G],illegal:/%/},ge={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function R(P){return n.concat("(?!",P.join("|"),")")}const O={match:n.concat(/\b/,R([...An,"super","import"].map(P=>`${P}\\s*\\(`)),t,n.lookahead(/\s*\(/)),className:"title.function",relevance:0},X={begin:n.concat(/\./,n.lookahead(n.concat(t,/(?![0-9A-Za-z$_(])/))),end:t,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},ee={match:[/get|set/,/\s+/,t,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},G]},ae="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+a.UNDERSCORE_IDENT_RE+")\\s*=>",pe={match:[/const|var|let/,/\s+/,t,/\s*/,/=\s*/,/(async\s*)?/,n.lookahead(ae)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[G]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:o,exports:{PARAMS_CONTAINS:U,CLASS_REFERENCE:Q},illegal:/#(?![$_A-z])/,contains:[a.SHEBANG({label:"shebang",binary:"node",relevance:5}),ie,a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,b,g,m,v,S,{match:/\$\d+/},p,Q,{scope:"attr",match:t+n.lookahead(":"),relevance:0},pe,{begin:"("+a.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[S,a.REGEXP_MODE,{className:"function",begin:ae,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:a.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:U}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:r.begin,end:r.end},{match:s},{begin:i.begin,"on:begin":i.isTrulyOpeningTag,end:i.end}],subLanguage:"xml",contains:[{begin:i.begin,end:i.end,skip:!0,contains:["self"]}]}]},ue,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+a.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[G,a.inherit(a.TITLE_MODE,{begin:t,className:"title.function"})]},{match:/\.\.\./,relevance:0},X,{match:"\\$"+t,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[G]},O,ge,W,ee,{match:/\$[(.]/}]}}const tt="[A-Za-z$_][0-9A-Za-z$_]*",Cn=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends","using"],Mn=["true","false","null","undefined","NaN","Infinity"],Rn=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Nn=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],$n=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],On=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],In=[].concat($n,Rn,Nn);function rs(a){const n=a.regex,e=(P,{after:I})=>{const H="</"+P[0].slice(1);return P.input.indexOf(H,I)!==-1},t=tt,r={begin:"<>",end:"</>"},s=/<[A-Za-z0-9\\._:-]+\s*\/>/,i={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(P,I)=>{const H=P[0].length+P.index,F=P.input[H];if(F==="<"||F===","){I.ignoreMatch();return}F===">"&&(e(P,{after:H})||I.ignoreMatch());let ce;const we=P.input.substring(H);if(ce=we.match(/^\s*=/)){I.ignoreMatch();return}if((ce=we.match(/^\s+extends\s+/))&&ce.index===0){I.ignoreMatch();return}}},o={$pattern:tt,keyword:Cn,literal:Mn,built_in:In,"variable.language":On},l="[0-9](_?[0-9])*",d=`\\.(${l})`,u="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",p={className:"number",variants:[{begin:`(\\b(${u})((${d})|\\.)?|(${d}))[eE][+-]?(${l})\\b`},{begin:`\\b(${u})\\b((${d})\\b|\\.)?|(${d})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},h={className:"subst",begin:"\\$\\{",end:"\\}",keywords:o,contains:[]},b={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"xml"}},g={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"css"}},m={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"graphql"}},v={className:"string",begin:"`",end:"`",contains:[a.BACKSLASH_ESCAPE,h]},S={className:"comment",variants:[a.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:t+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),a.C_BLOCK_COMMENT_MODE,a.C_LINE_COMMENT_MODE]},M=[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,b,g,m,v,{match:/\$\d+/},p];h.contains=M.concat({begin:/\{/,end:/\}/,keywords:o,contains:["self"].concat(M)});const q=[].concat(S,h.contains),U=q.concat([{begin:/(\s*)\(/,end:/\)/,keywords:o,contains:["self"].concat(q)}]),G={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:U},W={variants:[{match:[/class/,/\s+/,t,/\s+/,/extends/,/\s+/,n.concat(t,"(",n.concat(/\./,t),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,t],scope:{1:"keyword",3:"title.class"}}]},Q={relevance:0,match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...Rn,...Nn]}},ie={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},ue={variants:[{match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[G],illegal:/%/},ge={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function R(P){return n.concat("(?!",P.join("|"),")")}const O={match:n.concat(/\b/,R([...$n,"super","import"].map(P=>`${P}\\s*\\(`)),t,n.lookahead(/\s*\(/)),className:"title.function",relevance:0},X={begin:n.concat(/\./,n.lookahead(n.concat(t,/(?![0-9A-Za-z$_(])/))),end:t,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},ee={match:[/get|set/,/\s+/,t,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},G]},ae="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+a.UNDERSCORE_IDENT_RE+")\\s*=>",pe={match:[/const|var|let/,/\s+/,t,/\s*/,/=\s*/,/(async\s*)?/,n.lookahead(ae)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[G]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:o,exports:{PARAMS_CONTAINS:U,CLASS_REFERENCE:Q},illegal:/#(?![$_A-z])/,contains:[a.SHEBANG({label:"shebang",binary:"node",relevance:5}),ie,a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,b,g,m,v,S,{match:/\$\d+/},p,Q,{scope:"attr",match:t+n.lookahead(":"),relevance:0},pe,{begin:"("+a.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[S,a.REGEXP_MODE,{className:"function",begin:ae,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:a.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:U}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:r.begin,end:r.end},{match:s},{begin:i.begin,"on:begin":i.isTrulyOpeningTag,end:i.end}],subLanguage:"xml",contains:[{begin:i.begin,end:i.end,skip:!0,contains:["self"]}]}]},ue,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+a.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[G,a.inherit(a.TITLE_MODE,{begin:t,className:"title.function"})]},{match:/\.\.\./,relevance:0},X,{match:"\\$"+t,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[G]},O,ge,W,ee,{match:/\$[(.]/}]}}function Dn(a){const n=a.regex,e=rs(a),t=tt,r=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],s={begin:[/namespace/,/\s+/,a.IDENT_RE],beginScope:{1:"keyword",3:"title.class"}},i={beginKeywords:"interface",end:/\{/,excludeEnd:!0,keywords:{keyword:"interface extends",built_in:r},contains:[e.exports.CLASS_REFERENCE]},o={className:"meta",relevance:10,begin:/^\s*['"]use strict['"]/},l=["type","interface","public","private","protected","implements","declare","abstract","readonly","enum","override","satisfies"],d={$pattern:tt,keyword:Cn.concat(l),literal:Mn,built_in:In.concat(r),"variable.language":On},u={className:"meta",begin:"@"+t},p=(m,v,w)=>{const S=m.contains.findIndex(M=>M.label===v);if(S===-1)throw new Error("can not find mode to replace");m.contains.splice(S,1,w)};Object.assign(e.keywords,d),e.exports.PARAMS_CONTAINS.push(u);const h=e.contains.find(m=>m.scope==="attr"),b=Object.assign({},h,{match:n.concat(t,n.lookahead(/\s*\?:/))});e.exports.PARAMS_CONTAINS.push([e.exports.CLASS_REFERENCE,h,b]),e.contains=e.contains.concat([u,s,i,b]),p(e,"shebang",a.SHEBANG()),p(e,"use_strict",o);const g=e.contains.find(m=>m.label==="func.def");return g.relevance=0,Object.assign(e,{name:"TypeScript",aliases:["ts","tsx","mts","cts"]}),e}function Pn(a){const n=a.regex,e=n.concat(/[\p{L}_]/u,n.optional(/[\p{L}0-9_.-]*:/u),/[\p{L}0-9_.-]*/u),t=/[\p{L}0-9._:-]+/u,r={className:"symbol",begin:/&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;/},s={begin:/\s/,contains:[{className:"keyword",begin:/#?[a-z_][a-z1-9_-]+/,illegal:/\n/}]},i=a.inherit(s,{begin:/\(/,end:/\)/}),o=a.inherit(a.APOS_STRING_MODE,{className:"string"}),l=a.inherit(a.QUOTE_STRING_MODE,{className:"string"}),d={endsWithParent:!0,illegal:/</,relevance:0,contains:[{className:"attr",begin:t,relevance:0},{begin:/=\s*/,relevance:0,contains:[{className:"string",endsParent:!0,variants:[{begin:/"/,end:/"/,contains:[r]},{begin:/'/,end:/'/,contains:[r]},{begin:/[^\s"'=<>`]+/}]}]}]};return{name:"HTML, XML",aliases:["html","xhtml","rss","atom","xjb","xsd","xsl","plist","wsf","svg"],case_insensitive:!0,unicodeRegex:!0,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,relevance:10,contains:[s,l,o,i,{begin:/\[/,end:/\]/,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,contains:[s,i,l,o]}]}]},a.COMMENT(/<!--/,/-->/,{relevance:10}),{begin:/<!\[CDATA\[/,end:/\]\]>/,relevance:10},r,{className:"meta",end:/\?>/,variants:[{begin:/<\?xml/,relevance:10,contains:[l]},{begin:/<\?[a-z][a-z0-9]+/}]},{className:"tag",begin:/<style(?=\s|>)/,end:/>/,keywords:{name:"style"},contains:[d],starts:{end:/<\/style>/,returnEnd:!0,subLanguage:["css","xml"]}},{className:"tag",begin:/<script(?=\s|>)/,end:/>/,keywords:{name:"script"},contains:[d],starts:{end:/<\/script>/,returnEnd:!0,subLanguage:["javascript","handlebars","xml"]}},{className:"tag",begin:/<>|<\/>/},{className:"tag",begin:n.concat(/</,n.lookahead(n.concat(e,n.either(/\/>/,/>/,/\s/)))),end:/\/?>/,contains:[{className:"name",begin:e,relevance:0,starts:d}]},{className:"tag",begin:n.concat(/<\//,n.lookahead(n.concat(e,/>/))),contains:[{className:"name",begin:e,relevance:0},{begin:/>/,relevance:0,endsParent:!0}]}]}}const as=a=>({IMPORTANT:{scope:"meta",begin:"!important"},BLOCK_COMMENT:a.C_BLOCK_COMMENT_MODE,HEXCOLOR:{scope:"number",begin:/#(([0-9a-fA-F]{3,4})|(([0-9a-fA-F]{2}){3,4}))\b/},FUNCTION_DISPATCH:{className:"built_in",begin:/[\w-]+(?=\()/},ATTRIBUTE_SELECTOR_MODE:{scope:"selector-attr",begin:/\[/,end:/\]/,illegal:"$",contains:[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE]},CSS_NUMBER_MODE:{scope:"number",begin:a.NUMBER_RE+"(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?",relevance:0},CSS_VARIABLE:{className:"attr",begin:/--[A-Za-z_][A-Za-z0-9_-]*/}}),ss=["a","abbr","address","article","aside","audio","b","blockquote","body","button","canvas","caption","cite","code","dd","del","details","dfn","div","dl","dt","em","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","html","i","iframe","img","input","ins","kbd","label","legend","li","main","mark","menu","nav","object","ol","optgroup","option","p","picture","q","quote","samp","section","select","source","span","strong","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","ul","var","video"],is=["defs","g","marker","mask","pattern","svg","switch","symbol","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feFlood","feGaussianBlur","feImage","feMerge","feMorphology","feOffset","feSpecularLighting","feTile","feTurbulence","linearGradient","radialGradient","stop","circle","ellipse","image","line","path","polygon","polyline","rect","text","use","textPath","tspan","foreignObject","clipPath"],os=[...ss,...is],ls=["any-hover","any-pointer","aspect-ratio","color","color-gamut","color-index","device-aspect-ratio","device-height","device-width","display-mode","forced-colors","grid","height","hover","inverted-colors","monochrome","orientation","overflow-block","overflow-inline","pointer","prefers-color-scheme","prefers-contrast","prefers-reduced-motion","prefers-reduced-transparency","resolution","scan","scripting","update","width","min-width","max-width","min-height","max-height"].sort().reverse(),cs=["active","any-link","blank","checked","current","default","defined","dir","disabled","drop","empty","enabled","first","first-child","first-of-type","fullscreen","future","focus","focus-visible","focus-within","has","host","host-context","hover","indeterminate","in-range","invalid","is","lang","last-child","last-of-type","left","link","local-link","not","nth-child","nth-col","nth-last-child","nth-last-col","nth-last-of-type","nth-of-type","only-child","only-of-type","optional","out-of-range","past","placeholder-shown","read-only","read-write","required","right","root","scope","target","target-within","user-invalid","valid","visited","where"].sort().reverse(),ds=["after","backdrop","before","cue","cue-region","first-letter","first-line","grammar-error","marker","part","placeholder","selection","slotted","spelling-error"].sort().reverse(),us=["accent-color","align-content","align-items","align-self","alignment-baseline","all","anchor-name","animation","animation-composition","animation-delay","animation-direction","animation-duration","animation-fill-mode","animation-iteration-count","animation-name","animation-play-state","animation-range","animation-range-end","animation-range-start","animation-timeline","animation-timing-function","appearance","aspect-ratio","backdrop-filter","backface-visibility","background","background-attachment","background-blend-mode","background-clip","background-color","background-image","background-origin","background-position","background-position-x","background-position-y","background-repeat","background-size","baseline-shift","block-size","border","border-block","border-block-color","border-block-end","border-block-end-color","border-block-end-style","border-block-end-width","border-block-start","border-block-start-color","border-block-start-style","border-block-start-width","border-block-style","border-block-width","border-bottom","border-bottom-color","border-bottom-left-radius","border-bottom-right-radius","border-bottom-style","border-bottom-width","border-collapse","border-color","border-end-end-radius","border-end-start-radius","border-image","border-image-outset","border-image-repeat","border-image-slice","border-image-source","border-image-width","border-inline","border-inline-color","border-inline-end","border-inline-end-color","border-inline-end-style","border-inline-end-width","border-inline-start","border-inline-start-color","border-inline-start-style","border-inline-start-width","border-inline-style","border-inline-width","border-left","border-left-color","border-left-style","border-left-width","border-radius","border-right","border-right-color","border-right-style","border-right-width","border-spacing","border-start-end-radius","border-start-start-radius","border-style","border-top","border-top-color","border-top-left-radius","border-top-right-radius","border-top-style","border-top-width","border-width","bottom","box-align","box-decoration-break","box-direction","box-flex","box-flex-group","box-lines","box-ordinal-group","box-orient","box-pack","box-shadow","box-sizing","break-after","break-before","break-inside","caption-side","caret-color","clear","clip","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","color-scheme","column-count","column-fill","column-gap","column-rule","column-rule-color","column-rule-style","column-rule-width","column-span","column-width","columns","contain","contain-intrinsic-block-size","contain-intrinsic-height","contain-intrinsic-inline-size","contain-intrinsic-size","contain-intrinsic-width","container","container-name","container-type","content","content-visibility","counter-increment","counter-reset","counter-set","cue","cue-after","cue-before","cursor","cx","cy","direction","display","dominant-baseline","empty-cells","enable-background","field-sizing","fill","fill-opacity","fill-rule","filter","flex","flex-basis","flex-direction","flex-flow","flex-grow","flex-shrink","flex-wrap","float","flood-color","flood-opacity","flow","font","font-display","font-family","font-feature-settings","font-kerning","font-language-override","font-optical-sizing","font-palette","font-size","font-size-adjust","font-smooth","font-smoothing","font-stretch","font-style","font-synthesis","font-synthesis-position","font-synthesis-small-caps","font-synthesis-style","font-synthesis-weight","font-variant","font-variant-alternates","font-variant-caps","font-variant-east-asian","font-variant-emoji","font-variant-ligatures","font-variant-numeric","font-variant-position","font-variation-settings","font-weight","forced-color-adjust","gap","glyph-orientation-horizontal","glyph-orientation-vertical","grid","grid-area","grid-auto-columns","grid-auto-flow","grid-auto-rows","grid-column","grid-column-end","grid-column-start","grid-gap","grid-row","grid-row-end","grid-row-start","grid-template","grid-template-areas","grid-template-columns","grid-template-rows","hanging-punctuation","height","hyphenate-character","hyphenate-limit-chars","hyphens","icon","image-orientation","image-rendering","image-resolution","ime-mode","initial-letter","initial-letter-align","inline-size","inset","inset-area","inset-block","inset-block-end","inset-block-start","inset-inline","inset-inline-end","inset-inline-start","isolation","justify-content","justify-items","justify-self","kerning","left","letter-spacing","lighting-color","line-break","line-height","line-height-step","list-style","list-style-image","list-style-position","list-style-type","margin","margin-block","margin-block-end","margin-block-start","margin-bottom","margin-inline","margin-inline-end","margin-inline-start","margin-left","margin-right","margin-top","margin-trim","marker","marker-end","marker-mid","marker-start","marks","mask","mask-border","mask-border-mode","mask-border-outset","mask-border-repeat","mask-border-slice","mask-border-source","mask-border-width","mask-clip","mask-composite","mask-image","mask-mode","mask-origin","mask-position","mask-repeat","mask-size","mask-type","masonry-auto-flow","math-depth","math-shift","math-style","max-block-size","max-height","max-inline-size","max-width","min-block-size","min-height","min-inline-size","min-width","mix-blend-mode","nav-down","nav-index","nav-left","nav-right","nav-up","none","normal","object-fit","object-position","offset","offset-anchor","offset-distance","offset-path","offset-position","offset-rotate","opacity","order","orphans","outline","outline-color","outline-offset","outline-style","outline-width","overflow","overflow-anchor","overflow-block","overflow-clip-margin","overflow-inline","overflow-wrap","overflow-x","overflow-y","overlay","overscroll-behavior","overscroll-behavior-block","overscroll-behavior-inline","overscroll-behavior-x","overscroll-behavior-y","padding","padding-block","padding-block-end","padding-block-start","padding-bottom","padding-inline","padding-inline-end","padding-inline-start","padding-left","padding-right","padding-top","page","page-break-after","page-break-before","page-break-inside","paint-order","pause","pause-after","pause-before","perspective","perspective-origin","place-content","place-items","place-self","pointer-events","position","position-anchor","position-visibility","print-color-adjust","quotes","r","resize","rest","rest-after","rest-before","right","rotate","row-gap","ruby-align","ruby-position","scale","scroll-behavior","scroll-margin","scroll-margin-block","scroll-margin-block-end","scroll-margin-block-start","scroll-margin-bottom","scroll-margin-inline","scroll-margin-inline-end","scroll-margin-inline-start","scroll-margin-left","scroll-margin-right","scroll-margin-top","scroll-padding","scroll-padding-block","scroll-padding-block-end","scroll-padding-block-start","scroll-padding-bottom","scroll-padding-inline","scroll-padding-inline-end","scroll-padding-inline-start","scroll-padding-left","scroll-padding-right","scroll-padding-top","scroll-snap-align","scroll-snap-stop","scroll-snap-type","scroll-timeline","scroll-timeline-axis","scroll-timeline-name","scrollbar-color","scrollbar-gutter","scrollbar-width","shape-image-threshold","shape-margin","shape-outside","shape-rendering","speak","speak-as","src","stop-color","stop-opacity","stroke","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke-width","tab-size","table-layout","text-align","text-align-all","text-align-last","text-anchor","text-combine-upright","text-decoration","text-decoration-color","text-decoration-line","text-decoration-skip","text-decoration-skip-ink","text-decoration-style","text-decoration-thickness","text-emphasis","text-emphasis-color","text-emphasis-position","text-emphasis-style","text-indent","text-justify","text-orientation","text-overflow","text-rendering","text-shadow","text-size-adjust","text-transform","text-underline-offset","text-underline-position","text-wrap","text-wrap-mode","text-wrap-style","timeline-scope","top","touch-action","transform","transform-box","transform-origin","transform-style","transition","transition-behavior","transition-delay","transition-duration","transition-property","transition-timing-function","translate","unicode-bidi","user-modify","user-select","vector-effect","vertical-align","view-timeline","view-timeline-axis","view-timeline-inset","view-timeline-name","view-transition-name","visibility","voice-balance","voice-duration","voice-family","voice-pitch","voice-range","voice-rate","voice-stress","voice-volume","white-space","white-space-collapse","widows","width","will-change","word-break","word-spacing","word-wrap","writing-mode","x","y","z-index","zoom"].sort().reverse();function ps(a){const n=a.regex,e=as(a),t={begin:/-(webkit|moz|ms|o)-(?=[a-z])/},r="and or not only",s=/@-?\w[\w]*(-\w+)*/,i="[a-zA-Z-][a-zA-Z0-9_-]*",o=[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE];return{name:"CSS",case_insensitive:!0,illegal:/[=|'\$]/,keywords:{keyframePosition:"from to"},classNameAliases:{keyframePosition:"selector-tag"},contains:[e.BLOCK_COMMENT,t,e.CSS_NUMBER_MODE,{className:"selector-id",begin:/#[A-Za-z0-9_-]+/,relevance:0},{className:"selector-class",begin:"\\."+i,relevance:0},e.ATTRIBUTE_SELECTOR_MODE,{className:"selector-pseudo",variants:[{begin:":("+cs.join("|")+")"},{begin:":(:)?("+ds.join("|")+")"}]},e.CSS_VARIABLE,{className:"attribute",begin:"\\b("+us.join("|")+")\\b"},{begin:/:/,end:/[;}{]/,contains:[e.BLOCK_COMMENT,e.HEXCOLOR,e.IMPORTANT,e.CSS_NUMBER_MODE,...o,{begin:/(url|data-uri)\(/,end:/\)/,relevance:0,keywords:{built_in:"url data-uri"},contains:[...o,{className:"string",begin:/[^)]/,endsWithParent:!0,excludeEnd:!0}]},e.FUNCTION_DISPATCH]},{begin:n.lookahead(/@/),end:"[{;]",relevance:0,illegal:/:/,contains:[{className:"keyword",begin:s},{begin:/\s/,endsWithParent:!0,excludeEnd:!0,relevance:0,keywords:{$pattern:/[a-z-]+/,keyword:r,attribute:ls.join(" ")},contains:[{begin:/[a-z-]+(?=:)/,className:"attribute"},...o,e.CSS_NUMBER_MODE]}]},{className:"selector-tag",begin:"\\b("+os.join("|")+")\\b"}]}}function hs(a){const n=a.regex,e=new RegExp("[\\p{XID_Start}_]\\p{XID_Continue}*","u"),t=["and","as","assert","async","await","break","case","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","match","nonlocal|10","not","or","pass","raise","return","try","while","with","yield"],o={$pattern:/[A-Za-z]\w+|__\w+__/,keyword:t,built_in:["__import__","abs","all","any","ascii","bin","bool","breakpoint","bytearray","bytes","callable","chr","classmethod","compile","complex","delattr","dict","dir","divmod","enumerate","eval","exec","filter","float","format","frozenset","getattr","globals","hasattr","hash","help","hex","id","input","int","isinstance","issubclass","iter","len","list","locals","map","max","memoryview","min","next","object","oct","open","ord","pow","print","property","range","repr","reversed","round","set","setattr","slice","sorted","staticmethod","str","sum","super","tuple","type","vars","zip"],literal:["__debug__","Ellipsis","False","None","NotImplemented","True"],type:["Any","Callable","Coroutine","Dict","List","Literal","Generic","Optional","Sequence","Set","Tuple","Type","Union"]},l={className:"meta",begin:/^(>>>|\.\.\.) /},d={className:"subst",begin:/\{/,end:/\}/,keywords:o,illegal:/#/},u={begin:/\{\{/,relevance:0},p={className:"string",contains:[a.BACKSLASH_ESCAPE],variants:[{begin:/([uU]|[bB]|[rR]|[bB][rR]|[rR][bB])?'''/,end:/'''/,contains:[a.BACKSLASH_ESCAPE,l],relevance:10},{begin:/([uU]|[bB]|[rR]|[bB][rR]|[rR][bB])?"""/,end:/"""/,contains:[a.BACKSLASH_ESCAPE,l],relevance:10},{begin:/([fF][rR]|[rR][fF]|[fF])'''/,end:/'''/,contains:[a.BACKSLASH_ESCAPE,l,u,d]},{begin:/([fF][rR]|[rR][fF]|[fF])"""/,end:/"""/,contains:[a.BACKSLASH_ESCAPE,l,u,d]},{begin:/([uU]|[rR])'/,end:/'/,relevance:10},{begin:/([uU]|[rR])"/,end:/"/,relevance:10},{begin:/([bB]|[bB][rR]|[rR][bB])'/,end:/'/},{begin:/([bB]|[bB][rR]|[rR][bB])"/,end:/"/},{begin:/([fF][rR]|[rR][fF]|[fF])'/,end:/'/,contains:[a.BACKSLASH_ESCAPE,u,d]},{begin:/([fF][rR]|[rR][fF]|[fF])"/,end:/"/,contains:[a.BACKSLASH_ESCAPE,u,d]},a.APOS_STRING_MODE,a.QUOTE_STRING_MODE]},h="[0-9](_?[0-9])*",b=`(\\b(${h}))?\\.(${h})|\\b(${h})\\.`,g=`\\b|${t.join("|")}`,m={className:"number",relevance:0,variants:[{begin:`(\\b(${h})|(${b}))[eE][+-]?(${h})[jJ]?(?=${g})`},{begin:`(${b})[jJ]?`},{begin:`\\b([1-9](_?[0-9])*|0+(_?0)*)[lLjJ]?(?=${g})`},{begin:`\\b0[bB](_?[01])+[lL]?(?=${g})`},{begin:`\\b0[oO](_?[0-7])+[lL]?(?=${g})`},{begin:`\\b0[xX](_?[0-9a-fA-F])+[lL]?(?=${g})`},{begin:`\\b(${h})[jJ](?=${g})`}]},v={className:"comment",begin:n.lookahead(/# type:/),end:/$/,keywords:o,contains:[{begin:/# type:/},{begin:/#/,end:/\b\B/,endsWithParent:!0}]},w={className:"params",variants:[{className:"",begin:/\(\s*\)/,skip:!0},{begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:["self",l,m,p,a.HASH_COMMENT_MODE]}]};return d.contains=[p,m,l],{name:"Python",aliases:["py","gyp","ipython"],unicodeRegex:!0,keywords:o,illegal:/(<\/|\?)|=>/,contains:[l,m,{scope:"variable.language",match:/\bself\b/},{beginKeywords:"if",relevance:0},{match:/\bor\b/,scope:"keyword"},p,v,a.HASH_COMMENT_MODE,{match:[/\bdef/,/\s+/,e],scope:{1:"keyword",3:"title.function"},contains:[w]},{variants:[{match:[/\bclass/,/\s+/,e,/\s*/,/\(\s*/,e,/\s*\)/]},{match:[/\bclass/,/\s+/,e]}],scope:{1:"keyword",3:"title.class",6:"title.class.inherited"}},{className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[m,w,p]}]}}function gs(a){const n={className:"attr",begin:/"(\\.|[^\\"\r\n])*"(?=\s*:)/,relevance:1.01},e={match:/[{}[\],:]/,className:"punctuation",relevance:0},t=["true","false","null"],r={scope:"literal",beginKeywords:t.join(" ")};return{name:"JSON",aliases:["jsonc"],keywords:{literal:t},contains:[n,e,a.QUOTE_STRING_MODE,r,a.C_NUMBER_MODE,a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE],illegal:"\\S"}}function Bn(a){const n=a.regex,e={},t={begin:/\$\{/,end:/\}/,contains:["self",{begin:/:-/,contains:[e]}]};Object.assign(e,{className:"variable",variants:[{begin:n.concat(/\$[\w\d#@][\w\d_]*/,"(?![\\w\\d])(?![$])")},t]});const r={className:"subst",begin:/\$\(/,end:/\)/,contains:[a.BACKSLASH_ESCAPE]},s=a.inherit(a.COMMENT(),{match:[/(^|\s)/,/#.*$/],scope:{2:"comment"}}),i={begin:/<<-?\s*(?=\w+)/,starts:{contains:[a.END_SAME_AS_BEGIN({begin:/(\w+)/,end:/(\w+)/,className:"string"})]}},o={className:"string",begin:/"/,end:/"/,contains:[a.BACKSLASH_ESCAPE,e,r]};r.contains.push(o);const l={match:/\\"/},d={className:"string",begin:/'/,end:/'/},u={match:/\\'/},p={begin:/\$?\(\(/,end:/\)\)/,contains:[{begin:/\d+#[0-9a-f]+/,className:"number"},a.NUMBER_MODE,e]},h=["fish","bash","zsh","sh","csh","ksh","tcsh","dash","scsh"],b=a.SHEBANG({binary:`(${h.join("|")})`,relevance:10}),g={className:"function",begin:/\w[\w\d_]*\s*\(\s*\)\s*\{/,returnBegin:!0,contains:[a.inherit(a.TITLE_MODE,{begin:/\w[\w\d_]*/})],relevance:0},m=["if","then","else","elif","fi","time","for","while","until","in","do","done","case","esac","coproc","function","select"],v=["true","false"],w={match:/(\/[a-z._-]+)+/},S=["break","cd","continue","eval","exec","exit","export","getopts","hash","pwd","readonly","return","shift","test","times","trap","umask","unset"],M=["alias","bind","builtin","caller","command","declare","echo","enable","help","let","local","logout","mapfile","printf","read","readarray","source","sudo","type","typeset","ulimit","unalias"],q=["autoload","bg","bindkey","bye","cap","chdir","clone","comparguments","compcall","compctl","compdescribe","compfiles","compgroups","compquote","comptags","comptry","compvalues","dirs","disable","disown","echotc","echoti","emulate","fc","fg","float","functions","getcap","getln","history","integer","jobs","kill","limit","log","noglob","popd","print","pushd","pushln","rehash","sched","setcap","setopt","stat","suspend","ttyctl","unfunction","unhash","unlimit","unsetopt","vared","wait","whence","where","which","zcompile","zformat","zftp","zle","zmodload","zparseopts","zprof","zpty","zregexparse","zsocket","zstyle","ztcp"],U=["chcon","chgrp","chown","chmod","cp","dd","df","dir","dircolors","ln","ls","mkdir","mkfifo","mknod","mktemp","mv","realpath","rm","rmdir","shred","sync","touch","truncate","vdir","b2sum","base32","base64","cat","cksum","comm","csplit","cut","expand","fmt","fold","head","join","md5sum","nl","numfmt","od","paste","ptx","pr","sha1sum","sha224sum","sha256sum","sha384sum","sha512sum","shuf","sort","split","sum","tac","tail","tr","tsort","unexpand","uniq","wc","arch","basename","chroot","date","dirname","du","echo","env","expr","factor","groups","hostid","id","link","logname","nice","nohup","nproc","pathchk","pinky","printenv","printf","pwd","readlink","runcon","seq","sleep","stat","stdbuf","stty","tee","test","timeout","tty","uname","unlink","uptime","users","who","whoami","yes"];return{name:"Bash",aliases:["sh","zsh"],keywords:{$pattern:/\b[a-z][a-z0-9._-]+\b/,keyword:m,literal:v,built_in:[...S,...M,"set","shopt",...q,...U]},contains:[b,a.SHEBANG(),g,p,s,i,w,o,l,d,u,e]}}function Hn(a){const n=a.regex,e={begin:/<\/?[A-Za-z_]/,end:">",subLanguage:"xml",relevance:0},t={begin:"^[-\\*]{3,}",end:"$"},r={className:"code",variants:[{begin:"(`{3,})[^`](.|\\n)*?\\1`*[ ]*"},{begin:"(~{3,})[^~](.|\\n)*?\\1~*[ ]*"},{begin:"```",end:"```+[ ]*$"},{begin:"~~~",end:"~~~+[ ]*$"},{begin:"`.+?`"},{begin:"(?=^( {4}|\\t))",contains:[{begin:"^( {4}|\\t)",end:"(\\n)$"}],relevance:0}]},s={className:"bullet",begin:"^[ 	]*([*+-]|(\\d+\\.))(?=\\s+)",end:"\\s+",excludeEnd:!0},i={begin:/^\[[^\n]+\]:/,returnBegin:!0,contains:[{className:"symbol",begin:/\[/,end:/\]/,excludeBegin:!0,excludeEnd:!0},{className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]},o=/[A-Za-z][A-Za-z0-9+.-]*/,l={variants:[{begin:/\[.+?\]\[.*?\]/,relevance:0},{begin:/\[.+?\]\(((data|javascript|mailto):|(?:http|ftp)s?:\/\/).*?\)/,relevance:2},{begin:n.concat(/\[.+?\]\(/,o,/:\/\/.*?\)/),relevance:2},{begin:/\[.+?\]\([./?&#].*?\)/,relevance:1},{begin:/\[.*?\]\(.*?\)/,relevance:0}],returnBegin:!0,contains:[{match:/\[(?=\])/},{className:"string",relevance:0,begin:"\\[",end:"\\]",excludeBegin:!0,returnEnd:!0},{className:"link",relevance:0,begin:"\\]\\(",end:"\\)",excludeBegin:!0,excludeEnd:!0},{className:"symbol",relevance:0,begin:"\\]\\[",end:"\\]",excludeBegin:!0,excludeEnd:!0}]},d={className:"strong",contains:[],variants:[{begin:/_{2}(?!\s)/,end:/_{2}/},{begin:/\*{2}(?!\s)/,end:/\*{2}/}]},u={className:"emphasis",contains:[],variants:[{begin:/\*(?![*\s])/,end:/\*/},{begin:/_(?![_\s])/,end:/_/,relevance:0}]},p=a.inherit(d,{contains:[]}),h=a.inherit(u,{contains:[]});d.contains.push(h),u.contains.push(p);let b=[e,l];return[d,u,p,h].forEach(w=>{w.contains=w.contains.concat(b)}),b=b.concat(d,u),{name:"Markdown",aliases:["md","mkdown","mkd"],contains:[{className:"section",variants:[{begin:"^#{1,6}",end:"$",contains:b},{begin:"(?=^.+?\\n[=-]{2,}$)",contains:[{begin:"^[=-]*$"},{begin:"^",end:"\\n",contains:b}]}]},e,s,d,u,{className:"quote",begin:"^>\\s+",contains:b,end:"$"},r,t,l,i,{scope:"literal",match:/&([a-zA-Z0-9]+|#[0-9]{1,7}|#[Xx][0-9a-fA-F]{1,6});/}]}}de.registerLanguage("javascript",Ln);de.registerLanguage("js",Ln);de.registerLanguage("typescript",Dn);de.registerLanguage("ts",Dn);de.registerLanguage("html",Pn);de.registerLanguage("xml",Pn);de.registerLanguage("css",ps);de.registerLanguage("python",hs);de.registerLanguage("json",gs);de.registerLanguage("bash",Bn);de.registerLanguage("shell",Bn);de.registerLanguage("markdown",Hn);de.registerLanguage("md",Hn);j.setOptions({gfm:!0,breaks:!1});const at=new j.Renderer;at.heading=function({text:a,depth:n}){const e=a.toLowerCase().replace(/<[^>]+>/g,"").replace(/[^\w一-鿿]+/g,"-").replace(/^-|-$/g,"");return`<h${n} id="${e}">${a}</h${n}>`};function Ue(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}at.code=function({text:a,lang:n}){if(n==="mermaid")return`<div class="mermaid">${a}</div>`;const e=n&&de.getLanguage(n);let t="";const r=e?`language-${n}`:"language-plaintext";if(e)try{t=de.highlight(a,{language:n}).value}catch{t=Ue(a)}else t=Ue(a);return`<div class="code-block-wrapper"><div class="code-block-header">${n?`<span class="code-lang-label">${Ue(n)}</span>`:""}<button class="code-copy-btn" onclick="navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('code').textContent).then(()=>{this.textContent='已复制';setTimeout(()=>{this.textContent='复制'},1500)})">复制</button></div><pre><code class="hljs ${r}">${t}</code></pre></div>`};at.image=function({href:a,title:n,text:e}){let t;/^https?:\/\//.test(a)?t=a:t=`/images/${a.split("/").pop()||a}`;const r=n?` title="${Ue(n)}"`:"";return`<img src="${t}" alt="${Ue(e)}"${r}>`};j.use(Ya());j.use({renderer:at});function fs(a){return j.parse(a)}class ms extends HTMLElement{constructor(){super(...arguments);_(this,"_toc",[]);_(this,"_activeId","");_(this,"_article",null);_(this,"_renderedHtml","");_(this,"_scrollHandler",null);_(this,"_headingOffsets",[])}connectedCallback(){const t=new URLSearchParams(window.location.search).get("slug")||window.location.hash.replace("#/","");this._article=gt.find(r=>r.slug===t)||gt[0]||null;try{this.render(),this._article&&(this._buildTOC(),this._cloneTOCToDrawer(),this._setupScrollTracking(),this._setupMobileDrawer())}catch(r){console.error("[emu-article] Error in connectedCallback:",r)}}disconnectedCallback(){this._scrollHandler&&window.removeEventListener("scroll",this._scrollHandler)}_buildTOC(){const e=this.querySelector("#article-toc-list");if(!e||!this._article)return;const t=this.querySelector("#article-body");t&&(this._toc=[],t.querySelectorAll("h2, h3").forEach(r=>{const s=r.getAttribute("id")||"";this._toc.push({id:s,text:r.textContent||"",level:r.tagName==="H2"?2:3})}),e.innerHTML=this._toc.map((r,s)=>{const i=r.level===3?"pl-4":"",o=s===0?"toc-active":"toc-inactive";return`
          <a href="#${r.id}"
             data-toc-id="${r.id}"
             class="toc-item ${o} block py-1.5 text-sm rounded-lg transition-all duration-200 ${i}">
            ${r.text}
          </a>
        `}).join(""))}_setupScrollTracking(){const e=this.querySelector("#article-body"),t=this.querySelector("#article-progress-bar"),r=this.querySelector("#article-toc-list");if(!e)return;this._cacheHeadingOffsets();const s=r?Array.from(r.querySelectorAll(".toc-item")):[];this._scrollHandler=()=>{var l;if(t){const d=this.querySelector("#article-container");if(d){const u=d.getBoundingClientRect(),p=d.scrollHeight-window.innerHeight,h=Math.min(100,Math.max(0,-u.top/p*100));t.style.width=`${h}%`}}const i=window.scrollY+100;let o=((l=this._toc[0])==null?void 0:l.id)||"";for(const d of this._headingOffsets)if(d.top<=i)o=d.id;else break;o!==this._activeId&&(this._activeId=o,s.forEach(d=>{d.dataset.tocId===o?(d.classList.remove("toc-inactive"),d.classList.add("toc-active")):(d.classList.remove("toc-active"),d.classList.add("toc-inactive"))}))},window.addEventListener("scroll",this._scrollHandler,{passive:!0}),this._scrollHandler()}_cacheHeadingOffsets(){const e=this.querySelector("#article-body");e&&(this._headingOffsets=[],e.querySelectorAll("h2, h3").forEach(t=>{this._headingOffsets.push({id:t.id,top:t.getBoundingClientRect().top+window.scrollY})}))}_setupMobileDrawer(){const e=this.querySelector("#toc-toggle-btn"),t=this.querySelector("#toc-drawer"),r=this.querySelector("#toc-drawer-overlay"),s=this.querySelector("#toc-drawer-close");if(!e||!t||!r)return;const i=()=>{t.classList.remove("translate-y-full"),r.classList.remove("opacity-0","pointer-events-none"),document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden"},o=()=>{t.classList.add("translate-y-full"),r.classList.add("opacity-0","pointer-events-none"),document.body.style.overflow="",document.documentElement.style.overflow=""};e.addEventListener("click",i),s==null||s.addEventListener("click",o),r.addEventListener("click",o),t.addEventListener("click",l=>{const d=l.target.closest(".toc-item");if(!d)return;l.preventDefault();const u=d.getAttribute("href");o(),u&&requestAnimationFrame(()=>{const p=document.querySelector(u);p&&p.scrollIntoView({behavior:"smooth",block:"start"})})})}_setupImageLightbox(){const e=this.querySelector("#article-body");e&&e.addEventListener("click",t=>{const r=t.target;if(r.tagName==="IMG"&&r.closest(".article-prose")){const s=r;hn(s.src,s.alt)}})}render(){if(!this._article){this.innerHTML=`
        ...
        </section>`;return}this._renderedHtml=fs(this._article.content);const e=this._renderedHtml;this.innerHTML=`
    ...
    `,this._renderMermaid(),this._setupImageLightbox()}async _renderMermaid(){const e=this.querySelectorAll(".mermaid");if(e.length!==0)try{const{default:t}=await sa(async()=>{const{default:r}=await import("./mermaid.core-BdpHY_M3.js").then(s=>s.aH);return{default:r}},[]);t.initialize({startOnLoad:!1,theme:document.documentElement.classList.contains("dark")?"dark":"default",securityLevel:"loose",fontFamily:"'Hanken Grotesk', sans-serif"}),await t.run({nodes:e})}catch(t){console.warn("[emu-article] mermaid render error:",t)}}_cloneTOCToDrawer(){const e=this.querySelector("#article-toc-list"),t=this.querySelector("#toc-drawer-list");e&&t&&(t.innerHTML=e.innerHTML)}_getStyles(){return`
      /* ── 文章正文排版 ── */
      .article-prose h2 {
    ...
    `}}customElements.define("emu-article",ms);class bs extends HTMLElement{connectedCallback(){this.render()}render(){const n=Zt.related.map(t=>`
        <li>
    ...
    `}}customElements.define("emu-footer",bs);class xs extends HTMLElement{constructor(){super(...arguments);_(this,"_clickCount",0);_(this,"_clickTimer",null);_(this,"_inputBuffer",[]);_(this,"_isActive",!1);_(this,"_clickHandler",null);_(this,"_keydownHandler",null)}connectedCallback(){this.setupStyles(),this.setupEventListeners(),console.log('[EMU-Stu] Win气泡彩蛋已加载。提示：连击 Logo 3次 或键盘输入 "win" 触发！')}disconnectedCallback(){this._clickHandler&&document.removeEventListener("click",this._clickHandler),this._keydownHandler&&window.removeEventListener("keydown",this._keydownHandler)}setupStyles(){const e=document.createElement("style");e.textContent=`
    ...
    `,this.appendChild(e)}setupEventListeners(){this._clickHandler=e=>{e.target.closest('emu-header img[alt="EMU-Stu Logo"]')&&this.handleLogoClick()},document.addEventListener("click",this._clickHandler),this._keydownHandler=e=>{const t=document.activeElement;t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)||e.key.length===1&&/[a-zA-Z]/.test(e.key)&&(this._inputBuffer.push(e.key.toLowerCase()),this._inputBuffer.length>5&&this._inputBuffer.shift(),this._inputBuffer.join("").endsWith("win")&&(this.triggerWinEasterEgg(),this._inputBuffer=[]))},window.addEventListener("keydown",this._keydownHandler)}handleLogoClick(){this._clickCount++,this._clickTimer&&window.clearTimeout(this._clickTimer),this._clickCount>=3?(this.triggerWinEasterEgg(),this._clickCount=0):this._clickTimer=window.setTimeout(()=>{this._clickCount=0},1500)}triggerWinEasterEgg(){if(this._isActive)return;this._isActive=!0,console.log("🚀 迎大(win)！冲鸭！全新交互彩蛋触发成功！"),window.scrollTo({top:0,behavior:"smooth"});const e=document.querySelector("emu-hero #hero-content-wrapper"),t=document.querySelector("emu-hero #hero-easter-egg-container");setTimeout(()=>{e&&(e.style.opacity="0",e.style.transform="translateY(-30px) scale(0.96)",e.style.pointerEvents="none")},150),setTimeout(()=>{this.spawnWinBubbles()},200),setTimeout(()=>{t&&(t.innerHTML=`
        ...
        `,t.style.opacity="1",t.style.transform="translateY(0)",requestAnimationFrame(()=>{const r=t.querySelector(".easter-egg-line1"),s=t.querySelector(".easter-egg-line2");r&&(r.style.opacity="1",r.style.transform="translateY(0)"),s&&(s.style.opacity="1",s.style.transform="translateY(0)")}))},1e3),setTimeout(()=>{this.restoreHero()},6e3)}spawnWinBubbles(){const t=document.createDocumentFragment(),r=[];for(let s=0;s<50;s++){const i=document.createElement("div");i.className="win-bubble-wrapper";const o=document.createElement("div"),l=Math.random()>.5?"bubble-right":"bubble-left";o.className=`win-bubble ${l}`,o.textContent="win";const d=Math.floor(Math.random()*53)+32;o.style.width=`${d}px`,o.style.height=`${d*.72}px`,o.style.fontSize=`${d*.32}px`;const u=Math.random()*90+5,p=Math.random()*80+10;i.style.left=`${u}vw`,i.style.top=`${p}vh`;const h=(Math.random()-.5)*90,b=-Math.random()*120-40;i.style.setProperty("--tx-end",`${h}px`),i.style.setProperty("--ty-end",`${b}px`);const g=Math.random()*1.6,m=Math.random()*.8+2.2;i.style.animation=`win-fly ${m}s cubic-bezier(0.16, 1, 0.3, 1) ${g}s forwards`,o.style.animation=`win-scale-fade ${m}s cubic-bezier(0.25, 1, 0.5, 1) ${g}s forwards`,i.appendChild(o),t.appendChild(i),r.push(i)}document.body.appendChild(t),setTimeout(()=>{r.forEach(s=>s.remove())},5500)}restoreHero(){const e=document.querySelector("emu-hero #hero-content-wrapper"),t=document.querySelector("emu-hero #hero-easter-egg-container");t&&(t.style.opacity="0",t.style.transform="translateY(12px)"),setTimeout(()=>{t&&(t.innerHTML=""),e&&(e.style.opacity="1",e.style.transform="translateY(0) scale(1)",e.style.pointerEvents="auto"),this._isActive=!1},1e3)}}customElements.define("emu-easter-egg",xs);if(typeof window<"u"){document.addEventListener("gesturestart",n=>{n.preventDefault()}),document.addEventListener("touchstart",n=>{n.touches.length>1&&n.preventDefault()},{passive:!1});let a=0;document.addEventListener("touchend",n=>{const e=Date.now();e-a<=300&&n.preventDefault(),a=e},{passive:!1})}export{sa as _,Ka as g};
