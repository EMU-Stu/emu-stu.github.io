var En=Object.defineProperty;var _n=(a,r,e)=>r in a?En(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var S=(a,r,e)=>_n(a,typeof r!="symbol"?r+"":r,e);(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function e(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(n){if(n.ep)return;n.ep=!0;const s=e(n);fetch(n.href,s)}})();const Sn="/assets/emu-stu-logo-D3KqYaZd.png",Tt=Sn,br="EMU-Stu",Jt="应急管理大学开源技术组织",Tn="技术服务校园，开源贡献社区",kt="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z",An=[{label:"首页",href:"#",active:!0},{label:"技术博客",href:"/blog",active:!1}],Ln="https://github.com/EMU-Stu/EMU-Stu-Site",er={related:[{label:"学校官网",href:"https://www.ncist.edu.cn/"},{label:"教务系统",href:"https://jwc.ncist.edu.cn/"},{label:"图书馆",href:"https://lib.ncist.edu.cn/"}],bottom:[{label:"想知道此网站是如何实现的？点击查看文章",href:Ln,underline:!0}]};class Cn extends HTMLElement{constructor(){super(...arguments);S(this,"_menuOpen",!1)}connectedCallback(){this.classList.add("sticky","top-0","z-50","block","w-full"),this.render(),this.setupEventListeners()}render(){const e=window.location.pathname.includes("/blog")||window.location.pathname.includes("/article"),t=An.map(i=>{let o=i.href,l=i.active;return e?i.label==="首页"?(o="/",l=!1):i.label==="技术博客"&&(o="#",l=!0):i.label==="首页"?(o="#",l=!0):i.label==="技术博客"&&(o="/blog",l=!1),{label:i.label,href:o,active:l}}),n=t.map(i=>`
    ...
    `;const e=this.querySelector("#heatmap-dialog"),t=this.querySelector("#close-heatmap-dialog");t==null||t.addEventListener("click",()=>this.close()),e==null||e.addEventListener("click",n=>{n.target===e&&this.close()})}open(){const e=this.querySelector("#heatmap-dialog");e&&(e.showModal(),requestAnimationFrame(()=>{e.classList.remove("opacity-0","scale-95")}),this.renderHeatmap(),this.scrollToLatest())}close(){const e=this.querySelector("#heatmap-dialog");if(!e)return;e.classList.add("opacity-0","scale-95");const t=()=>{e.close(),e.removeEventListener("transitionend",t)};e.addEventListener("transitionend",t)}scrollToLatest(){setTimeout(()=>{const e=this.querySelector(".overflow-x-auto");e&&(e.scrollLeft=e.scrollWidth)},50)}getDayVal(e){var u,p,h,x;const t=this._historyData.find(g=>g.date===e);if(!t)return{val:0,additions:0,deletions:0,commits:0,commitsTracked:!1,dateTracked:!1,score:0};const n=((u=t.metrics)==null?void 0:u.additions)??t.total_additions??0,s=((p=t.metrics)==null?void 0:p.deletions)??t.total_deletions??0,i=((h=t.metrics)==null?void 0:h.lines_changed)??n+s;let o=0,l=!1;typeof((x=t.metrics)==null?void 0:x.commits)=="number"?(o=t.metrics.commits,l=!0):t.repos&&t.repos.some(b=>{var k;return typeof((k=b.metrics)==null?void 0:k.commits)=="number"})&&(o=t.repos.reduce((b,k)=>{var C;return b+(((C=k.metrics)==null?void 0:C.commits)??0)},0),l=!0);const d=o*20+Math.log2(i+1)*10;return{val:i,additions:n,deletions:s,commits:o,commitsTracked:l,dateTracked:!0,score:d}}calculateYearQuantiles(e){const t=[];if(e.forEach(s=>{const{score:i}=this.getDayVal(s);i>0&&t.push(i)}),t.length===0)return{q25:1,q50:2,q75:3};t.sort((s,i)=>s-i);const n=s=>{const i=Math.floor(t.length*s);return t[Math.min(i,t.length-1)]};return{q25:n(.25),q50:n(.5),q75:n(.75)}}renderHeatmap(){if(!this._dataLoaded){const I=this.querySelector("#dialog-heatmap-grid");I&&(I.innerHTML='<span class="text-xs text-on-surface-variant/70 py-6">正在加载活跃度数据...</span>');return}const e=480*60*1e3,t=new Date,n=new Date(t.getTime()+t.getTimezoneOffset()*60*1e3+e),s=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`,i=new Date(2025,4,1),o=n,l=i.getDay(),d=new Date(i.getTime()-l*24*60*60*1e3),u=o.getDay(),p=new Date(o.getTime()+(6-u)*24*60*60*1e3),h=[];let x=new Date(d);for(;x<=p;){const I=x.getFullYear(),H=String(x.getMonth()+1).padStart(2,"0"),q=String(x.getDate()).padStart(2,"0");h.push(`${I}-${H}-${q}`),x.setDate(x.getDate()+1)}const b=h.length/7,k="2025-05-01",C=h.filter(I=>I>=k&&I<=s);let A=0,$=0,Z=0,j=0,U="";C.forEach(I=>{const{val:H,commits:q}=this.getDayVal(I);(H>0||q>0)&&(A+=H,$+=q,Z++,H>j&&(j=H,U=I))});const W=this.calculateYearQuantiles(C),ee=[];for(let I=0;I<b;I++){const H=[];for(let q=0;q<7;q++)H.push(h[I*7+q]);ee.push(H)}let oe="",fe=-10,me="";ee.forEach((I,H)=>{const ne=`${new Date(I[3]).getMonth()+1}月`;ne!==me&&H-fe>=3&&H<b-1&&(oe+=`<div class="absolute text-[10px] text-on-surface-variant/50 font-mono select-none whitespace-nowrap" style="left: calc(${H} * (14px + 2px));">${ne}</div>`,me=ne,fe=H)});let ve="";ee.forEach(I=>{let H="";I.forEach(q=>{const ne=q>s;if(q<"2025-05-01"||ne)H+=`
          ...
          `;else{const{val:Ue,additions:at,deletions:st,commits:it,commitsTracked:ot,dateTracked:Pt,score:be}=this.getDayVal(q);let Ae=0;be>0&&(be<=W.q25?Ae=1:be<=W.q50?Ae=2:be<=W.q75?Ae=3:Ae=4);const lt=["bg-[#ebedf0] dark:bg-[#161b22] hover:scale-125 hover:z-10","bg-[#9be9a8] dark:bg-[#0e4429] hover:scale-125 hover:z-10","bg-[#40c463] dark:bg-[#006d32] hover:scale-125 hover:z-10","bg-[#30a14e] dark:bg-[#26a641] hover:scale-125 hover:z-10","bg-[#216e39] dark:bg-[#39d353] hover:scale-125 hover:z-10"],ct=Ue.toLocaleString(),dt=ot?`<strong>${it}</strong> 次`:'<span style="opacity:0.45;font-style:italic;">未统计</span>',ut=Pt?`<strong>${ct}</strong> 行${Ue>0?` (新增 +${at.toLocaleString()} / 删除 -${st.toLocaleString()})`:""}`:'<span style="opacity:0.45;font-style:italic;">未统计</span>',pt=`提交次数：${dt}<br/>变更代码：${ut}`;H+=`
            <div class="w-[14px] h-[14px] relative flex-shrink-0 flex items-center justify-center">
              <emu-tooltip style="display: flex; width: 14px; height: 14px; align-items: center; justify-content: center;">
                <div 
                  class="w-[14px] h-[14px] rounded-[2px] ${lt[Ae]} cursor-pointer transition-all duration-200"
                  data-date="${q}"
                ></div>
          ...
          `}}),ve+=`<div class="flex flex-col gap-[2px]">${H}</div>`});const ye=this.querySelector("#dialog-heatmap-months");ye&&(ye.innerHTML=oe);const ie=this.querySelector("#dialog-heatmap-grid");ie&&(ie.innerHTML=ve);const ke=this.querySelector("#year-total-lines");ke&&(ke.textContent=`${A.toLocaleString()} 行`);const ue=this.querySelector("#year-total-commits");ue&&(ue.textContent=`${$.toLocaleString()} 次`);const we=this.querySelector("#year-active-days");we&&(we.textContent=`${Z} 天`);const D=this.querySelector("#year-max-lines");D&&(D.textContent=`${j.toLocaleString()} 行${U?` (${U})`:""}`)}}customElements.define("emu-activity-heatmap",Gn);const nr=[{name:"物联网实验室（AKA 数字孪生暨虚拟现实实验室）",code:"IoT-Lab",description:"开展物联网架构、嵌入式硬件开发与实时数据采集研究，结合数字孪生与虚拟现实技术实现物理世界的数字化映射。",department:"计算机科学与工程学院",professors:["陈超"],tags:["物联网","数字孪生","虚拟现实","嵌入式"],icon:"sensors",href:"https://emu-stu.github.io/IOT-lab-web/"},{name:"河北省安全生产与应急处置特种机器人重点实验室",code:"SER-Lab",description:"致力于应急救援、特种作业机器人的研发，开展智能环境感知、鲁棒控制及人机协作技术等关键课题攻关。",department:"应急管理学院",tags:["特种机器人","应急处置","智能控制","环境感知"],icon:"precision_manufacturing"},{name:"ArkLab方舟实验室",code:"Ark-Lab",description:"专注于学生技术创新与工程实践，覆盖全栈软件开发、算法研究及软硬件协同设计，培养核心技术人才。",department:"电子信息工程学院",tags:["软件工程","算法设计","技术创新","全栈开发"],icon:"sailing"},{name:"利刃网安攻防实验室",code:"Blade-Sec-Lab",description:"聚焦于网络空间安全，开展渗透测试、漏洞挖掘、红蓝对抗以及安全防御体系建设等核心攻防技术研究。",department:"计算机科学与工程学院",tags:["网络安全","漏洞挖掘","红蓝对抗","渗透测试"],icon:"shield_lock"}];class Fn extends HTMLElement{constructor(){super(...arguments);S(this,"_resizeObserver",null)}connectedCallback(){this.render(),this.setupResponsiveness()}disconnectedCallback(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null)}generateCardHtml(e){const t=e.tags.map(s=>`
        <span
...
`,Wn=Object.freeze(Object.defineProperty({__proto__:null,default:Zn},Symbol.toStringTag,{value:"Module"}));function Kn(a,r){var u;const e=((u=a.split("/").pop())==null?void 0:u.replace(".md",""))||"untitled",t=r.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n([\s\S]*)$/),n={};let s=r;if(t){const p=t[1];s=t[2],p.split(`
`).forEach(h=>{const x=h.trim();if(!x||x.startsWith("#"))return;const g=x.indexOf(":");if(g!==-1){const b=x.slice(0,g).trim();let k=x.slice(g+1).trim();(k.startsWith('"')&&k.endsWith('"')||k.startsWith("'")&&k.endsWith("'"))&&(k=k.slice(1,-1)),n[b]=k}})}const i=s.match(/^\s*#\s+(.+)$/m);let o=n.title;i&&(o||(o=i[1].trim()),s=s.replace(/^\s*#\s+.+$/m,"").trim()),o||(o=e);const l=p=>p.slice(0,300).replace(/[#*`~_\-]/g,"").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/\s+/g," ").trim().slice(0,150)+"...",d=n.excerpt||l(s);return{slug:n.slug||e,title:o,excerpt:d,category:n.category||"技术沉淀",subCategory:n.subCategory||"General",author:n.author||"Anonymous",authorAvatar:n.authorAvatar||(n.author?n.author[0].toUpperCase():"A"),date:n.date||new Date().toISOString().split("T")[0],readTime:n.readTime||`${Math.max(1,Math.ceil(s.length/500))} min`,content:s,filePath:a}}const ar=Object.assign({"../../docs/articles/github_repo_code_change_stats_howto.md":Wn}),xr=[];for(const a in ar)try{const r=ar[a];let e="";if(typeof r=="string")e=r;else if(r&&typeof r.default=="string")e=r.default;else{console.warn(`[article.ts] Failed to load raw content for ${a}:`,r);continue}const t=Kn(a,e);xr.push(t)}catch(r){console.error(`[article.ts] Error parsing markdown article at ${a}:`,r)}const wt=[...xr].sort((a,r)=>new Date(r.date).getTime()-new Date(a.date).getTime()),Xn=wt.map(a=>({category:a.category,subCategory:a.subCategory,href:`/article?slug=${a.slug}`,title:a.title,excerpt:a.excerpt,authorAvatar:a.authorAvatar,author:a.author,date:a.date,readTime:a.readTime}));class Yn extends HTMLElement{constructor(){super(...arguments);S(this,"_currentCategory","全部");S(this,"_searchQuery","");S(this,"_currentPage",1);S(this,"_postsPerPage",4);S(this,"_categories",["全部","后端开发","前端架构","AI/ML","应急科技","开源治理"]);S(this,"_searchHandler",null);S(this,"_searchInput",null)}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this._searchHandler&&this._searchInput&&this._searchInput.removeEventListener("input",this._searchHandler)}getFilteredPosts(){return Xn.filter(e=>{const t=this._currentCategory==="全部"||e.category===this._currentCategory,n=this._searchQuery.trim().toLowerCase(),s=!n||e.title.toLowerCase().includes(n)||e.excerpt.toLowerCase().includes(n);return t&&s})}generatePostHtml(e){return`
      <a 
        href="${e.href}" 
    ...
    `}refreshList(){const e=this.querySelector("#blog-posts-list"),t=this.querySelector("#blog-pagination-container"),n=this.getFilteredPosts(),s=Math.ceil(n.length/this._postsPerPage);this._currentPage>s&&s>0&&(this._currentPage=1);const i=(this._currentPage-1)*this._postsPerPage,o=n.slice(i,i+this._postsPerPage);e&&(e.style.opacity="0"),setTimeout(()=>{e&&(o.length>0?e.innerHTML=o.map(l=>this.generatePostHtml(l)).join(""):e.innerHTML=`
          ...
          `,e.style.opacity="1"),t&&(t.innerHTML=this.generatePaginationHtml(s),this.setupPaginationListeners())},200)}setupEventListeners(){var e;this.addEventListener("click",t=>{const s=t.target.closest(".category-tab");if(s){const i=s.dataset.category||"全部";this._currentCategory!==i&&(this._currentCategory=i,this._currentPage=1,this.querySelectorAll(".category-tab").forEach(l=>{l.className="category-tab px-4 py-2 text-sm font-semibold rounded-xl transition-all duration-300 bg-surface-container hover:bg-surface-container-high text-on-surface-variant dark:text-surface-variant dark:bg-surface-container/30 dark:hover:bg-surface-container/50",l.setAttribute("aria-selected","false")}),s.className="category-tab px-4 py-2 text-sm font-semibold rounded-xl transition-all duration-300 bg-primary text-on-primary shadow-sm dark:bg-primary-fixed dark:text-on-primary-fixed",s.setAttribute("aria-selected","true"),this.refreshList())}}),this._searchInput=this.querySelector("#blog-search-input"),this._searchHandler=()=>{this._searchInput&&(this._searchQuery=this._searchInput.value,this._currentPage=1,this.refreshList())},(e=this._searchInput)==null||e.addEventListener("input",this._searchHandler),this.setupPaginationListeners()}setupPaginationListeners(){const e=this.querySelector("#blog-prev-btn");e==null||e.addEventListener("click",()=>{this._currentPage>1&&(this._currentPage--,this.refreshList(),this.scrollToTop())});const t=this.querySelector("#blog-next-btn");t==null||t.addEventListener("click",()=>{const s=this.getFilteredPosts(),i=Math.ceil(s.length/this._postsPerPage);this._currentPage<i&&(this._currentPage++,this.refreshList(),this.scrollToTop())}),this.querySelectorAll(".page-num-btn").forEach(s=>{s.addEventListener("click",()=>{const i=parseInt(s.dataset.page||"1",10);this._currentPage!==i&&(this._currentPage=i,this.refreshList(),this.scrollToTop())})})}scrollToTop(){const e=this.querySelector("#blog-container");e&&e.scrollIntoView({behavior:"smooth",block:"start"})}}customElements.define("emu-blog",Yn);const Qn="modulepreload",Vn=function(a){return"/"+a},sr={},Jn=function(r,e,t){let n=Promise.resolve();if(e&&e.length>0){let i=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=i(e.map(d=>{if(d=Vn(d),d in sr)return;sr[d]=!0;const u=d.endsWith(".css"),p=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":Qn,u||(h.as="script"),h.crossOrigin="",h.href=d,l&&h.setAttribute("nonce",l),document.head.appendChild(h),u)return new Promise((x,g)=>{h.addEventListener("load",x),h.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return n.then(i=>{for(const o of i||[])o.status==="rejected"&&s(o.reason);return r().catch(s)})};function At(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ne=At();function vr(a){Ne=a}var Re={exec:()=>null};function Ie(a){let r=[];return e=>{let t=Math.max(0,Math.min(3,e-1)),n=r[t];return n||(n=a(t),r[t]=n),n}}function P(a,r=""){let e=typeof a=="string"?a:a.source,t={replace:(n,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(re.caret,"$1"),e=e.replace(n,i),t},getRegex:()=>new RegExp(e,r)};return t}var ea=((a="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+a)}catch{return!1}})(),re={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:a=>new RegExp(`^( {0,3}${a})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:Ie(a=>new RegExp(`^ {0,${a}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:Ie(a=>new RegExp(`^ {0,${a}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}(?:\`\`\`|~~~)`)),headingBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}#`)),htmlBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}<(?:[a-z].*>|!--)`,"i")),blockquoteBeginRegex:Ie(a=>new RegExp(`^ {0,${a}}>`))},ta=/^(?:[ \t]*(?:\n|$))+/,ra=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,na=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,je=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,aa=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Lt=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,yr=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,kr=P(yr).replace(/bull/g,Lt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),sa=P(yr).replace(/bull/g,Lt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ct=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,ia=/^[^\n]+/,Rt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,oa=P(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Rt).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),la=P(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Lt).getRegex(),tt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Mt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ca=P("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Mt).replace("tag",tt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),wr=P(Ct).replace("hr",je).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tt).getRegex(),da=P(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",wr).getRegex(),Nt={blockquote:da,code:ra,def:oa,fences:na,heading:aa,hr:je,html:ca,lheading:kr,list:la,newline:ta,paragraph:wr,table:Re,text:ia},ir=P("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",je).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tt).getRegex(),ua={...Nt,lheading:sa,table:ir,paragraph:P(Ct).replace("hr",je).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ir).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tt).getRegex()},pa={...Nt,html:P(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Mt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Re,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:P(Ct).replace("hr",je).replace("heading",` *#{1,6} *[^
]`).replace("lheading",kr).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ha=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ga=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Er=/^( {2,}|\\)\n(?!\s*$)/,fa=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Pe=/[\p{P}\p{S}]/u,rt=/[\s\p{P}\p{S}]/u,$t=/[^\s\p{P}\p{S}]/u,ma=P(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,rt).getRegex(),_r=/(?!~)[\p{P}\p{S}]/u,ba=/(?!~)[\s\p{P}\p{S}]/u,xa=/(?:[^\s\p{P}\p{S}]|~)/u,va=P(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",ea?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Sr=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,ya=P(Sr,"u").replace(/punct/g,Pe).getRegex(),ka=P(Sr,"u").replace(/punct/g,_r).getRegex(),Tr="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",wa=P(Tr,"gu").replace(/notPunctSpace/g,$t).replace(/punctSpace/g,rt).replace(/punct/g,Pe).getRegex(),Ea=P(Tr,"gu").replace(/notPunctSpace/g,xa).replace(/punctSpace/g,ba).replace(/punct/g,_r).getRegex(),_a=P("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,$t).replace(/punctSpace/g,rt).replace(/punct/g,Pe).getRegex(),Sa=P(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Pe).getRegex(),Ta="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Aa=P(Ta,"gu").replace(/notPunctSpace/g,$t).replace(/punctSpace/g,rt).replace(/punct/g,Pe).getRegex(),La=P(/\\(punct)/,"gu").replace(/punct/g,Pe).getRegex(),Ca=P(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ra=P(Mt).replace("(?:-->|$)","-->").getRegex(),Ma=P("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ra).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Qe=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,Na=P(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Qe).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Ar=P(/^!?\[(label)\]\[(ref)\]/).replace("label",Qe).replace("ref",Rt).getRegex(),Lr=P(/^!?\[(ref)\](?:\[\])?/).replace("ref",Rt).getRegex(),$a=P("reflink|nolink(?!\\()","g").replace("reflink",Ar).replace("nolink",Lr).getRegex(),or=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ot={_backpedal:Re,anyPunctuation:La,autolink:Ca,blockSkip:va,br:Er,code:ga,del:Re,delLDelim:Re,delRDelim:Re,emStrongLDelim:ya,emStrongRDelimAst:wa,emStrongRDelimUnd:_a,escape:ha,link:Na,nolink:Lr,punctuation:ma,reflink:Ar,reflinkSearch:$a,tag:Ma,text:fa,url:Re},Oa={...Ot,link:P(/^!?\[(label)\]\((.*?)\)/).replace("label",Qe).getRegex(),reflink:P(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Qe).getRegex()},Et={...Ot,emStrongRDelimAst:Ea,emStrongLDelim:ka,delLDelim:Sa,delRDelim:Aa,url:P(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",or).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:P(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",or).getRegex()},Ia={...Et,br:P(Er).replace("{2,}","*").getRegex(),text:P(Et.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Xe={normal:Nt,gfm:ua,pedantic:pa},Be={normal:Ot,gfm:Et,breaks:Ia,pedantic:Oa},Pa={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},lr=a=>Pa[a];function ge(a,r){if(r){if(re.escapeTest.test(a))return a.replace(re.escapeReplace,lr)}else if(re.escapeTestNoEncode.test(a))return a.replace(re.escapeReplaceNoEncode,lr);return a}function cr(a){try{a=encodeURI(a).replace(re.percentDecode,"%")}catch{return null}return a}function dr(a,r){var s;let e=a.replace(re.findPipe,(i,o,l)=>{let d=!1,u=o;for(;--u>=0&&l[u]==="\\";)d=!d;return d?"|":" |"}),t=e.split(re.splitPipe),n=0;if(t[0].trim()||t.shift(),t.length>0&&!((s=t.at(-1))!=null&&s.trim())&&t.pop(),r)if(t.length>r)t.splice(r);else for(;t.length<r;)t.push("");for(;n<t.length;n++)t[n]=t[n].trim().replace(re.slashPipe,"|");return t}function Te(a,r,e){let t=a.length;if(t===0)return"";let n=0;for(;n<t&&a.charAt(t-n-1)===r;)n++;return a.slice(0,t-n)}function ur(a){let r=a.split(`
`),e=r.length-1;for(;e>=0&&re.blankLine.test(r[e]);)e--;return r.length-e<=2?a:r.slice(0,e+1).join(`
`)}function Da(a,r){if(a.indexOf(r[1])===-1)return-1;let e=0;for(let t=0;t<a.length;t++)if(a[t]==="\\")t++;else if(a[t]===r[0])e++;else if(a[t]===r[1]&&(e--,e<0))return t;return e>0?-2:-1}function Ba(a,r=0){let e=r,t="";for(let n of a)if(n==="	"){let s=4-e%4;t+=" ".repeat(s),e+=s}else t+=n,e++;return t}function pr(a,r,e,t,n){let s=r.href,i=r.title||null,o=a[1].replace(n.other.outputLinkReplace,"$1");t.state.inLink=!0;let l={type:a[0].charAt(0)==="!"?"image":"link",raw:e,href:s,title:i,text:o,tokens:t.inlineTokens(o)};return t.state.inLink=!1,l}function Ha(a,r,e){let t=a.match(e.other.indentCodeCompensation);if(t===null)return r;let n=t[1];return r.split(`
`).map(s=>{let i=s.match(e.other.beginningSpace);if(i===null)return s;let[o]=i;return o.length>=n.length?s.slice(n.length):s}).join(`
`)}var Ve=class{constructor(a){S(this,"options");S(this,"rules");S(this,"lexer");this.options=a||Ne}space(a){let r=this.rules.block.newline.exec(a);if(r&&r[0].length>0)return{type:"space",raw:r[0]}}code(a){let r=this.rules.block.code.exec(a);if(r){let e=this.options.pedantic?r[0]:ur(r[0]),t=e.replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e,codeBlockStyle:"indented",text:t}}}fences(a){let r=this.rules.block.fences.exec(a);if(r){let e=r[0],t=Ha(e,r[3]||"",this.rules);return{type:"code",raw:e,lang:r[2]?r[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):r[2],text:t}}}heading(a){let r=this.rules.block.heading.exec(a);if(r){let e=r[2].trim();if(this.rules.other.endingHash.test(e)){let t=Te(e,"#");(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:"heading",raw:Te(r[0],`
...
`+e.join(`
`),b=this.blockquote(g);s[s.length-1]=b,t=t.substring(0,t.length-x.raw.length)+b.raw,n=n.substring(0,n.length-x.text.length)+b.text;break}else if((h==null?void 0:h.type)==="list"){let x=h,g=x.raw+`
`+e.join(`
`),b=this.list(g);s[s.length-1]=b,t=t.substring(0,t.length-h.raw.length)+b.raw,n=n.substring(0,n.length-x.raw.length)+b.raw,e=g.substring(s.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:t,tokens:s,text:n}}}list(a){let r=this.rules.block.list.exec(a);if(r){let e=r[1].trim(),t=e.length>1,n={type:"list",raw:"",ordered:t,start:t?+e.slice(0,-1):"",loose:!1,items:[]};e=t?`\\d{1,9}\\${e.slice(-1)}`:`\\${e}`,this.options.pedantic&&(e=t?e:"[*+-]");let s=this.rules.other.listItemRegex(e),i=!1;for(;a;){let l=!1,d="",u="";if(!(r=s.exec(a))||this.rules.block.hr.test(a))break;d=r[0],a=a.substring(d.length);let p=Ba(r[2].split(`
...
`,a=a.substring(h.length+1),l=!0),!l){let b=this.rules.other.nextBulletRegex(g),k=this.rules.other.hrRegex(g),C=this.rules.other.fencesBeginRegex(g),A=this.rules.other.headingBeginRegex(g),$=this.rules.other.htmlBeginRegex(g),Z=this.rules.other.blockquoteBeginRegex(g);for(;a;){let j=a.split(`
...
`)?"":`
`)+l.raw,u.text+=`
`+l.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):e.push(l);continue}if(r){this.infiniteLoopError(r.charCodeAt(0));break}}return this.state.top=!0,e}inline(r,e=[]){return this.inlineQueue.push({src:r,tokens:e}),e}inlineTokens(r,e=[]){var d,u,p,h,x;this.tokenizer.lexer=this;let t=r,n=null;if(this.tokens.links){let g=Object.keys(this.tokens.links);if(g.length>0)for(;(n=this.tokenizer.rules.inline.reflinkSearch.exec(t))!==null;)g.includes(n[0].slice(n[0].lastIndexOf("[")+1,-1))&&(t=t.slice(0,n.index)+"["+"a".repeat(n[0].length-2)+"]"+t.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(n=this.tokenizer.rules.inline.anyPunctuation.exec(t))!==null;)t=t.slice(0,n.index)+"++"+t.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let s;for(;(n=this.tokenizer.rules.inline.blockSkip.exec(t))!==null;)s=n[2]?n[2].length:0,t=t.slice(0,n.index+s)+"["+"a".repeat(n[0].length-s-2)+"]"+t.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);t=((u=(d=this.options.hooks)==null?void 0:d.emStrongMask)==null?void 0:u.call({lexer:this},t))??t;let i=!1,o="",l=1/0;for(;r;){if(r.length<l)l=r.length;else{this.infiniteLoopError(r.charCodeAt(0));break}i||(o=""),i=!1;let g;if((h=(p=this.options.extensions)==null?void 0:p.inline)!=null&&h.some(k=>(g=k.call({lexer:this},r,e))?(r=r.substring(g.raw.length),e.push(g),!0):!1))continue;if(g=this.tokenizer.escape(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.tag(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.link(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.reflink(r,this.tokens.links)){r=r.substring(g.raw.length);let k=e.at(-1);g.type==="text"&&(k==null?void 0:k.type)==="text"?(k.raw+=g.raw,k.text+=g.text):e.push(g);continue}if(g=this.tokenizer.emStrong(r,t,o)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.codespan(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.br(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.del(r,t,o)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.autolink(r)){r=r.substring(g.raw.length),e.push(g);continue}if(!this.state.inLink&&(g=this.tokenizer.url(r))){r=r.substring(g.raw.length),e.push(g);continue}let b=r;if((x=this.options.extensions)!=null&&x.startInline){let k=1/0,C=r.slice(1),A;this.options.extensions.startInline.forEach($=>{A=$.call({lexer:this},C),typeof A=="number"&&A>=0&&(k=Math.min(k,A))}),k<1/0&&k>=0&&(b=r.substring(0,k+1))}if(g=this.tokenizer.inlineText(b)){r=r.substring(g.raw.length),g.raw.slice(-1)!=="_"&&(o=g.raw.slice(-1)),i=!0;let k=e.at(-1);(k==null?void 0:k.type)==="text"?(k.raw+=g.raw,k.text+=g.text):e.push(g);continue}if(r){this.infiniteLoopError(r.charCodeAt(0));break}}return e}infiniteLoopError(r){let e="Infinite loop on byte: "+r;if(this.options.silent)console.error(e);else throw new Error(e)}},Je=class{constructor(a){S(this,"options");S(this,"parser");this.options=a||Ne}space(a){return""}code({text:a,lang:r,escaped:e}){var s;let t=(s=(r||"").match(re.notSpaceStart))==null?void 0:s[0],n=a.replace(re.endingNewline,"")+`
`;return t?'<pre><code class="language-'+ge(t)+'">'+(e?n:ge(n,!0))+`</code></pre>
