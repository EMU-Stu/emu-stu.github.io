var Vr=Object.defineProperty;var Jr=(a,r,e)=>r in a?Vr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var y=(a,r,e)=>Jr(a,typeof r!="symbol"?r+"":r,e);(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function e(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(n){if(n.ep)return;n.ep=!0;const s=e(n);fetch(n.href,s)}})();const Qr="/assets/uem-stu-logo-D3KqYaZd.png",Nt=Qr,Pn="UEM-Stu",sn="应急管理大学开源技术组织",ea="技术服务校园，开源贡献社区",At="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z",ta=[{label:"首页",href:"#",active:!0},{label:"技术博客",href:"/blog",active:!1}],kt=[{label:"校园活动",path:"/activity",href:"/activity"}],na="https://github.com/UEM-Stu/UEM-Stu-Site",on={related:[{label:"学校官网",href:"https://www.ncist.edu.cn/"},{label:"教务系统",href:"https://jwc.ncist.edu.cn/"},{label:"图书馆",href:"https://lib.ncist.edu.cn/"}],bottom:[{label:"想知道此网站是如何实现的？点击查看文章",href:na,underline:!0}]};class ra extends HTMLElement{constructor(){super(...arguments);y(this,"_menuOpen",!1)}connectedCallback(){this.classList.add("sticky","top-0","z-50","block","w-full"),this.render(),this.setupEventListeners()}render(){const e=window.location.pathname,t=e.includes("/blog")||e.includes("/article"),n=kt.find(w=>e.includes(w.path))??null,s=t||n!==null,i=ta.map(w=>{let H=w.href,D=w.active;return w.label==="首页"?(H=s?"/":"#",D=!s):w.label==="技术博客"&&(H=t?"#":"/blog",D=t),{label:w.label,href:H,active:D}}),o=i.find(w=>w.label==="首页"),l=i.find(w=>w.label==="技术博客"),c=s?"/":"",u=n?`
    ...
    `,f=(o?p(o):"")+(l?p(l):""),g=n?`
      <a
        ...
        href="${n.href}"
      >${n.label}</a>
    `:"",b=(o?h(o):"")+g+(l?h(l):""),v=kt.filter(w=>w.path!==(n==null?void 0:n.path)).map(w=>`
  ...
  `,document.head.appendChild(a)}class sa extends HTMLElement{constructor(){super(...arguments);y(this,"_dialog",null);y(this,"_titleElement",null);y(this,"_closing",!1);y(this,"_closeTimer",null)}static get observedAttributes(){return["max-width","subtitle","title"]}attributeChangedCallback(e,t,n){t!==n&&this.update()}connectedCallback(){aa(),this.render()}get titleText(){return this.getAttribute("title")||""}set titleText(e){this.setAttribute("title",e)}showModal(){if(this._dialog){if(this._closing){this._closing=!1,this._closeTimer!==null&&(clearTimeout(this._closeTimer),this._closeTimer=null),delete this._dialog.dataset.closing,document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden";return}this._dialog.showModal(),document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden"}}close(){!this._dialog||!this._dialog.open||this._closing||(this._closing=!0,this._dialog.dataset.closing="1",this._closeTimer=setTimeout(()=>{this._dialog&&(this._dialog.close(),delete this._dialog.dataset.closing),this._closing=!1,this._closeTimer=null},160))}update(){const e=this.getAttribute("title")||"",t=this.getAttribute("subtitle")||"",n=this.getAttribute("max-width")||"max-w-2xl";this._titleElement&&(this._titleElement.textContent=e);const s=this.querySelector(".dialog-subtitle");s&&(s.textContent=t,t?s.removeAttribute("style"):s.setAttribute("style","display: none;")),this._dialog&&(this._dialog.className=`bg-[#f5f6f8] dark:bg-[#151718] text-on-surface p-0 shadow-2xl ${n} w-[90%] md:w-full rounded-2xl border border-outline/10 dark:border-outline-variant/10 focus:outline-none overflow-hidden`)}render(){if(this._dialog)return;const e=this.getAttribute("title")||"",t=this.getAttribute("subtitle")||"",n=this.getAttribute("max-width")||"max-w-2xl",s=Array.from(this.childNodes);this.innerHTML="";const i=document.createElement("dialog");i.className=`bg-[#f5f6f8] dark:bg-[#151718] text-on-surface p-0 shadow-2xl ${n} w-[90%] md:w-full rounded-2xl border border-outline/10 dark:border-outline-variant/10 focus:outline-none overflow-hidden`,i.dataset.uem="1",this._dialog=i;const o=document.createElement("button");o.className="absolute top-4 right-4 flex items-center justify-center w-8 h-8 rounded-full bg-surface-container-highest/50 hover:bg-surface-container-highest text-on-surface-variant hover:text-on-surface transition-all duration-200 focus:outline-none z-10 cursor-pointer",o.setAttribute("aria-label","关闭浮窗"),o.innerHTML='<span class="material-symbols-outlined text-[20px]">close</span>',o.addEventListener("click",()=>this.close()),i.appendChild(o);const l=document.createElement("div");l.className="max-h-[90dvh] w-full overflow-y-auto overscroll-contain";const c=document.createElement("div");c.className="relative p-6 md:p-8 flex flex-col items-center";const u=document.createElement("div");u.className="text-center mb-8";const p=document.createElement("span");p.className="dialog-subtitle text-xs font-bold tracking-wider text-primary/70 dark:text-primary-fixed-dim/70 uppercase mb-1 block font-mono",p.textContent=t,t||(p.style.display="none"),u.appendChild(p);const h=document.createElement("h3");h.className="text-2xl font-extrabold text-on-surface tracking-tight",h.textContent=e,this._titleElement=h,u.appendChild(h),c.appendChild(u);const f=document.createElement("div");f.className="w-full flex flex-col items-center",s.forEach(b=>f.appendChild(b)),c.appendChild(f);const g=document.createElement("div");g.className="text-center w-full mt-6 pt-4 border-t border-outline-variant/10",g.innerHTML='<p class="text-[10px] text-on-surface-variant/60 font-mono">Powered by UEM-Stu 开源技术组织</p>',c.appendChild(g),l.appendChild(c),i.appendChild(l),this.appendChild(i),i.addEventListener("close",()=>{document.body.style.overflow="",document.documentElement.style.overflow="",this.dispatchEvent(new CustomEvent("close"))}),i.addEventListener("cancel",b=>{b.preventDefault(),this.close()}),i.addEventListener("click",b=>{b.target===i&&this.close()})}}customElements.define("uem-float",sa);const cn="uem-lightbox-styles";function ia(){if(document.getElementById(cn))return;const a=document.createElement("style");a.id=cn,a.textContent=`
    ...
    `,document.head.appendChild(a)}class oa extends HTMLElement{constructor(){super(...arguments);y(this,"_open",()=>{});y(this,"_close",()=>{})}connectedCallback(){this.dataset.ready||(this.dataset.ready="1",ia(),this._build())}open(e,t=""){this._open(e,t)}close(){this._close()}_build(){this.style.display="contents";const e=document.createElement("dialog");e.className="uem-lightbox-dialog",e.dataset.uem="1";const t=document.createElement("button");t.className="uem-lightbox-close",t.setAttribute("aria-label","关闭图片预览"),t.innerHTML='<span class="material-symbols-outlined" style="font-size:28px;">close</span>';const n=document.createElement("div");n.className="uem-lightbox-img-wrap";const s=document.createElement("img");s.className="uem-lightbox-img",s.alt="",n.appendChild(s),e.appendChild(t),e.appendChild(n),this.appendChild(e);const i=5;let o=1,l=0,c=0,u="none",p=0,h=0,f=0,g=0,b=0,v=0,E=0,T=!1,w=0,H=0,D=0,q="",Z="";const V=($=!1)=>{s.style.transition=$?"transform 0.25s ease":"none",s.style.transform=`translate(${l}px, ${c}px) scale(${o})`},ie=()=>{const $=Math.max(0,(s.clientWidth*o-window.innerWidth)/2),O=Math.max(0,(s.clientHeight*o-window.innerHeight)/2);l=Math.min($,Math.max(-$,l)),c=Math.min(O,Math.max(-O,c))},ue=()=>{o=1,l=0,c=0,u="none",s.style.transition="",s.style.transform=""},ge=($,O,W,ee=!1)=>{const ae=Math.min(i,Math.max(1,W)),pe=window.innerWidth/2,B=window.innerHeight/2,I=ae/o;l=($-pe)*(1-I)+I*l,c=(O-B)*(1-I)+I*c,o=ae,o<=1.001&&(o=1,l=0,c=0),ie(),V(ee)};this._open=($,O)=>{s.src=$,s.alt=O||"",ue(),e.open||(q=document.body.style.overflow,Z=document.documentElement.style.overflow,document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden",e.showModal())},this._close=()=>{e.open&&e.close()},e.addEventListener("close",()=>{document.body.style.overflow=q,document.documentElement.style.overflow=Z,ue()}),t.addEventListener("click",()=>this._close()),e.addEventListener("click",$=>{$.target===e&&this._close()}),s.addEventListener("touchstart",$=>{if($.touches.length===2){u="pinch",T=!0;const O=$.touches[0],W=$.touches[1];p=Math.hypot(W.clientX-O.clientX,W.clientY-O.clientY),h=(O.clientX+W.clientX)/2,f=(O.clientY+W.clientY)/2,$.preventDefault()}else if($.touches.length===1){const O=$.touches[0];v=g=O.clientX,E=b=O.clientY,T=!1,u=o>1?"pan":"none"}},{passive:!1}),s.addEventListener("touchmove",$=>{if(u==="pinch"&&$.touches.length>=2){const O=$.touches[0],W=$.touches[1],ee=Math.hypot(W.clientX-O.clientX,W.clientY-O.clientY),ae=(O.clientX+W.clientX)/2,pe=(O.clientY+W.clientY)/2;l+=ae-h,c+=pe-f;const B=Math.min(i,Math.max(1,o*ee/p)),I=window.innerWidth/2,j=window.innerHeight/2,F=B/o;l=(ae-I)*(1-F)+F*l,c=(pe-j)*(1-F)+F*c,o=B,p=ee,h=ae,f=pe,ie(),V(!1),$.preventDefault()}else if(u==="pan"&&$.touches.length===1){const O=$.touches[0];l+=O.clientX-g,c+=O.clientY-b,g=O.clientX,b=O.clientY,(Math.abs(O.clientX-v)>6||Math.abs(O.clientY-E)>6)&&(T=!0),ie(),V(!1),$.preventDefault()}},{passive:!1}),s.addEventListener("touchend",$=>{if($.touches.length===0){const O=u==="pinch";if(u="none",!O&&!T){const W=Date.now(),ee=$.changedTouches[0];if(W-w<300&&Math.abs(ee.clientX-H)<30&&Math.abs(ee.clientY-D)<30){o>1?ue():ge(ee.clientX,ee.clientY,2.5,!0),w=0;return}w=W,H=ee.clientX,D=ee.clientY}o<=1.001?ue():(ie(),V(!0))}else if($.touches.length===1){const O=$.touches[0];v=g=O.clientX,E=b=O.clientY,u=o>1?"pan":"none"}},{passive:!1}),s.addEventListener("wheel",$=>{$.preventDefault();const O=Math.exp(-$.deltaY*.0015);ge($.clientX,$.clientY,o*O,!1)},{passive:!1})}}customElements.define("uem-lightbox",oa);let je=null;function Bn(a,r=""){(!je||!je.isConnected)&&(je=document.createElement("uem-lightbox"),document.body.appendChild(je)),je.open(a,r)}if(typeof window<"u"){const a=()=>{};window.addEventListener("touchstart",a,{capture:!0,passive:!0}),window.addEventListener("touchmove",a,{capture:!0,passive:!0}),window.addEventListener("touchend",a,{capture:!0,passive:!0})}class la extends HTMLElement{connectedCallback(){this.render()}render(){const r=this.querySelector('[slot="content"]'),e=Array.from(this.childNodes).filter(p=>p!==r);this.innerHTML="",this.style.display||(this.style.display="inline-block"),this.style.verticalAlign||(this.style.verticalAlign="middle");const t=document.createElement("div");t.className="relative inline-flex items-center group/tooltip",e.forEach(p=>t.appendChild(p));const n=document.createElement("div");n.className="fixed p-3 bg-white dark:bg-[#1e2124] text-on-surface border border-outline-variant/30 dark:border-[#2f3336] rounded-xl shadow-lg invisible opacity-0 pointer-events-none transition-opacity duration-200 z-50 min-w-[260px] max-w-[calc(100vw-24px)] text-left text-xs whitespace-normal font-sans normal-case after:content-[''] after:absolute after:top-full after:left-0 after:w-full after:h-2";const s=document.createElement("div");if(s.className="absolute top-full w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-white dark:border-t-[#1e2124]",n.appendChild(s),r)r.removeAttribute("slot"),n.appendChild(r);else{const p=this.getAttribute("text")||"",h=document.createElement("span");h.textContent=p,n.appendChild(h)}t.appendChild(n),this.appendChild(t);let i=!1;const o=()=>{i=!0;const h=(t.firstElementChild||t).getBoundingClientRect();n.style.visibility="hidden",n.style.transition="none",n.style.position="fixed",n.style.left="-9999px",n.style.top="-9999px",n.style.transform="none";const f=n.getBoundingClientRect(),g=window.innerWidth||document.documentElement.clientWidth,b=h.left+(h.width-f.width)/2,v=h.top-f.height-8;let E=Math.max(12,b);E+f.width>g-12&&(E=g-12-f.width),n.style.left=`${E}px`,n.style.top=`${v}px`;const w=h.left+h.width/2-E,H=16,D=f.width-16,q=Math.max(H,Math.min(D,w));s.style.left=`${q}px`,s.style.transform="translateX(-50%)",requestAnimationFrame(()=>{requestAnimationFrame(()=>{i&&(n.style.transition="",n.style.visibility="visible",n.style.opacity="1",n.style.pointerEvents="auto")})})},l=()=>{i=!1,n.style.transition="",n.style.opacity="0",n.style.pointerEvents="none",setTimeout(()=>{i||(n.style.visibility="hidden")},200)},c=this.hasAttribute("manual-touch"),u=typeof window.matchMedia=="function"?window.matchMedia("(hover: hover)").matches:!0;c&&!u||(t.addEventListener("mouseenter",o),t.addEventListener("mouseleave",l)),c||t.addEventListener("touchstart",o,{passive:!0})}}customElements.define("uem-tooltip",la);const dn="uem-select-styles";function ca(){if(document.getElementById(dn))return;const a=document.createElement("style");a.id=dn,a.textContent=`
  ...
  `,document.head.appendChild(a)}const nt=a=>a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;");class da extends HTMLElement{constructor(){super(...arguments);y(this,"_options",[]);y(this,"_value",null);y(this,"_open",!1);y(this,"_onDocClick",e=>{this.contains(e.target)||this.closePanel()});y(this,"_onKeydown",e=>{var t;e.key==="Escape"&&this._open&&(this.closePanel(),(t=this.querySelector("[data-trigger]"))==null||t.focus())})}static get observedAttributes(){return["placeholder","clearable","aria-label"]}connectedCallback(){ca(),this.render(),this.bindEvents(),document.addEventListener("click",this._onDocClick),document.addEventListener("keydown",this._onKeydown)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick),document.removeEventListener("keydown",this._onKeydown)}attributeChangedCallback(){this.isConnected&&this.render()}get options(){return this._options}set options(e){this._options=Array.isArray(e)?e.slice():[],this._value&&!this._options.includes(this._value)&&(this._value=null),this.isConnected&&this.render()}get value(){return this._value}set value(e){const t=e&&this._options.includes(e)?e:null;t!==this._value&&(this._value=t,this.isConnected&&this.render())}get clearable(){return this.hasAttribute("clearable")}get placeholder(){return this.getAttribute("placeholder")||"请选择"}emitChange(){this.dispatchEvent(new CustomEvent("uem-select-change",{detail:{value:this._value},bubbles:!0}))}openPanel(){this._open||(document.querySelectorAll("uem-select").forEach(e=>{e!==this&&e._open&&(e._open=!1)}),this._open=!0,document.querySelectorAll("uem-select").forEach(e=>e.render()))}closePanel(){this._open&&(this._open=!1,this.render())}togglePanel(){this._open?this.closePanel():this.openPanel()}selectOption(e){this._value=this._value===e?null:e,this._open=!1,this.render(),this.emitChange()}clearValue(){this._value!==null&&(this._value=null,this.render(),this.emitChange())}bindEvents(){this.addEventListener("click",e=>{const t=e.target;if(e.stopPropagation(),t.closest("[data-clear]")){this.clearValue();return}if(t.closest("[data-trigger]")){this.togglePanel();return}const n=t.closest("[data-option]");if(n){this.selectOption(n.getAttribute("data-option"));return}})}render(){const e=this._value!==null,t=e?this._value:this.placeholder,n=this.getAttribute("aria-label")||this.placeholder,s=e?"border-primary/40 text-on-surface dark:border-primary-fixed-dim/40":"border-outline-variant/60 text-on-surface-variant/80 hover:text-on-surface hover:border-primary/30",i=this.clearable&&e?`<span data-clear role="button" tabindex="0" aria-label="清除选择" title="清除选择"
    ...
    </div>`}}customElements.define("uem-select",da);class ua extends HTMLElement{connectedCallback(){this.render(),this.setupEventListeners()}render(){this.innerHTML=`
      <section
    ...
    `}}customElements.define("uem-service-card",ya);const ka=[{name:"EmergencyTeleoperatedRobotSystem-Jetson",description:"应急遥操作机器人系统 Jetson 端：机器人主控核心，负责为客户端提供三维场景重建与目标检测功能，以及接收和处理来自客户端的控制指令。",languages:["C++","Python"],stars:48,color:"#3572A5",href:"https://github.com/UEM-Stu/EmergencyTeleoperatedRobotSystem-Jetson"},{name:"EmergencyTeleoperatedRobotSystem-Unity",description:"应急遥操作机器人系统 Unity 端：机器人控制客户端，基于 MRTK 框架并面向 HoloLens 2 平台开发，提供 3D 虚拟孪生、遥操作与三维现场呈现。",languages:["C#"],stars:62,color:"#178600",href:"https://github.com/UEM-Stu/EmergencyTeleoperatedRobotSystem-Unity"},{name:"skills",description:"校园相关 Agent Skills。",languages:["Markdown"],stars:128,color:"#083fa6",href:"https://github.com/UEM-Stu/skills"},{name:"UEM-Stu-Site",description:"UEM-Stu 官网源码。",languages:["TypeScript","HTML","CSS"],stars:35,color:"#3178c6",href:"https://github.com/UEM-Stu/UEM-Stu-Site"},{name:"UEM-Stu-Blog",description:"UEM-Stu 技术博客的内容仓库，包含所有的文章 Markdown 源文件与相关静态资源，欢迎你的投稿。",languages:["Markdown"],stars:28,color:"#083fa6",href:"https://github.com/UEM-Stu/UEM-Stu-Blog"},{name:"CUEDC-2024-Drone-code",description:"2024 年全国大学生电子设计竞赛无人机赛题方案。基于 Fast-LIO 激光 SLAM 实现室内自主定位，融合 PX4 飞控、STM32 下位机路径规划 与 OpenMV 视觉识别，完成自主航点飞行与目标检测任务。",languages:["C"],stars:56,color:"#555555",href:"https://github.com/UEM-Stu/CUEDC-2024-Drone-code"},{name:"IOT-lab-web",description:"物联网实验室实验室门户站点，基于 Next.js + Tailwind 的纯前端实验室站点，包含新生导览、毕业路径文章与项目索引。",languages:["TypeScript","CSS","JavaScript"],stars:0,color:"#3178c6",href:"https://github.com/UEM-Stu/IOT-lab-web"}];class wa extends HTMLElement{constructor(){super(...arguments);y(this,"_displayedProjects",[])}connectedCallback(){this.shuffleProjects(),this.render(),this.loadCommitStats(),this.setupEventListeners()}shuffleProjects(){const e=[...ka];for(let t=e.length-1;t>0;t--){const n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}this._displayedProjects=e.slice(0,4)}getLanguageColor(e,t){return{TypeScript:"#3178c6",JavaScript:"#f1e05a",HTML:"#e34c26",CSS:"#563d7c","C#":"#178600","C++":"#f34b7d",C:"#555555",Python:"#3572A5",Markdown:"#083fa6"}[e]||t}generateCardHtml(e){const t=e.languages.map(n=>`
            ...
            <uem-tooltip style="vertical-align: -0.125em;">
              ...
              <div slot="content" class="min-w-[240px] select-none">
                ...
                <span class="flex items-center gap-4 text-on-surface-variant/80 mb-2.5 text-[11px]">
                  ...
                  <span>删除：<strong class="text-error font-mono font-semibold">-${f}</strong></span>
                </span>
    ...
    `}open(){const e=this.querySelector("uem-float");e&&(e.showModal(),this.renderHeatmap(),this.setupTouchScrub(),this.scrollToLatest())}close(){const e=this.querySelector("uem-float");e==null||e.close()}cellTooltipHTML(e){const{val:t,additions:n,deletions:s,commits:i,commitsTracked:o,dateTracked:l}=this.getDayVal(e),c=t.toLocaleString(),u=o?`<strong>${i}</strong> 次`:'<span style="opacity:0.45;font-style:italic;">未统计</span>',p=l?`<strong>${c}</strong> 行${t>0?` (新增 +${n.toLocaleString()} / 删除 -${s.toLocaleString()})`:""}`:'<span style="opacity:0.45;font-style:italic;">未统计</span>',h=`提交次数：${u}<br/>变更代码：${p}`;return`<span class="block font-bold text-on-surface mb-1.5 font-mono text-[11px]">${e}</span><span class="block text-on-surface-variant/90 text-[11px] leading-relaxed">${h}</span>`}setupTouchScrub(){if(this._touchScrubReady)return;const e=this.querySelector("#dialog-heatmap-grid");if(!e)return;this._touchScrubReady=!0;const t=320,n=12,s=500;let i=null,o=!1,l=0,c=0,u=null;const p=()=>{i!==null&&(clearTimeout(i),i=null)},h=(E,T)=>{const w=document.elementFromPoint(E,T),H=w==null?void 0:w.closest("[data-date]");return H&&e.contains(H)?H:null},f=E=>{!E||E===u||(u=E,this.showTouchTip(E))};e.addEventListener("touchstart",E=>{if(E.touches.length!==1)return;const T=E.touches[0];l=T.clientX,c=T.clientY,o=!1,u=null,p(),i=setTimeout(()=>{o=!0,i=null,navigator.vibrate&&navigator.vibrate(10),f(h(l,c))},t)},{passive:!0}),e.addEventListener("touchmove",E=>{const T=E.touches[0];if(T){if(!o){Math.hypot(T.clientX-l,T.clientY-c)>n&&p();return}E.preventDefault(),f(h(T.clientX,T.clientY))}},{passive:!1});const g=()=>{p(),o&&(o=!1,u=null,this.hideTouchTip())};e.addEventListener("touchend",g),e.addEventListener("touchcancel",g);let b=null;const v=()=>{e.setAttribute("data-touch-suppress",""),b&&clearTimeout(b),b=setTimeout(()=>{e.removeAttribute("data-touch-suppress"),b=null},s)};if(!document.getElementById("heatmap-touch-suppress-style")){const E=document.createElement("style");E.id="heatmap-touch-suppress-style",E.textContent=`
        [data-touch-suppress] uem-tooltip > .group\\/tooltip {
          pointer-events: none !important;
        }
      `,document.head.appendChild(E)}e.addEventListener("touchstart",v,{capture:!0,passive:!0}),e.addEventListener("touchend",v,{capture:!0,passive:!0})}ensureTouchTip(){if(this._touchTip)return this._touchTip;const e=document.createElement("div");e.className="fixed p-3 bg-white dark:bg-[#1e2124] text-on-surface border border-outline-variant/30 dark:border-[#2f3336] rounded-xl shadow-lg invisible opacity-0 pointer-events-none transition-opacity duration-150 z-50 text-left text-xs whitespace-normal font-sans normal-case",e.style.minWidth="180px",e.style.maxWidth="calc(100vw - 24px)";const t=document.createElement("div");t.className="absolute top-full w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-white dark:border-t-[#1e2124]",e.appendChild(t);const n=document.createElement("div");return n.className="p-0.5 select-none",e.appendChild(n),(this.querySelector("uem-float dialog")||this).appendChild(e),this._touchTip=e,this._touchTipArrow=t,this._touchTipBody=n,e}showTouchTip(e){const t=e.getAttribute("data-date");if(!t)return;const n=this.ensureTouchTip();this._touchTipBody.innerHTML=this.cellTooltipHTML(t),n.style.visibility="hidden",n.style.left="-9999px",n.style.top="-9999px";const s=e.getBoundingClientRect(),i=n.getBoundingClientRect(),o=window.innerWidth||document.documentElement.clientWidth,l=s.left+(s.width-i.width)/2;let c=Math.max(12,l);c+i.width>o-12&&(c=o-12-i.width);const u=s.top-i.height-8;n.style.left=`${c}px`,n.style.top=`${u}px`;const p=s.left+s.width/2,h=Math.max(16,Math.min(i.width-16,p-c));this._touchTipArrow.style.left=`${h}px`,this._touchTipArrow.style.transform="translateX(-50%)",n.style.visibility="visible",n.style.opacity="1"}hideTouchTip(){this._touchTip&&(this._touchTip.style.opacity="0",this._touchTip.style.visibility="hidden")}scrollToLatest(){setTimeout(()=>{const e=this.querySelector(".overflow-x-auto");e&&(e.scrollLeft=e.scrollWidth)},50)}getDayVal(e){var u,p,h,f;const t=this._historyData.find(g=>g.date===e);if(!t)return{val:0,additions:0,deletions:0,commits:0,commitsTracked:!1,dateTracked:!1,score:0};const n=((u=t.metrics)==null?void 0:u.additions)??t.total_additions??0,s=((p=t.metrics)==null?void 0:p.deletions)??t.total_deletions??0,i=((h=t.metrics)==null?void 0:h.lines_changed)??n+s;let o=0,l=!1;typeof((f=t.metrics)==null?void 0:f.commits)=="number"?(o=t.metrics.commits,l=!0):t.repos&&t.repos.some(b=>{var v;return typeof((v=b.metrics)==null?void 0:v.commits)=="number"})&&(o=t.repos.reduce((b,v)=>{var E;return b+(((E=v.metrics)==null?void 0:E.commits)??0)},0),l=!0);const c=o*20+Math.log2(i+1)*10;return{val:i,additions:n,deletions:s,commits:o,commitsTracked:l,dateTracked:!0,score:c}}calculateYearQuantiles(e){const t=[];if(e.forEach(s=>{const{score:i}=this.getDayVal(s);i>0&&t.push(i)}),t.length===0)return{q25:1,q50:2,q75:3};t.sort((s,i)=>s-i);const n=s=>{const i=Math.floor(t.length*s);return t[Math.min(i,t.length-1)]};return{q25:n(.25),q50:n(.5),q75:n(.75)}}renderHeatmap(){if(!this._dataLoaded){const I=this.querySelector("#dialog-heatmap-grid");I&&(I.innerHTML='<span class="text-xs text-on-surface-variant/70 py-6">正在加载活跃度数据...</span>');return}const e=480*60*1e3,t=new Date,n=new Date(t.getTime()+t.getTimezoneOffset()*60*1e3+e),s=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`,i=new Date(2025,4,1),o=n,l=i.getDay(),c=new Date(i.getTime()-l*24*60*60*1e3),u=o.getDay(),p=new Date(o.getTime()+(6-u)*24*60*60*1e3),h=[];let f=new Date(c);for(;f<=p;){const I=f.getFullYear(),j=String(f.getMonth()+1).padStart(2,"0"),F=String(f.getDate()).padStart(2,"0");h.push(`${I}-${j}-${F}`),f.setDate(f.getDate()+1)}const b=h.length/7,v="2025-05-01",E=h.filter(I=>I>=v&&I<=s);let T=0,w=0,H=0,D=0,q="";E.forEach(I=>{const{val:j,commits:F}=this.getDayVal(I);(j>0||F>0)&&(T+=j,w+=F,H++,j>D&&(D=j,q=I))});const Z=this.calculateYearQuantiles(E),V=[];for(let I=0;I<b;I++){const j=[];for(let F=0;F<7;F++)j.push(h[I*7+F]);V.push(j)}let ie="",ue=-10,ge="";V.forEach((I,j)=>{const ce=`${new Date(I[3]).getMonth()+1}月`;ce!==ge&&j-ue>=3&&j<b-1&&(ie+=`<div class="absolute text-[10px] text-on-surface-variant/50 font-mono select-none whitespace-nowrap" style="left: calc(${j} * (20px + 2px));">${ce}</div>`,ge=ce,ue=j)});let $="";V.forEach(I=>{let j="";I.forEach(F=>{const ce=F>s;if(F<"2025-05-01"||ce)j+=`
            <div class="w-[20px] h-[20px] relative flex-shrink-0">
              <div class="w-[20px] h-[20px] rounded-[2px] bg-transparent pointer-events-none"></div>
            </div>
          `;else{const{score:Re}=this.getDayVal(F);let Ae=0;Re>0&&(Re<=Z.q25?Ae=1:Re<=Z.q50?Ae=2:Re<=Z.q75?Ae=3:Ae=4),j+=`
  ...
  `,document.head.appendChild(a)}class Ia extends HTMLElement{constructor(){super(...arguments);y(this,"view","month");y(this,"current",new Date);y(this,"selected",Pe(new Date));y(this,"selectedCollege",null);y(this,"selectedClub",null);y(this,"active",new Set(it));y(this,"todayStr",Pe(new Date));y(this,"activities",[]);y(this,"dataState","loading")}connectedCallback(){Oa();const e=window.innerWidth||document.documentElement.clientWidth||0;e>0&&e<=767&&(this.view="week"),this.renderShell(),this.bindEvents(),this.loadData()}async loadData(){this.dataState="loading",this.renderAll();try{this.activities=await Na(),this.dataState="ready"}catch(e){console.error("加载校园活动失败:",e),this.dataState="error"}this.renderAll()}passesFilter(e){return!(this.selectedCollege&&(e.level!=="college"||!(e.organizer??"").includes(this.selectedCollege))||this.selectedClub&&(e.category!=="club"||!(e.organizer??"").includes(this.selectedClub))||!this.active.has(e.category))}activitiesOn(e){return this.activities.filter(t=>t.date===e&&this.passesFilter(t)).sort((t,n)=>t.start.localeCompare(n.start))}renderShell(){const e=gn;this.innerHTML=`
    ...
    `}bindEvents(){this.addEventListener("click",n=>{const s=n.target,i=s.closest("[data-goto-day]");if(i){const u=i.getAttribute("data-goto-day");this.selected=u,this.current=vn(u),this.view="day",this.renderAll();return}const o=s.closest("[data-view]");if(o){this.view=o.getAttribute("data-view"),this.renderAll();return}const l=s.closest("[data-cat]");if(l){const u=l.getAttribute("data-cat");this.active.has(u)?this.active.delete(u):this.active.add(u),this.active.size===0&&(this.active=new Set(it)),this.renderAll();return}const c=s.closest("[data-day]");if(c){this.selected=c.getAttribute("data-day"),this.renderAll(!1);return}if(s.closest("#nav-prev"))return this.navigate(-1);if(s.closest("#nav-next"))return this.navigate(1);if(s.closest("#nav-today"))return this.current=new Date,this.selected=this.todayStr,this.renderAll();if(s.closest("[data-retry]"))return void this.loadData();if(s.closest("#subscribe-btn"))return this.openSubscribe();if(s.closest("[data-copy-sub]"))return this.copySubscribeUrl();if(s.closest("[data-download-ics]"))return this.downloadICS()}),this.addEventListener("keydown",n=>{const s=n.target.closest("[data-day]");s&&(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),s.click())});const e=this.querySelector("#college-select");e&&(e.options=[..._a],e.addEventListener("uem-select-change",n=>{const s=n.detail.value;this.selectedCollege=s,s&&(this.selectedClub=null,this.syncSelects()),this.renderAll()}));const t=this.querySelector("#club-select");t&&(t.options=[...Sa],t.addEventListener("uem-select-change",n=>{const s=n.detail.value;this.selectedClub=s,s&&(this.selectedCollege=null,this.syncSelects()),this.renderAll()}))}navigate(e){this.view==="month"?this.current=Ra(this.current,e):this.view==="week"?this.current=Ge(this.current,e*7):(this.current=Ge(this.current,e),this.selected=Pe(this.current)),this.renderAll()}renderControls(){const e=(s,i,o,l)=>`<button data-${i}="${o}" class="px-3 md:px-4 py-1.5 rounded-full text-xs font-semibold transition-all duration-200 cursor-pointer ${s?"bg-white dark:bg-[#323639] text-primary dark:text-primary-fixed-dim shadow-sm":"text-on-surface-variant/80 hover:text-on-surface"}">${l}</button>`,t=this.querySelector("#view-switch");t&&(t.innerHTML=e(this.view==="month","view","month","月")+e(this.view==="week","view","week","周")+e(this.view==="day","view","day","日")),this.syncSelects();const n=this.querySelector("#legend");n&&(n.innerHTML=it.map(s=>{const i=De[s],o=this.active.has(s),l=o?`${i.chipBg} ${i.chipBorder} ${i.text}`:"bg-transparent border-outline-variant/40 text-on-surface-variant/45",c=o?i.dot:"bg-on-surface-variant/30";return`<button data-cat="${s}" class="flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-xs font-medium transition-all cursor-pointer ${l}">
      ...
      <div class="min-w-0 leading-tight">
        <div class="text-[11px] font-semibold text-on-surface/90 truncate">${qe(e.title)}</div>
      ...
      ${fn.map((e,t)=>`<div class="text-center text-[11px] md:text-xs font-semibold ${t>=5?"text-primary/60 dark:text-primary-fixed-dim/60":"text-on-surface-variant/60"}">周${e}</div>`).join("")}
    </div>`}paneWrap(e,t=!0){return`<div class="rounded-2xl border border-outline-variant/60 bg-surface-container-lowest/70 dark:bg-[#1b1d1e]/50 backdrop-blur-sm shadow-sm p-2.5 md:p-4${t?" eac-in":""}">${e}</div>`}renderMonth(e=!0){const t=new Date(this.current.getFullYear(),this.current.getMonth(),1),n=St(t),s=this.current.getMonth();let i="";for(let o=0;o<42;o++){const l=Ge(n,o);i+=this.dayCellHTML(l,{dim:l.getMonth()!==s,minH:"min-h-[68px] md:min-h-[116px]"})}return this.paneWrap(`
      ${this.weekdayHeaderHTML()}
      <div class="grid grid-cols-7 gap-1.5 md:gap-2">${i}</div>
    `,e)}renderWeek(e=!0){const t=St(this.current),n=Array.from({length:7},(o,l)=>Ge(t,l)),s=n.map(o=>this.dayCellHTML(o,{minH:"min-h-[76px]"})).join(""),i=n.map(o=>{const l=Pe(o),c=this.activitiesOn(l),u=l===this.selected,p=l===this.todayStr,h=`
          ...
          </div>`,f=c.slice(0,_t).map(E=>this.chipHTML(E)).join(""),g=c.length>_t?`<div class="text-[10px] font-medium text-on-surface-variant/60 px-1.5">还有 ${c.length-_t} 个活动</div>`:"",b=c.length===0?'<div class="text-[10px] text-on-surface-variant/35 text-center py-3">—</div>':"";return`<div data-day="${l}" role="button" tabindex="0"
          ...
          ${h}
          <div class="flex flex-col gap-1 min-w-0">${f}${g}${b}</div>
      ...
      `,e)+'<p class="md:hidden text-[11px] text-on-surface-variant/55 mt-2 px-1">点击某天查看下方当日议程</p>'}timelineHTML(e){return e.length===0?`<div class="flex flex-col items-center justify-center text-center py-12 px-4 text-on-surface-variant/50">
        ...
        <p class="text-[11px] mt-1 opacity-70">换个日期或调整筛选试试</p>
          ...
          <div class="rounded-xl border ${i.chipBorder} ${i.chipBg} p-3">
            ...
            <h4 class="text-sm font-bold text-on-surface leading-snug mb-1.5">${qe(n.title)}</h4>
            <div class="flex items-center gap-1 text-[11px] text-on-surface-variant/75 mb-0.5">
              <span class="material-symbols-outlined text-[14px]">location_on</span>
              <span class="truncate">${qe(n.location)}</span>
            </div>
            ${n.organizer?`<div class="flex items-center gap-1 text-[11px] text-on-surface-variant/75">
              <span class="material-symbols-outlined text-[14px]">group</span>
              <span class="truncate">${qe(n.organizer)}</span>
            </div>`:""}
            ${n.description?`<p class="text-[11px] text-on-surface-variant/65 leading-relaxed mt-1.5 line-clamp-2">${qe(n.description)}</p>`:""}
...
`,Ua=Object.freeze(Object.defineProperty({__proto__:null,default:Ha},Symbol.toStringTag,{value:"Module"})),ja=`---
...
`,za=Object.freeze(Object.defineProperty({__proto__:null,default:ja},Symbol.toStringTag,{value:"Module"})),Ga=`---
...
`,qa=Object.freeze(Object.defineProperty({__proto__:null,default:Ga},Symbol.toStringTag,{value:"Module"})),Fa=`---
...
`,Ya=Object.freeze(Object.defineProperty({__proto__:null,default:Fa},Symbol.toStringTag,{value:"Module"}));function Wa(a){if(a instanceof Date&&!Number.isNaN(a.getTime()))return a.toISOString().slice(0,10);if(typeof a=="string"){const r=a.trim().match(/^(\d{4}-\d{2}-\d{2})/);if(r)return r[1]}return new Date().toISOString().split("T")[0]}function Za(a){return a.replace(/\]\(\/blog\/([a-z0-9-]+)\)/gi,"](/article?slug=$1)")}function Xa(a,r){var u;const e=((u=a.split("/").pop())==null?void 0:u.replace(".md",""))||"untitled",t=r.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n([\s\S]*)$/),n={};let s=r;if(t){const p=t[1];s=t[2],p.split(`
`).forEach(h=>{const f=h.trim();if(!f||f.startsWith("#"))return;const g=f.indexOf(":");if(g!==-1){const b=f.slice(0,g).trim();let v=f.slice(g+1).trim();(v.startsWith('"')&&v.endsWith('"')||v.startsWith("'")&&v.endsWith("'"))&&(v=v.slice(1,-1)),n[b]=v}})}const i=s.match(/^\s*#\s+(.+)$/m);let o=n.title;i&&(o||(o=i[1].trim()),s=s.replace(/^\s*#\s+.+$/m,"").trim()),o||(o=e);const l=p=>p.slice(0,300).replace(/[#*`~_\-]/g,"").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/\s+/g," ").trim().slice(0,150)+"...",c=n.excerpt||l(s);return s=Za(s),{slug:n.slug||e,title:o,excerpt:c,category:n.category||"技术沉淀",subCategory:n.subCategory||"General",author:n.author||"Anonymous",authorAvatar:n.authorAvatar||(n.author?n.author[0].toUpperCase():"A"),date:Wa(n.date),readTime:n.readTime||`${Math.max(1,Math.ceil(s.length/500))} min`,content:s,filePath:a}}const En=Object.assign({"../../docs/articles/fix-bug-of-lab-pulse.md":Da,"../../docs/articles/github_repo_code_change_stats_howto.md":Ua,"../../docs/articles/lab-pulse-contribution-heatmap.md":za,"../../docs/articles/lab-web-blog-auto-fetch-howto.md":qa,"../../docs/articles/personal-site-blog-sync-to-emu-howto.md":Ya}),Hn=[];for(const a in En)try{const r=En[a];let e="";if(typeof r=="string")e=r;else if(r&&typeof r.default=="string")e=r.default;else{console.warn(`[article.ts] Failed to load raw content for ${a}:`,r);continue}const t=Xa(a,e);Hn.push(t)}catch(r){console.error(`[article.ts] Error parsing markdown article at ${a}:`,r)}const Lt=[...Hn].sort((a,r)=>new Date(r.date).getTime()-new Date(a.date).getTime()),Ka=Lt.map(a=>({category:a.category,subCategory:a.subCategory,href:`/article?slug=${a.slug}`,title:a.title,excerpt:a.excerpt,authorAvatar:a.authorAvatar,author:a.author,date:a.date,readTime:a.readTime}));class Va extends HTMLElement{constructor(){super(...arguments);y(this,"_currentCategory","全部");y(this,"_searchQuery","");y(this,"_currentPage",1);y(this,"_postsPerPage",4);y(this,"_categories",["全部","后端开发","前端架构","AI/ML","应急科技","开源治理"]);y(this,"_searchHandler",null);y(this,"_searchInput",null)}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this._searchHandler&&this._searchInput&&this._searchInput.removeEventListener("input",this._searchHandler)}getFilteredPosts(){return Ka.filter(e=>{const t=this._currentCategory==="全部"||e.category===this._currentCategory,n=this._searchQuery.trim().toLowerCase(),s=!n||e.title.toLowerCase().includes(n)||e.excerpt.toLowerCase().includes(n);return t&&s})}generatePostHtml(e){return`
      <a 
        href="${e.href}" 
    ...
    `}refreshList(){const e=this.querySelector("#blog-posts-list"),t=this.querySelector("#blog-pagination-container"),n=this.getFilteredPosts(),s=Math.ceil(n.length/this._postsPerPage);this._currentPage>s&&s>0&&(this._currentPage=1);const i=(this._currentPage-1)*this._postsPerPage,o=n.slice(i,i+this._postsPerPage);e&&(e.style.opacity="0"),setTimeout(()=>{e&&(o.length>0?e.innerHTML=o.map(l=>this.generatePostHtml(l)).join(""):e.innerHTML=`
          ...
          `,e.style.opacity="1"),t&&(t.innerHTML=this.generatePaginationHtml(s),this.setupPaginationListeners())},200)}setupEventListeners(){var e;this.addEventListener("click",t=>{const s=t.target.closest(".category-tab");if(s){const i=s.dataset.category||"全部";this._currentCategory!==i&&(this._currentCategory=i,this._currentPage=1,this.querySelectorAll(".category-tab").forEach(l=>{l.className="category-tab px-4 py-2 text-sm font-semibold rounded-xl transition-all duration-300 bg-surface-container hover:bg-surface-container-high text-on-surface-variant dark:text-surface-variant dark:bg-surface-container/30 dark:hover:bg-surface-container/50",l.setAttribute("aria-selected","false")}),s.className="category-tab px-4 py-2 text-sm font-semibold rounded-xl transition-all duration-300 bg-primary text-on-primary shadow-sm dark:bg-primary-fixed dark:text-on-primary-fixed",s.setAttribute("aria-selected","true"),this.refreshList())}}),this._searchInput=this.querySelector("#blog-search-input"),this._searchHandler=()=>{this._searchInput&&(this._searchQuery=this._searchInput.value,this._currentPage=1,this.refreshList())},(e=this._searchInput)==null||e.addEventListener("input",this._searchHandler),this.setupPaginationListeners()}setupPaginationListeners(){const e=this.querySelector("#blog-prev-btn");e==null||e.addEventListener("click",()=>{this._currentPage>1&&(this._currentPage--,this.refreshList(),this.scrollToTop())});const t=this.querySelector("#blog-next-btn");t==null||t.addEventListener("click",()=>{const s=this.getFilteredPosts(),i=Math.ceil(s.length/this._postsPerPage);this._currentPage<i&&(this._currentPage++,this.refreshList(),this.scrollToTop())}),this.querySelectorAll(".page-num-btn").forEach(s=>{s.addEventListener("click",()=>{const i=parseInt(s.dataset.page||"1",10);this._currentPage!==i&&(this._currentPage=i,this.refreshList(),this.scrollToTop())})})}scrollToTop(){const e=this.querySelector("#blog-container");e&&e.scrollIntoView({behavior:"smooth",block:"start"})}}customElements.define("uem-blog",Va);const Ja="modulepreload",Qa=function(a){return"/"+a},_n={},es=function(r,e,t){let n=Promise.resolve();if(e&&e.length>0){let i=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=i(e.map(c=>{if(c=Qa(c),c in _n)return;_n[c]=!0;const u=c.endsWith(".css"),p=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":Ja,u||(h.as="script"),h.crossOrigin="",h.href=c,l&&h.setAttribute("nonce",l),document.head.appendChild(h),u)return new Promise((f,g)=>{h.addEventListener("load",f),h.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return n.then(i=>{for(const o of i||[])o.status==="rejected"&&s(o.reason);return r().catch(s)})};function Rt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ne=Rt();function Un(a){Ne=a}var Ce={exec:()=>null};function Be(a){let r=[];return e=>{let t=Math.max(0,Math.min(3,e-1)),n=r[t];return n||(n=a(t),r[t]=n),n}}function z(a,r=""){let e=typeof a=="string"?a:a.source,t={replace:(n,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(le.caret,"$1"),e=e.replace(n,i),t},getRegex:()=>new RegExp(e,r)};return t}var ts=((a="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+a)}catch{return!1}})(),le={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:a=>new RegExp(`^( {0,3}${a})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:Be(a=>new RegExp(`^ {0,${a}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:Be(a=>new RegExp(`^ {0,${a}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:Be(a=>new RegExp(`^ {0,${a}}(?:\`\`\`|~~~)`)),headingBeginRegex:Be(a=>new RegExp(`^ {0,${a}}#`)),htmlBeginRegex:Be(a=>new RegExp(`^ {0,${a}}<(?:[a-z].*>|!--)`,"i")),blockquoteBeginRegex:Be(a=>new RegExp(`^ {0,${a}}>`))},ns=/^(?:[ \t]*(?:\n|$))+/,rs=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,as=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ze=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ss=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Ot=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,jn=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,zn=z(jn).replace(/bull/g,Ot).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),is=z(jn).replace(/bull/g,Ot).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),It=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,os=/^[^\n]+/,Pt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ls=z(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Pt).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),cs=z(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Ot).getRegex(),ut="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Bt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ds=z("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Bt).replace("tag",ut).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Gn=z(It).replace("hr",Ze).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ut).getRegex(),us=z(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Gn).getRegex(),Dt={blockquote:us,code:rs,def:ls,fences:as,heading:ss,hr:Ze,html:ds,lheading:zn,list:cs,newline:ns,paragraph:Gn,table:Ce,text:os},Sn=z("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ze).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ut).getRegex(),ps={...Dt,lheading:is,table:Sn,paragraph:z(It).replace("hr",Ze).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Sn).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ut).getRegex()},hs={...Dt,html:z(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Bt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ce,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:z(It).replace("hr",Ze).replace("heading",` *#{1,6} *[^
]`).replace("lheading",zn).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},gs=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ms=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,qn=/^( {2,}|\\)\n(?!\s*$)/,bs=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,He=/[\p{P}\p{S}]/u,pt=/[\s\p{P}\p{S}]/u,Ht=/[^\s\p{P}\p{S}]/u,fs=z(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,pt).getRegex(),Fn=/(?!~)[\p{P}\p{S}]/u,xs=/(?!~)[\s\p{P}\p{S}]/u,vs=/(?:[^\s\p{P}\p{S}]|~)/u,ys=z(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",ts?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Yn=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,ks=z(Yn,"u").replace(/punct/g,He).getRegex(),ws=z(Yn,"u").replace(/punct/g,Fn).getRegex(),Wn="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Es=z(Wn,"gu").replace(/notPunctSpace/g,Ht).replace(/punctSpace/g,pt).replace(/punct/g,He).getRegex(),_s=z(Wn,"gu").replace(/notPunctSpace/g,vs).replace(/punctSpace/g,xs).replace(/punct/g,Fn).getRegex(),Ss=z("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Ht).replace(/punctSpace/g,pt).replace(/punct/g,He).getRegex(),Ts=z(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,He).getRegex(),As="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Ls=z(As,"gu").replace(/notPunctSpace/g,Ht).replace(/punctSpace/g,pt).replace(/punct/g,He).getRegex(),Ms=z(/\\(punct)/,"gu").replace(/punct/g,He).getRegex(),Cs=z(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),$s=z(Bt).replace("(?:-->|$)","-->").getRegex(),Ns=z("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",$s).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ot=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,Rs=z(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",ot).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Zn=z(/^!?\[(label)\]\[(ref)\]/).replace("label",ot).replace("ref",Pt).getRegex(),Xn=z(/^!?\[(ref)\](?:\[\])?/).replace("ref",Pt).getRegex(),Os=z("reflink|nolink(?!\\()","g").replace("reflink",Zn).replace("nolink",Xn).getRegex(),Tn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ut={_backpedal:Ce,anyPunctuation:Ms,autolink:Cs,blockSkip:ys,br:qn,code:ms,del:Ce,delLDelim:Ce,delRDelim:Ce,emStrongLDelim:ks,emStrongRDelimAst:Es,emStrongRDelimUnd:Ss,escape:gs,link:Rs,nolink:Xn,punctuation:fs,reflink:Zn,reflinkSearch:Os,tag:Ns,text:bs,url:Ce},Is={...Ut,link:z(/^!?\[(label)\]\((.*?)\)/).replace("label",ot).getRegex(),reflink:z(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ot).getRegex()},Mt={...Ut,emStrongRDelimAst:_s,emStrongLDelim:ws,delLDelim:Ts,delRDelim:Ls,url:z(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Tn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:z(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Tn).getRegex()},Ps={...Mt,br:z(qn).replace("{2,}","*").getRegex(),text:z(Mt.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},at={normal:Dt,gfm:ps,pedantic:hs},Fe={normal:Ut,gfm:Mt,breaks:Ps,pedantic:Is},Bs={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},An=a=>Bs[a];function ke(a,r){if(r){if(le.escapeTest.test(a))return a.replace(le.escapeReplace,An)}else if(le.escapeTestNoEncode.test(a))return a.replace(le.escapeReplaceNoEncode,An);return a}function Ln(a){try{a=encodeURI(a).replace(le.percentDecode,"%")}catch{return null}return a}function Mn(a,r){var s;let e=a.replace(le.findPipe,(i,o,l)=>{let c=!1,u=o;for(;--u>=0&&l[u]==="\\";)c=!c;return c?"|":" |"}),t=e.split(le.splitPipe),n=0;if(t[0].trim()||t.shift(),t.length>0&&!((s=t.at(-1))!=null&&s.trim())&&t.pop(),r)if(t.length>r)t.splice(r);else for(;t.length<r;)t.push("");for(;n<t.length;n++)t[n]=t[n].trim().replace(le.slashPipe,"|");return t}function Te(a,r,e){let t=a.length;if(t===0)return"";let n=0;for(;n<t&&a.charAt(t-n-1)===r;)n++;return a.slice(0,t-n)}function Cn(a){let r=a.split(`
`),e=r.length-1;for(;e>=0&&le.blankLine.test(r[e]);)e--;return r.length-e<=2?a:r.slice(0,e+1).join(`
`)}function Ds(a,r){if(a.indexOf(r[1])===-1)return-1;let e=0;for(let t=0;t<a.length;t++)if(a[t]==="\\")t++;else if(a[t]===r[0])e++;else if(a[t]===r[1]&&(e--,e<0))return t;return e>0?-2:-1}function Hs(a,r=0){let e=r,t="";for(let n of a)if(n==="	"){let s=4-e%4;t+=" ".repeat(s),e+=s}else t+=n,e++;return t}function $n(a,r,e,t,n){let s=r.href,i=r.title||null,o=a[1].replace(n.other.outputLinkReplace,"$1");t.state.inLink=!0;let l={type:a[0].charAt(0)==="!"?"image":"link",raw:e,href:s,title:i,text:o,tokens:t.inlineTokens(o)};return t.state.inLink=!1,l}function Us(a,r,e){let t=a.match(e.other.indentCodeCompensation);if(t===null)return r;let n=t[1];return r.split(`
`).map(s=>{let i=s.match(e.other.beginningSpace);if(i===null)return s;let[o]=i;return o.length>=n.length?s.slice(n.length):s}).join(`
`)}var lt=class{constructor(a){y(this,"options");y(this,"rules");y(this,"lexer");this.options=a||Ne}space(a){let r=this.rules.block.newline.exec(a);if(r&&r[0].length>0)return{type:"space",raw:r[0]}}code(a){let r=this.rules.block.code.exec(a);if(r){let e=this.options.pedantic?r[0]:Cn(r[0]),t=e.replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e,codeBlockStyle:"indented",text:t}}}fences(a){let r=this.rules.block.fences.exec(a);if(r){let e=r[0],t=Us(e,r[3]||"",this.rules);return{type:"code",raw:e,lang:r[2]?r[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):r[2],text:t}}}heading(a){let r=this.rules.block.heading.exec(a);if(r){let e=r[2].trim();if(this.rules.other.endingHash.test(e)){let t=Te(e,"#");(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:"heading",raw:Te(r[0],`
...
${c}`:c,n=n?`${n}
${u}`:u;let p=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(u,s,!0),this.lexer.state.top=p,e.length===0)break;let h=s.at(-1);if((h==null?void 0:h.type)==="code")break;if((h==null?void 0:h.type)==="blockquote"){let f=h,g=f.raw+`
`+e.join(`
`),b=this.blockquote(g);s[s.length-1]=b,t=t.substring(0,t.length-f.raw.length)+b.raw,n=n.substring(0,n.length-f.text.length)+b.text;break}else if((h==null?void 0:h.type)==="list"){let f=h,g=f.raw+`
`+e.join(`
`),b=this.list(g);s[s.length-1]=b,t=t.substring(0,t.length-h.raw.length)+b.raw,n=n.substring(0,n.length-f.raw.length)+b.raw,e=g.substring(s.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:t,tokens:s,text:n}}}list(a){let r=this.rules.block.list.exec(a);if(r){let e=r[1].trim(),t=e.length>1,n={type:"list",raw:"",ordered:t,start:t?+e.slice(0,-1):"",loose:!1,items:[]};e=t?`\\d{1,9}\\${e.slice(-1)}`:`\\${e}`,this.options.pedantic&&(e=t?e:"[*+-]");let s=this.rules.other.listItemRegex(e),i=!1;for(;a;){let l=!1,c="",u="";if(!(r=s.exec(a))||this.rules.block.hr.test(a))break;c=r[0],a=a.substring(c.length);let p=Hs(r[2].split(`
`,1)[0],r[1].length),h=a.split(`
`,1)[0],f=!p.trim(),g=0;if(this.options.pedantic?(g=2,u=p.trimStart()):f?g=r[1].length+1:(g=p.search(this.rules.other.nonSpaceChar),g=g>4?1:g,u=p.slice(g),g+=r[1].length),f&&this.rules.other.blankLine.test(h)&&(c+=h+`
`,a=a.substring(h.length+1),l=!0),!l){let b=this.rules.other.nextBulletRegex(g),v=this.rules.other.hrRegex(g),E=this.rules.other.fencesBeginRegex(g),T=this.rules.other.headingBeginRegex(g),w=this.rules.other.htmlBeginRegex(g),H=this.rules.other.blockquoteBeginRegex(g);for(;a;){let D=a.split(`
`,1)[0],q;if(h=D,this.options.pedantic?(h=h.replace(this.rules.other.listReplaceNesting,"  "),q=h):q=h.replace(this.rules.other.tabCharGlobal,"    "),E.test(h)||T.test(h)||w.test(h)||H.test(h)||b.test(h)||v.test(h))break;if(q.search(this.rules.other.nonSpaceChar)>=g||!h.trim())u+=`
`+q.slice(g);else{if(f||p.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||E.test(p)||T.test(p)||v.test(p))break;u+=`
`+h}f=!h.trim(),c+=D+`
`,a=a.substring(D.length+1),p=q.slice(g)}}n.loose||(i?n.loose=!0:this.rules.other.doubleBlankLine.test(c)&&(i=!0)),n.items.push({type:"list_item",raw:c,task:!!this.options.gfm&&this.rules.other.listIsTask.test(u),loose:!1,text:u,tokens:[]}),n.raw+=c}let o=n.items.at(-1);if(o)o.raw=o.raw.trimEnd(),o.text=o.text.trimEnd();else return;n.raw=n.raw.trimEnd();for(let l of n.items){this.lexer.state.top=!1,l.tokens=this.lexer.blockTokens(l.text,[]);let c=l.tokens[0];if(l.task&&((c==null?void 0:c.type)==="text"||(c==null?void 0:c.type)==="paragraph")){l.text=l.text.replace(this.rules.other.listReplaceTask,""),c.raw=c.raw.replace(this.rules.other.listReplaceTask,""),c.text=c.text.replace(this.rules.other.listReplaceTask,"");for(let p=this.lexer.inlineQueue.length-1;p>=0;p--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[p].src)){this.lexer.inlineQueue[p].src=this.lexer.inlineQueue[p].src.replace(this.rules.other.listReplaceTask,"");break}let u=this.rules.other.listTaskCheckbox.exec(l.raw);if(u){let p={type:"checkbox",raw:u[0]+" ",checked:u[0]!=="[ ]"};l.checked=p.checked,n.loose?l.tokens[0]&&["paragraph","text"].includes(l.tokens[0].type)&&"tokens"in l.tokens[0]&&l.tokens[0].tokens?(l.tokens[0].raw=p.raw+l.tokens[0].raw,l.tokens[0].text=p.raw+l.tokens[0].text,l.tokens[0].tokens.unshift(p)):l.tokens.unshift({type:"paragraph",raw:p.raw,text:p.raw,tokens:[p]}):l.tokens.unshift(p)}}else l.task&&(l.task=!1);if(!n.loose){let u=l.tokens.filter(h=>h.type==="space"),p=u.length>0&&u.some(h=>this.rules.other.anyLine.test(h.raw));n.loose=p}}if(n.loose)for(let l of n.items){l.loose=!0;for(let c of l.tokens)c.type==="text"&&(c.type="paragraph")}return n}}html(a){let r=this.rules.block.html.exec(a);if(r){let e=Cn(r[0]);return{type:"html",block:!0,raw:e,pre:r[1]==="pre"||r[1]==="script"||r[1]==="style",text:e}}}def(a){let r=this.rules.block.def.exec(a);if(r){let e=r[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),t=r[2]?r[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",n=r[3]?r[3].substring(1,r[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):r[3];return{type:"def",tag:e,raw:Te(r[0],`
`),href:t,title:n}}}table(a){var i;let r=this.rules.block.table.exec(a);if(!r||!this.rules.other.tableDelimiter.test(r[2]))return;let e=Mn(r[1]),t=r[2].replace(this.rules.other.tableAlignChars,"").split("|"),n=(i=r[3])!=null&&i.trim()?r[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],s={type:"table",raw:Te(r[0],`
`),header:[],align:[],rows:[]};if(e.length===t.length){for(let o of t)this.rules.other.tableAlignRight.test(o)?s.align.push("right"):this.rules.other.tableAlignCenter.test(o)?s.align.push("center"):this.rules.other.tableAlignLeft.test(o)?s.align.push("left"):s.align.push(null);for(let o=0;o<e.length;o++)s.header.push({text:e[o],tokens:this.lexer.inline(e[o]),header:!0,align:s.align[o]});for(let o of n)s.rows.push(Mn(o,s.header.length).map((l,c)=>({text:l,tokens:this.lexer.inline(l),header:!1,align:s.align[c]})));return s}}lheading(a){let r=this.rules.block.lheading.exec(a);if(r){let e=r[1].trim();return{type:"heading",raw:Te(r[0],`
...
`)?"":`
`)+l.raw,u.text+=`
`+l.raw,this.inlineQueue.at(-1).src=u.text):this.tokens.links[l.tag]||(this.tokens.links[l.tag]={href:l.href,title:l.title},e.push(l));continue}if(l=this.tokenizer.table(r)){r=r.substring(l.raw.length),e.push(l);continue}if(l=this.tokenizer.lheading(r)){r=r.substring(l.raw.length),e.push(l);continue}let c=r;if((o=this.options.extensions)!=null&&o.startBlock){let u=1/0,p=r.slice(1),h;this.options.extensions.startBlock.forEach(f=>{h=f.call({lexer:this},p),typeof h=="number"&&h>=0&&(u=Math.min(u,h))}),u<1/0&&u>=0&&(c=r.substring(0,u+1))}if(this.state.top&&(l=this.tokenizer.paragraph(c))){let u=e.at(-1);t&&(u==null?void 0:u.type)==="paragraph"?(u.raw+=(u.raw.endsWith(`
`)?"":`
`)+l.raw,u.text+=`
...
`)?"":`
`)+l.raw,u.text+=`
`+l.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):e.push(l);continue}if(r){this.infiniteLoopError(r.charCodeAt(0));break}}return this.state.top=!0,e}inline(r,e=[]){return this.inlineQueue.push({src:r,tokens:e}),e}inlineTokens(r,e=[]){var c,u,p,h,f;this.tokenizer.lexer=this;let t=r,n=null;if(this.tokens.links){let g=Object.keys(this.tokens.links);if(g.length>0)for(;(n=this.tokenizer.rules.inline.reflinkSearch.exec(t))!==null;)g.includes(n[0].slice(n[0].lastIndexOf("[")+1,-1))&&(t=t.slice(0,n.index)+"["+"a".repeat(n[0].length-2)+"]"+t.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(n=this.tokenizer.rules.inline.anyPunctuation.exec(t))!==null;)t=t.slice(0,n.index)+"++"+t.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let s;for(;(n=this.tokenizer.rules.inline.blockSkip.exec(t))!==null;)s=n[2]?n[2].length:0,t=t.slice(0,n.index+s)+"["+"a".repeat(n[0].length-s-2)+"]"+t.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);t=((u=(c=this.options.hooks)==null?void 0:c.emStrongMask)==null?void 0:u.call({lexer:this},t))??t;let i=!1,o="",l=1/0;for(;r;){if(r.length<l)l=r.length;else{this.infiniteLoopError(r.charCodeAt(0));break}i||(o=""),i=!1;let g;if((h=(p=this.options.extensions)==null?void 0:p.inline)!=null&&h.some(v=>(g=v.call({lexer:this},r,e))?(r=r.substring(g.raw.length),e.push(g),!0):!1))continue;if(g=this.tokenizer.escape(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.tag(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.link(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.reflink(r,this.tokens.links)){r=r.substring(g.raw.length);let v=e.at(-1);g.type==="text"&&(v==null?void 0:v.type)==="text"?(v.raw+=g.raw,v.text+=g.text):e.push(g);continue}if(g=this.tokenizer.emStrong(r,t,o)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.codespan(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.br(r)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.del(r,t,o)){r=r.substring(g.raw.length),e.push(g);continue}if(g=this.tokenizer.autolink(r)){r=r.substring(g.raw.length),e.push(g);continue}if(!this.state.inLink&&(g=this.tokenizer.url(r))){r=r.substring(g.raw.length),e.push(g);continue}let b=r;if((f=this.options.extensions)!=null&&f.startInline){let v=1/0,E=r.slice(1),T;this.options.extensions.startInline.forEach(w=>{T=w.call({lexer:this},E),typeof T=="number"&&T>=0&&(v=Math.min(v,T))}),v<1/0&&v>=0&&(b=r.substring(0,v+1))}if(g=this.tokenizer.inlineText(b)){r=r.substring(g.raw.length),g.raw.slice(-1)!=="_"&&(o=g.raw.slice(-1)),i=!0;let v=e.at(-1);(v==null?void 0:v.type)==="text"?(v.raw+=g.raw,v.text+=g.text):e.push(g);continue}if(r){this.infiniteLoopError(r.charCodeAt(0));break}}return e}infiniteLoopError(r){let e="Infinite loop on byte: "+r;if(this.options.silent)console.error(e);else throw new Error(e)}},ct=class{constructor(a){y(this,"options");y(this,"parser");this.options=a||Ne}space(a){return""}code({text:a,lang:r,escaped:e}){var s;let t=(s=(r||"").match(le.notSpaceStart))==null?void 0:s[0],n=a.replace(le.endingNewline,"")+`
...
`}strong({tokens:a}){return`<strong>${this.parser.parseInline(a)}</strong>`}em({tokens:a}){return`<em>${this.parser.parseInline(a)}</em>`}codespan({text:a}){return`<code>${ke(a,!0)}</code>`}br(a){return"<br>"}del({tokens:a}){return`<del>${this.parser.parseInline(a)}</del>`}link({href:a,title:r,tokens:e}){let t=this.parser.parseInline(e),n=Ln(a);if(n===null)return t;a=n;let s='<a href="'+a+'"';return r&&(s+=' title="'+ke(r)+'"'),s+=">"+t+"</a>",s}image({href:a,title:r,text:e,tokens:t}){t&&(e=this.parser.parseInline(t,this.parser.textRenderer));let n=Ln(a);if(n===null)return ke(e);a=n;let s=`<img src="${a}" alt="${ke(e)}"`;return r&&(s+=` title="${ke(r)}"`),s+=">",s}text(a){return"tokens"in a&&a.tokens?this.parser.parseInline(a.tokens):"escaped"in a&&a.escaped?a.text:ke(a.text)}},jt=class{strong({text:a}){return a}em({text:a}){return a}codespan({text:a}){return a}del({text:a}){return a}html({text:a}){return a}text({text:a}){return a}link({text:a}){return""+a}image({text:a}){return""+a}br(){return""}checkbox({raw:a}){return a}},fe=class $t{constructor(r){y(this,"options");y(this,"renderer");y(this,"textRenderer");this.options=r||Ne,this.options.renderer=this.options.renderer||new ct,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new jt}static parse(r,e){return new $t(e).parse(r)}static parseInline(r,e){return new $t(e).parseInline(r)}parse(r){var t,n;this.renderer.parser=this;let e="";for(let s=0;s<r.length;s++){let i=r[s];if((n=(t=this.options.extensions)==null?void 0:t.renderers)!=null&&n[i.type]){let l=i,c=this.options.extensions.renderers[l.type].call({parser:this},l);if(c!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(l.type)){e+=c||"";continue}}let o=i;switch(o.type){case"space":{e+=this.renderer.space(o);break}case"hr":{e+=this.renderer.hr(o);break}case"heading":{e+=this.renderer.heading(o);break}case"code":{e+=this.renderer.code(o);break}case"table":{e+=this.renderer.table(o);break}case"blockquote":{e+=this.renderer.blockquote(o);break}case"list":{e+=this.renderer.list(o);break}case"checkbox":{e+=this.renderer.checkbox(o);break}case"html":{e+=this.renderer.html(o);break}case"def":{e+=this.renderer.def(o);break}case"paragraph":{e+=this.renderer.paragraph(o);break}case"text":{e+=this.renderer.text(o);break}default:{let l='Token with "'+o.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return e}parseInline(r,e=this.renderer){var n,s;this.renderer.parser=this;let t="";for(let i=0;i<r.length;i++){let o=r[i];if((s=(n=this.options.extensions)==null?void 0:n.renderers)!=null&&s[o.type]){let c=this.options.extensions.renderers[o.type].call({parser:this},o);if(c!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(o.type)){t+=c||"";continue}}let l=o;switch(l.type){case"escape":{t+=e.text(l);break}case"html":{t+=e.html(l);break}case"link":{t+=e.link(l);break}case"image":{t+=e.image(l);break}case"checkbox":{t+=e.checkbox(l);break}case"strong":{t+=e.strong(l);break}case"em":{t+=e.em(l);break}case"codespan":{t+=e.codespan(l);break}case"br":{t+=e.br(l);break}case"del":{t+=e.del(l);break}case"text":{t+=e.text(l);break}default:{let c='Token with "'+l.type+'" type was not found.';if(this.options.silent)return console.error(c),"";throw new Error(c)}}}return t}},st,Ye=(st=class{constructor(a){y(this,"options");y(this,"block");this.options=a||Ne}preprocess(a){return a}postprocess(a){return a}processAllTokens(a){return a}emStrongMask(a){return a}provideLexer(a=this.block){return a?be.lex:be.lexInline}provideParser(a=this.block){return a?fe.parse:fe.parseInline}},y(st,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),y(st,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),st),js=class{constructor(...a){y(this,"defaults",Rt());y(this,"options",this.setOptions);y(this,"parse",this.parseMarkdown(!0));y(this,"parseInline",this.parseMarkdown(!1));y(this,"Parser",fe);y(this,"Renderer",ct);y(this,"TextRenderer",jt);y(this,"Lexer",be);y(this,"Tokenizer",lt);y(this,"Hooks",Ye);this.use(...a)}walkTokens(a,r){var t,n;let e=[];for(let s of a)switch(e=e.concat(r.call(this,s)),s.type){case"table":{let i=s;for(let o of i.header)e=e.concat(this.walkTokens(o.tokens,r));for(let o of i.rows)for(let l of o)e=e.concat(this.walkTokens(l.tokens,r));break}case"list":{let i=s;e=e.concat(this.walkTokens(i.items,r));break}default:{let i=s;(n=(t=this.defaults.extensions)==null?void 0:t.childTokens)!=null&&n[i.type]?this.defaults.extensions.childTokens[i.type].forEach(o=>{let l=i[o].flat(1/0);e=e.concat(this.walkTokens(l,r))}):i.tokens&&(e=e.concat(this.walkTokens(i.tokens,r)))}}return e}use(...a){let r=this.defaults.extensions||{renderers:{},childTokens:{}};return a.forEach(e=>{let t={...e};if(t.async=this.defaults.async||t.async||!1,e.extensions&&(e.extensions.forEach(n=>{if(!n.name)throw new Error("extension name required");if("renderer"in n){let s=r.renderers[n.name];s?r.renderers[n.name]=function(...i){let o=n.renderer.apply(this,i);return o===!1&&(o=s.apply(this,i)),o}:r.renderers[n.name]=n.renderer}if("tokenizer"in n){if(!n.level||n.level!=="block"&&n.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let s=r[n.level];s?s.unshift(n.tokenizer):r[n.level]=[n.tokenizer],n.start&&(n.level==="block"?r.startBlock?r.startBlock.push(n.start):r.startBlock=[n.start]:n.level==="inline"&&(r.startInline?r.startInline.push(n.start):r.startInline=[n.start]))}"childTokens"in n&&n.childTokens&&(r.childTokens[n.name]=n.childTokens)}),t.extensions=r),e.renderer){let n=this.defaults.renderer||new ct(this.defaults);for(let s in e.renderer){if(!(s in n))throw new Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let i=s,o=e.renderer[i],l=n[i];n[i]=(...c)=>{let u=o.apply(n,c);return u===!1&&(u=l.apply(n,c)),u||""}}t.renderer=n}if(e.tokenizer){let n=this.defaults.tokenizer||new lt(this.defaults);for(let s in e.tokenizer){if(!(s in n))throw new Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let i=s,o=e.tokenizer[i],l=n[i];n[i]=(...c)=>{let u=o.apply(n,c);return u===!1&&(u=l.apply(n,c)),u}}t.tokenizer=n}if(e.hooks){let n=this.defaults.hooks||new Ye;for(let s in e.hooks){if(!(s in n))throw new Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let i=s,o=e.hooks[i],l=n[i];Ye.passThroughHooks.has(s)?n[i]=c=>{if(this.defaults.async&&Ye.passThroughHooksRespectAsync.has(s))return(async()=>{let p=await o.call(n,c);return l.call(n,p)})();let u=o.call(n,c);return l.call(n,u)}:n[i]=(...c)=>{if(this.defaults.async)return(async()=>{let p=await o.apply(n,c);return p===!1&&(p=await l.apply(n,c)),p})();let u=o.apply(n,c);return u===!1&&(u=l.apply(n,c)),u}}t.hooks=n}if(e.walkTokens){let n=this.defaults.walkTokens,s=e.walkTokens;t.walkTokens=function(i){let o=[];return o.push(s.call(this,i)),n&&(o=o.concat(n.call(this,i))),o}}this.defaults={...this.defaults,...t}}),this}setOptions(a){return this.defaults={...this.defaults,...a},this}lexer(a,r){return be.lex(a,r??this.defaults)}parser(a,r){return fe.parse(a,r??this.defaults)}parseMarkdown(a){return(r,e)=>{let t={...e},n={...this.defaults,...t},s=this.onError(!!n.silent,!!n.async);if(this.defaults.async===!0&&t.async===!1)return s(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof r>"u"||r===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof r!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(r)+", string expected"));if(n.hooks&&(n.hooks.options=n,n.hooks.block=a),n.async)return(async()=>{let i=n.hooks?await n.hooks.preprocess(r):r,o=await(n.hooks?await n.hooks.provideLexer(a):a?be.lex:be.lexInline)(i,n),l=n.hooks?await n.hooks.processAllTokens(o):o;n.walkTokens&&await Promise.all(this.walkTokens(l,n.walkTokens));let c=await(n.hooks?await n.hooks.provideParser(a):a?fe.parse:fe.parseInline)(l,n);return n.hooks?await n.hooks.postprocess(c):c})().catch(s);try{n.hooks&&(r=n.hooks.preprocess(r));let i=(n.hooks?n.hooks.provideLexer(a):a?be.lex:be.lexInline)(r,n);n.hooks&&(i=n.hooks.processAllTokens(i)),n.walkTokens&&this.walkTokens(i,n.walkTokens);let o=(n.hooks?n.hooks.provideParser(a):a?fe.parse:fe.parseInline)(i,n);return n.hooks&&(o=n.hooks.postprocess(o)),o}catch(i){return s(i)}}}onError(a,r){return e=>{if(e.message+=`
Please report this to https://github.com/markedjs/marked.`,a){let t="<p>An error occurred:</p><pre>"+ke(e.message+"",!0)+"</pre>";return r?Promise.resolve(t):t}if(r)return Promise.reject(e);throw e}}},$e=new js;function G(a,r){return $e.parse(a,r)}G.options=G.setOptions=function(a){return $e.setOptions(a),G.defaults=$e.defaults,Un(G.defaults),G};G.getDefaults=Rt;G.defaults=Ne;G.use=function(...a){return $e.use(...a),G.defaults=$e.defaults,Un(G.defaults),G};G.walkTokens=function(a,r){return $e.walkTokens(a,r)};G.parseInline=$e.parseInline;G.Parser=fe;G.parser=fe.parse;G.Renderer=ct;G.TextRenderer=jt;G.Lexer=be;G.lexer=be.lex;G.Tokenizer=lt;G.Hooks=Ye;G.parse=G;G.options;G.setOptions;G.use;G.walkTokens;G.parseInline;fe.parse;be.lex;const Nn=[{type:"note",icon:'<svg class="octicon octicon-info mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>'},{type:"tip",icon:'<svg class="octicon octicon-light-bulb mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M8 1.5c-2.363 0-4 1.69-4 3.75 0 .984.424 1.625.984 2.304l.214.253c.223.264.47.556.673.848.284.411.537.896.621 1.49a.75.75 0 0 1-1.484.211c-.04-.282-.163-.547-.37-.847a8.456 8.456 0 0 0-.542-.68c-.084-.1-.173-.205-.268-.32C3.201 7.75 2.5 6.766 2.5 5.25 2.5 2.31 4.863 0 8 0s5.5 2.31 5.5 5.25c0 1.516-.701 2.5-1.328 3.259-.095.115-.184.22-.268.319-.207.245-.383.453-.541.681-.208.3-.33.565-.37.847a.751.751 0 0 1-1.485-.212c.084-.593.337-1.078.621-1.489.203-.292.45-.584.673-.848.075-.088.147-.173.213-.253.561-.679.985-1.32.985-2.304 0-2.06-1.637-3.75-4-3.75ZM5.75 12h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM6 15.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75Z"></path></svg>'},{type:"important",icon:'<svg class="octicon octicon-report mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0 1 14.25 13H8.06l-2.573 2.573A1.458 1.458 0 0 1 3 14.543V13H1.75A1.75 1.75 0 0 1 0 11.25Zm1.75-.25a.25.25 0 0 0-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h6.5a.25.25 0 0 0 .25-.25v-9.5a.25.25 0 0 0-.25-.25Zm7 2.25v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>'},{type:"warning",icon:'<svg class="octicon octicon-alert mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path></svg>'},{type:"caution",icon:'<svg class="octicon octicon-stop mr-2" viewBox="0 0 16 16" width="16" height="16" aria-hidden="true"><path d="M4.47.22A.749.749 0 0 1 5 0h6c.199 0 .389.079.53.22l4.25 4.25c.141.14.22.331.22.53v6a.749.749 0 0 1-.22.53l-4.25 4.25A.749.749 0 0 1 11 16H5a.749.749 0 0 1-.53-.22L.22 11.53A.749.749 0 0 1 0 11V5c0-.199.079-.389.22-.53Zm.84 1.28L1.5 5.31v5.38l3.81 3.81h5.38l3.81-3.81V5.31L10.69 1.5ZM8 4a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 8 4Zm0 8a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>'}];function zs(a){return a.length?Object.values([...Nn,...a].reduce((r,e)=>(r[e.type]=e,r),{})):Nn}function Rn(a){return`^(?:\\[!${a.toUpperCase()}])\\s*?
*`}function Gs(a){return a.slice(0,1).toUpperCase()+a.slice(1).toLowerCase()}function qs(a={}){const{className:r="markdown-alert",variants:e=[]}=a,t=zs(e);return{walkTokens(n){var s,i,o,l;if(n.type!=="blockquote")return;const c=t.find(({type:u})=>new RegExp(Rn(u)).test(n.text));if(c){const{type:u,icon:p,title:h=Gs(u),titleClassName:f=`${r}-title`}=c,g=new RegExp(Rn(u));Object.assign(n,{type:"alert",meta:{className:r,variant:u,icon:p,title:h,titleClassName:f}});const b=(s=n.tokens)==null?void 0:s[0];if((i=b.raw)!=null&&i.replace(g,"").trim()){const v=b.tokens[0];Object.assign(v,{raw:v.raw.replace(g,""),text:v.text.replace(g,"")}),((o=b.tokens[1])==null?void 0:o.type)==="br"&&b.tokens.splice(1,1)}else(l=n.tokens)==null||l.shift()}},extensions:[{name:"alert",level:"block",renderer({meta:n,tokens:s=[]}){let i=`<div class="${n.className} ${n.className}-${n.variant}">
`;return i+=`<p class="${n.titleClassName}">`,i+=n.icon,i+=n.title,i+=`</p>
`,i+=this.parser.parse(s),i+=`</div>
`,i}}]}}function Fs(a){return a&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a}var Tt,On;function Ys(){if(On)return Tt;On=1;function a(d){return d instanceof Map?d.clear=d.delete=d.set=function(){throw new Error("map is read-only")}:d instanceof Set&&(d.add=d.clear=d.delete=function(){throw new Error("set is read-only")}),Object.freeze(d),Object.getOwnPropertyNames(d).forEach(m=>{const k=d[m],N=typeof k;(N==="object"||N==="function")&&!Object.isFrozen(k)&&a(k)}),d}class r{constructor(m){m.data===void 0&&(m.data={}),this.data=m.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function e(d){return d.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function t(d,...m){const k=Object.create(null);for(const N in d)k[N]=d[N];return m.forEach(function(N){for(const J in N)k[J]=N[J]}),k}const n="</span>",s=d=>!!d.scope,i=(d,{prefix:m})=>{if(d.startsWith("language:"))return d.replace("language:","language-");if(d.includes(".")){const k=d.split(".");return[`${m}${k.shift()}`,...k.map((N,J)=>`${N}${"_".repeat(J+1)}`)].join(" ")}return`${m}${d}`};class o{constructor(m,k){this.buffer="",this.classPrefix=k.classPrefix,m.walk(this)}addText(m){this.buffer+=e(m)}openNode(m){if(!s(m))return;const k=i(m.scope,{prefix:this.classPrefix});this.span(k)}closeNode(m){s(m)&&(this.buffer+=n)}value(){return this.buffer}span(m){this.buffer+=`<span class="${m}">`}}const l=(d={})=>{const m={children:[]};return Object.assign(m,d),m};class c{constructor(){this.rootNode=l(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(m){this.top.children.push(m)}openNode(m){const k=l({scope:m});this.add(k),this.stack.push(k)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(m){return this.constructor._walk(m,this.rootNode)}static _walk(m,k){return typeof k=="string"?m.addText(k):k.children&&(m.openNode(k),k.children.forEach(N=>this._walk(m,N)),m.closeNode(k)),m}static _collapse(m){typeof m!="string"&&m.children&&(m.children.every(k=>typeof k=="string")?m.children=[m.children.join("")]:m.children.forEach(k=>{c._collapse(k)}))}}class u extends c{constructor(m){super(),this.options=m}addText(m){m!==""&&this.add(m)}startScope(m){this.openNode(m)}endScope(){this.closeNode()}__addSublanguage(m,k){const N=m.root;k&&(N.scope=`language:${k}`),this.add(N)}toHTML(){return new o(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function p(d){return d?typeof d=="string"?d:d.source:null}function h(d){return b("(?=",d,")")}function f(d){return b("(?:",d,")*")}function g(d){return b("(?:",d,")?")}function b(...d){return d.map(k=>p(k)).join("")}function v(d){const m=d[d.length-1];return typeof m=="object"&&m.constructor===Object?(d.splice(d.length-1,1),m):{}}function E(...d){return"("+(v(d).capture?"":"?:")+d.map(N=>p(N)).join("|")+")"}function T(d){return new RegExp(d.toString()+"|").exec("").length-1}function w(d,m){const k=d&&d.exec(m);return k&&k.index===0}const H=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function D(d,{joinWith:m}){let k=0;return d.map(N=>{k+=1;const J=k;let Q=p(N),A="";for(;Q.length>0;){const S=H.exec(Q);if(!S){A+=Q;break}A+=Q.substring(0,S.index),Q=Q.substring(S.index+S[0].length),S[0][0]==="\\"&&S[1]?A+="\\"+String(Number(S[1])+J):(A+=S[0],S[0]==="("&&k++)}return A}).map(N=>`(${N})`).join(m)}const q=/\b\B/,Z="[a-zA-Z]\\w*",V="[a-zA-Z_]\\w*",ie="\\b\\d+(\\.\\d+)?",ue="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",ge="\\b(0b[01]+)",$="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",O=(d={})=>{const m=/^#![ ]*\//;return d.binary&&(d.begin=b(m,/.*\b/,d.binary,/\b.*/)),t({scope:"meta",begin:m,end:/$/,relevance:0,"on:begin":(k,N)=>{k.index!==0&&N.ignoreMatch()}},d)},W={begin:"\\\\[\\s\\S]",relevance:0},ee={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[W]},ae={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[W]},pe={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},B=function(d,m,k={}){const N=t({scope:"comment",begin:d,end:m,contains:[]},k);N.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const J=E("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return N.contains.push({begin:b(/[ ]+/,"(",J,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),N},I=B("//","$"),j=B("/\\*","\\*/"),F=B("#","$"),ce={scope:"number",begin:ie,relevance:0},Ee={scope:"number",begin:ue,relevance:0},Re={scope:"number",begin:ge,relevance:0},Ae={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[W,{begin:/\[/,end:/\]/,relevance:0,contains:[W]}]},zt={scope:"title",begin:Z,relevance:0},ur={scope:"title",begin:V,relevance:0},pr={begin:"\\.\\s*"+V,relevance:0};var Xe=Object.freeze({__proto__:null,APOS_STRING_MODE:ee,BACKSLASH_ESCAPE:W,BINARY_NUMBER_MODE:Re,BINARY_NUMBER_RE:ge,COMMENT:B,C_BLOCK_COMMENT_MODE:j,C_LINE_COMMENT_MODE:I,C_NUMBER_MODE:Ee,C_NUMBER_RE:ue,END_SAME_AS_BEGIN:function(d){return Object.assign(d,{"on:begin":(m,k)=>{k.data._beginMatch=m[1]},"on:end":(m,k)=>{k.data._beginMatch!==m[1]&&k.ignoreMatch()}})},HASH_COMMENT_MODE:F,IDENT_RE:Z,MATCH_NOTHING_RE:q,METHOD_GUARD:pr,NUMBER_MODE:ce,NUMBER_RE:ie,PHRASAL_WORDS_MODE:pe,QUOTE_STRING_MODE:ae,REGEXP_MODE:Ae,RE_STARTERS_RE:$,SHEBANG:O,TITLE_MODE:zt,UNDERSCORE_IDENT_RE:V,UNDERSCORE_TITLE_MODE:ur});function hr(d,m){d.input[d.index-1]==="."&&m.ignoreMatch()}function gr(d,m){d.className!==void 0&&(d.scope=d.className,delete d.className)}function mr(d,m){m&&d.beginKeywords&&(d.begin="\\b("+d.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",d.__beforeBegin=hr,d.keywords=d.keywords||d.beginKeywords,delete d.beginKeywords,d.relevance===void 0&&(d.relevance=0))}function br(d,m){Array.isArray(d.illegal)&&(d.illegal=E(...d.illegal))}function fr(d,m){if(d.match){if(d.begin||d.end)throw new Error("begin & end are not supported with match");d.begin=d.match,delete d.match}}function xr(d,m){d.relevance===void 0&&(d.relevance=1)}const vr=(d,m)=>{if(!d.beforeMatch)return;if(d.starts)throw new Error("beforeMatch cannot be used with starts");const k=Object.assign({},d);Object.keys(d).forEach(N=>{delete d[N]}),d.keywords=k.keywords,d.begin=b(k.beforeMatch,h(k.begin)),d.starts={relevance:0,contains:[Object.assign(k,{endsParent:!0})]},d.relevance=0,delete k.beforeMatch},yr=["of","and","for","in","not","or","if","then","parent","list","value"],kr="keyword";function Gt(d,m,k=kr){const N=Object.create(null);return typeof d=="string"?J(k,d.split(" ")):Array.isArray(d)?J(k,d):Object.keys(d).forEach(function(Q){Object.assign(N,Gt(d[Q],m,Q))}),N;function J(Q,A){m&&(A=A.map(S=>S.toLowerCase())),A.forEach(function(S){const C=S.split("|");N[C[0]]=[Q,wr(C[0],C[1])]})}}function wr(d,m){return m?Number(m):Er(d)?0:1}function Er(d){return yr.includes(d.toLowerCase())}const qt={},Le=d=>{console.error(d)},Ft=(d,...m)=>{console.log(`WARN: ${d}`,...m)},Oe=(d,m)=>{qt[`${d}/${m}`]||(console.log(`Deprecated as of ${d}. ${m}`),qt[`${d}/${m}`]=!0)},Ke=new Error;function Yt(d,m,{key:k}){let N=0;const J=d[k],Q={},A={};for(let S=1;S<=m.length;S++)A[S+N]=J[S],Q[S+N]=!0,N+=T(m[S-1]);d[k]=A,d[k]._emit=Q,d[k]._multi=!0}function _r(d){if(Array.isArray(d.begin)){if(d.skip||d.excludeBegin||d.returnBegin)throw Le("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ke;if(typeof d.beginScope!="object"||d.beginScope===null)throw Le("beginScope must be object"),Ke;Yt(d,d.begin,{key:"beginScope"}),d.begin=D(d.begin,{joinWith:""})}}function Sr(d){if(Array.isArray(d.end)){if(d.skip||d.excludeEnd||d.returnEnd)throw Le("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ke;if(typeof d.endScope!="object"||d.endScope===null)throw Le("endScope must be object"),Ke;Yt(d,d.end,{key:"endScope"}),d.end=D(d.end,{joinWith:""})}}function Tr(d){d.scope&&typeof d.scope=="object"&&d.scope!==null&&(d.beginScope=d.scope,delete d.scope)}function Ar(d){Tr(d),typeof d.beginScope=="string"&&(d.beginScope={_wrap:d.beginScope}),typeof d.endScope=="string"&&(d.endScope={_wrap:d.endScope}),_r(d),Sr(d)}function Lr(d){function m(A,S){return new RegExp(p(A),"m"+(d.case_insensitive?"i":"")+(d.unicodeRegex?"u":"")+(S?"g":""))}class k{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(S,C){C.position=this.position++,this.matchIndexes[this.matchAt]=C,this.regexes.push([C,S]),this.matchAt+=T(S)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const S=this.regexes.map(C=>C[1]);this.matcherRe=m(D(S,{joinWith:"|"}),!0),this.lastIndex=0}exec(S){this.matcherRe.lastIndex=this.lastIndex;const C=this.matcherRe.exec(S);if(!C)return null;const re=C.findIndex((Ue,mt)=>mt>0&&Ue!==void 0),te=this.matchIndexes[re];return C.splice(0,re),Object.assign(C,te)}}class N{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(S){if(this.multiRegexes[S])return this.multiRegexes[S];const C=new k;return this.rules.slice(S).forEach(([re,te])=>C.addRule(re,te)),C.compile(),this.multiRegexes[S]=C,C}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(S,C){this.rules.push([S,C]),C.type==="begin"&&this.count++}exec(S){const C=this.getMatcher(this.regexIndex);C.lastIndex=this.lastIndex;let re=C.exec(S);if(this.resumingScanAtSamePosition()&&!(re&&re.index===this.lastIndex)){const te=this.getMatcher(0);te.lastIndex=this.lastIndex+1,re=te.exec(S)}return re&&(this.regexIndex+=re.position+1,this.regexIndex===this.count&&this.considerAll()),re}}function J(A){const S=new N;return A.contains.forEach(C=>S.addRule(C.begin,{rule:C,type:"begin"})),A.terminatorEnd&&S.addRule(A.terminatorEnd,{type:"end"}),A.illegal&&S.addRule(A.illegal,{type:"illegal"}),S}function Q(A,S){const C=A;if(A.isCompiled)return C;[gr,fr,Ar,vr].forEach(te=>te(A,S)),d.compilerExtensions.forEach(te=>te(A,S)),A.__beforeBegin=null,[mr,br,xr].forEach(te=>te(A,S)),A.isCompiled=!0;let re=null;return typeof A.keywords=="object"&&A.keywords.$pattern&&(A.keywords=Object.assign({},A.keywords),re=A.keywords.$pattern,delete A.keywords.$pattern),re=re||/\w+/,A.keywords&&(A.keywords=Gt(A.keywords,d.case_insensitive)),C.keywordPatternRe=m(re,!0),S&&(A.begin||(A.begin=/\B|\b/),C.beginRe=m(C.begin),!A.end&&!A.endsWithParent&&(A.end=/\B|\b/),A.end&&(C.endRe=m(C.end)),C.terminatorEnd=p(C.end)||"",A.endsWithParent&&S.terminatorEnd&&(C.terminatorEnd+=(A.end?"|":"")+S.terminatorEnd)),A.illegal&&(C.illegalRe=m(A.illegal)),A.contains||(A.contains=[]),A.contains=[].concat(...A.contains.map(function(te){return Mr(te==="self"?A:te)})),A.contains.forEach(function(te){Q(te,C)}),A.starts&&Q(A.starts,S),C.matcher=J(C),C}if(d.compilerExtensions||(d.compilerExtensions=[]),d.contains&&d.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return d.classNameAliases=t(d.classNameAliases||{}),Q(d)}function Wt(d){return d?d.endsWithParent||Wt(d.starts):!1}function Mr(d){return d.variants&&!d.cachedVariants&&(d.cachedVariants=d.variants.map(function(m){return t(d,{variants:null},m)})),d.cachedVariants?d.cachedVariants:Wt(d)?t(d,{starts:d.starts?t(d.starts):null}):Object.isFrozen(d)?t(d):d}var Cr="11.11.1";class $r extends Error{constructor(m,k){super(m),this.name="HTMLInjectionError",this.html=k}}const gt=e,Zt=t,Xt=Symbol("nomatch"),Nr=7,Kt=function(d){const m=Object.create(null),k=Object.create(null),N=[];let J=!0;const Q="Could not find the language '{}', did you forget to load/include a language module?",A={disableAutodetect:!0,name:"Plain text",contains:[]};let S={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:u};function C(x){return S.noHighlightRe.test(x)}function re(x){let M=x.className+" ";M+=x.parentNode?x.parentNode.className:"";const U=S.languageDetectRe.exec(M);if(U){const X=_e(U[1]);return X||(Ft(Q.replace("{}",U[1])),Ft("Falling back to no-highlight mode for this block.",x)),X?U[1]:"no-highlight"}return M.split(/\s+/).find(X=>C(X)||_e(X))}function te(x,M,U){let X="",ne="";typeof M=="object"?(X=x,U=M.ignoreIllegals,ne=M.language):(Oe("10.7.0","highlight(lang, code, ...args) has been deprecated."),Oe("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),ne=x,X=M),U===void 0&&(U=!0);const me={code:X,language:ne};Je("before:highlight",me);const Se=me.result?me.result:Ue(me.language,me.code,U);return Se.code=me.code,Je("after:highlight",Se),Se}function Ue(x,M,U,X){const ne=Object.create(null);function me(_,L){return _.keywords[L]}function Se(){if(!R.keywords){se.addText(K);return}let _=0;R.keywordPatternRe.lastIndex=0;let L=R.keywordPatternRe.exec(K),P="";for(;L;){P+=K.substring(_,L.index);const Y=ve.case_insensitive?L[0].toLowerCase():L[0],oe=me(R,Y);if(oe){const[we,Xr]=oe;if(se.addText(P),P="",ne[Y]=(ne[Y]||0)+1,ne[Y]<=Nr&&(tt+=Xr),we.startsWith("_"))P+=L[0];else{const Kr=ve.classNameAliases[we]||we;xe(L[0],Kr)}}else P+=L[0];_=R.keywordPatternRe.lastIndex,L=R.keywordPatternRe.exec(K)}P+=K.substring(_),se.addText(P)}function Qe(){if(K==="")return;let _=null;if(typeof R.subLanguage=="string"){if(!m[R.subLanguage]){se.addText(K);return}_=Ue(R.subLanguage,K,!0,an[R.subLanguage]),an[R.subLanguage]=_._top}else _=bt(K,R.subLanguage.length?R.subLanguage:null);R.relevance>0&&(tt+=_.relevance),se.__addSublanguage(_._emitter,_.language)}function he(){R.subLanguage!=null?Qe():Se(),K=""}function xe(_,L){_!==""&&(se.startScope(L),se.addText(_),se.endScope())}function en(_,L){let P=1;const Y=L.length-1;for(;P<=Y;){if(!_._emit[P]){P++;continue}const oe=ve.classNameAliases[_[P]]||_[P],we=L[P];oe?xe(we,oe):(K=we,Se(),K=""),P++}}function tn(_,L){return _.scope&&typeof _.scope=="string"&&se.openNode(ve.classNameAliases[_.scope]||_.scope),_.beginScope&&(_.beginScope._wrap?(xe(K,ve.classNameAliases[_.beginScope._wrap]||_.beginScope._wrap),K=""):_.beginScope._multi&&(en(_.beginScope,L),K="")),R=Object.create(_,{parent:{value:R}}),R}function nn(_,L,P){let Y=w(_.endRe,P);if(Y){if(_["on:end"]){const oe=new r(_);_["on:end"](L,oe),oe.isMatchIgnored&&(Y=!1)}if(Y){for(;_.endsParent&&_.parent;)_=_.parent;return _}}if(_.endsWithParent)return nn(_.parent,L,P)}function qr(_){return R.matcher.regexIndex===0?(K+=_[0],1):(yt=!0,0)}function Fr(_){const L=_[0],P=_.rule,Y=new r(P),oe=[P.__beforeBegin,P["on:begin"]];for(const we of oe)if(we&&(we(_,Y),Y.isMatchIgnored))return qr(L);return P.skip?K+=L:(P.excludeBegin&&(K+=L),he(),!P.returnBegin&&!P.excludeBegin&&(K=L)),tn(P,_),P.returnBegin?0:L.length}function Yr(_){const L=_[0],P=M.substring(_.index),Y=nn(R,_,P);if(!Y)return Xt;const oe=R;R.endScope&&R.endScope._wrap?(he(),xe(L,R.endScope._wrap)):R.endScope&&R.endScope._multi?(he(),en(R.endScope,_)):oe.skip?K+=L:(oe.returnEnd||oe.excludeEnd||(K+=L),he(),oe.excludeEnd&&(K=L));do R.scope&&se.closeNode(),!R.skip&&!R.subLanguage&&(tt+=R.relevance),R=R.parent;while(R!==Y.parent);return Y.starts&&tn(Y.starts,_),oe.returnEnd?0:L.length}function Wr(){const _=[];for(let L=R;L!==ve;L=L.parent)L.scope&&_.unshift(L.scope);_.forEach(L=>se.openNode(L))}let et={};function rn(_,L){const P=L&&L[0];if(K+=_,P==null)return he(),0;if(et.type==="begin"&&L.type==="end"&&et.index===L.index&&P===""){if(K+=M.slice(L.index,L.index+1),!J){const Y=new Error(`0 width match regex (${x})`);throw Y.languageName=x,Y.badRule=et.rule,Y}return 1}if(et=L,L.type==="begin")return Fr(L);if(L.type==="illegal"&&!U){const Y=new Error('Illegal lexeme "'+P+'" for mode "'+(R.scope||"<unnamed>")+'"');throw Y.mode=R,Y}else if(L.type==="end"){const Y=Yr(L);if(Y!==Xt)return Y}if(L.type==="illegal"&&P==="")return K+=`
`,1;if(vt>1e5&&vt>L.index*3)throw new Error("potential infinite loop, way more iterations than matches");return K+=P,P.length}const ve=_e(x);if(!ve)throw Le(Q.replace("{}",x)),new Error('Unknown language: "'+x+'"');const Zr=Lr(ve);let xt="",R=X||Zr;const an={},se=new S.__emitter(S);Wr();let K="",tt=0,Me=0,vt=0,yt=!1;try{if(ve.__emitTokens)ve.__emitTokens(M,se);else{for(R.matcher.considerAll();;){vt++,yt?yt=!1:R.matcher.considerAll(),R.matcher.lastIndex=Me;const _=R.matcher.exec(M);if(!_)break;const L=M.substring(Me,_.index),P=rn(L,_);Me=_.index+P}rn(M.substring(Me))}return se.finalize(),xt=se.toHTML(),{language:x,value:xt,relevance:tt,illegal:!1,_emitter:se,_top:R}}catch(_){if(_.message&&_.message.includes("Illegal"))return{language:x,value:gt(M),illegal:!0,relevance:0,_illegalBy:{message:_.message,index:Me,context:M.slice(Me-100,Me+100),mode:_.mode,resultSoFar:xt},_emitter:se};if(J)return{language:x,value:gt(M),illegal:!1,relevance:0,errorRaised:_,_emitter:se,_top:R};throw _}}function mt(x){const M={value:gt(x),illegal:!1,relevance:0,_top:A,_emitter:new S.__emitter(S)};return M._emitter.addText(x),M}function bt(x,M){M=M||S.languages||Object.keys(m);const U=mt(x),X=M.filter(_e).filter(Qt).map(he=>Ue(he,x,!1));X.unshift(U);const ne=X.sort((he,xe)=>{if(he.relevance!==xe.relevance)return xe.relevance-he.relevance;if(he.language&&xe.language){if(_e(he.language).supersetOf===xe.language)return 1;if(_e(xe.language).supersetOf===he.language)return-1}return 0}),[me,Se]=ne,Qe=me;return Qe.secondBest=Se,Qe}function Rr(x,M,U){const X=M&&k[M]||U;x.classList.add("hljs"),x.classList.add(`language-${X}`)}function ft(x){let M=null;const U=re(x);if(C(U))return;if(Je("before:highlightElement",{el:x,language:U}),x.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",x);return}if(x.children.length>0&&(S.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(x)),S.throwUnescapedHTML))throw new $r("One of your code blocks includes unescaped HTML.",x.innerHTML);M=x;const X=M.textContent,ne=U?te(X,{language:U,ignoreIllegals:!0}):bt(X);x.innerHTML=ne.value,x.dataset.highlighted="yes",Rr(x,U,ne.language),x.result={language:ne.language,re:ne.relevance,relevance:ne.relevance},ne.secondBest&&(x.secondBest={language:ne.secondBest.language,relevance:ne.secondBest.relevance}),Je("after:highlightElement",{el:x,result:ne,text:X})}function Or(x){S=Zt(S,x)}const Ir=()=>{Ve(),Oe("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function Pr(){Ve(),Oe("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let Vt=!1;function Ve(){function x(){Ve()}if(document.readyState==="loading"){Vt||window.addEventListener("DOMContentLoaded",x,!1),Vt=!0;return}document.querySelectorAll(S.cssSelector).forEach(ft)}function Br(x,M){let U=null;try{U=M(d)}catch(X){if(Le("Language definition for '{}' could not be registered.".replace("{}",x)),J)Le(X);else throw X;U=A}U.name||(U.name=x),m[x]=U,U.rawDefinition=M.bind(null,d),U.aliases&&Jt(U.aliases,{languageName:x})}function Dr(x){delete m[x];for(const M of Object.keys(k))k[M]===x&&delete k[M]}function Hr(){return Object.keys(m)}function _e(x){return x=(x||"").toLowerCase(),m[x]||m[k[x]]}function Jt(x,{languageName:M}){typeof x=="string"&&(x=[x]),x.forEach(U=>{k[U.toLowerCase()]=M})}function Qt(x){const M=_e(x);return M&&!M.disableAutodetect}function Ur(x){x["before:highlightBlock"]&&!x["before:highlightElement"]&&(x["before:highlightElement"]=M=>{x["before:highlightBlock"](Object.assign({block:M.el},M))}),x["after:highlightBlock"]&&!x["after:highlightElement"]&&(x["after:highlightElement"]=M=>{x["after:highlightBlock"](Object.assign({block:M.el},M))})}function jr(x){Ur(x),N.push(x)}function zr(x){const M=N.indexOf(x);M!==-1&&N.splice(M,1)}function Je(x,M){const U=x;N.forEach(function(X){X[U]&&X[U](M)})}function Gr(x){return Oe("10.7.0","highlightBlock will be removed entirely in v12.0"),Oe("10.7.0","Please use highlightElement now."),ft(x)}Object.assign(d,{highlight:te,highlightAuto:bt,highlightAll:Ve,highlightElement:ft,highlightBlock:Gr,configure:Or,initHighlighting:Ir,initHighlightingOnLoad:Pr,registerLanguage:Br,unregisterLanguage:Dr,listLanguages:Hr,getLanguage:_e,registerAliases:Jt,autoDetection:Qt,inherit:Zt,addPlugin:jr,removePlugin:zr}),d.debugMode=function(){J=!1},d.safeMode=function(){J=!0},d.versionString=Cr,d.regex={concat:b,lookahead:h,either:E,optional:g,anyNumberOfTimes:f};for(const x in Xe)typeof Xe[x]=="object"&&a(Xe[x]);return Object.assign(d,Xe),d},Ie=Kt({});return Ie.newInstance=()=>Kt({}),Tt=Ie,Ie.HighlightJS=Ie,Ie.default=Ie,Tt}var Ws=Ys();const de=Fs(Ws),In="[A-Za-z$_][0-9A-Za-z$_]*",Zs=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends","using"],Xs=["true","false","null","undefined","NaN","Infinity"],Kn=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Vn=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],Jn=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],Ks=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],Vs=[].concat(Jn,Kn,Vn);function Qn(a){const r=a.regex,e=(B,{after:I})=>{const j="</"+B[0].slice(1);return B.input.indexOf(j,I)!==-1},t=In,n={begin:"<>",end:"</>"},s=/<[A-Za-z0-9\\._:-]+\s*\/>/,i={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(B,I)=>{const j=B[0].length+B.index,F=B.input[j];if(F==="<"||F===","){I.ignoreMatch();return}F===">"&&(e(B,{after:j})||I.ignoreMatch());let ce;const Ee=B.input.substring(j);if(ce=Ee.match(/^\s*=/)){I.ignoreMatch();return}if((ce=Ee.match(/^\s+extends\s+/))&&ce.index===0){I.ignoreMatch();return}}},o={$pattern:In,keyword:Zs,literal:Xs,built_in:Vs,"variable.language":Ks},l="[0-9](_?[0-9])*",c=`\\.(${l})`,u="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",p={className:"number",variants:[{begin:`(\\b(${u})((${c})|\\.)?|(${c}))[eE][+-]?(${l})\\b`},{begin:`\\b(${u})\\b((${c})\\b|\\.)?|(${c})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},h={className:"subst",begin:"\\$\\{",end:"\\}",keywords:o,contains:[]},f={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"xml"}},g={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"css"}},b={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"graphql"}},v={className:"string",begin:"`",end:"`",contains:[a.BACKSLASH_ESCAPE,h]},T={className:"comment",variants:[a.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:t+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),a.C_BLOCK_COMMENT_MODE,a.C_LINE_COMMENT_MODE]},w=[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,f,g,b,v,{match:/\$\d+/},p];h.contains=w.concat({begin:/\{/,end:/\}/,keywords:o,contains:["self"].concat(w)});const H=[].concat(T,h.contains),D=H.concat([{begin:/(\s*)\(/,end:/\)/,keywords:o,contains:["self"].concat(H)}]),q={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:D},Z={variants:[{match:[/class/,/\s+/,t,/\s+/,/extends/,/\s+/,r.concat(t,"(",r.concat(/\./,t),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,t],scope:{1:"keyword",3:"title.class"}}]},V={relevance:0,match:r.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...Kn,...Vn]}},ie={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},ue={variants:[{match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[q],illegal:/%/},ge={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function $(B){return r.concat("(?!",B.join("|"),")")}const O={match:r.concat(/\b/,$([...Jn,"super","import"].map(B=>`${B}\\s*\\(`)),t,r.lookahead(/\s*\(/)),className:"title.function",relevance:0},W={begin:r.concat(/\./,r.lookahead(r.concat(t,/(?![0-9A-Za-z$_(])/))),end:t,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},ee={match:[/get|set/,/\s+/,t,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},q]},ae="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+a.UNDERSCORE_IDENT_RE+")\\s*=>",pe={match:[/const|var|let/,/\s+/,t,/\s*/,/=\s*/,/(async\s*)?/,r.lookahead(ae)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[q]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:o,exports:{PARAMS_CONTAINS:D,CLASS_REFERENCE:V},illegal:/#(?![$_A-z])/,contains:[a.SHEBANG({label:"shebang",binary:"node",relevance:5}),ie,a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,f,g,b,v,T,{match:/\$\d+/},p,V,{scope:"attr",match:t+r.lookahead(":"),relevance:0},pe,{begin:"("+a.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[T,a.REGEXP_MODE,{className:"function",begin:ae,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:a.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:D}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:n.begin,end:n.end},{match:s},{begin:i.begin,"on:begin":i.isTrulyOpeningTag,end:i.end}],subLanguage:"xml",contains:[{begin:i.begin,end:i.end,skip:!0,contains:["self"]}]}]},ue,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+a.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[q,a.inherit(a.TITLE_MODE,{begin:t,className:"title.function"})]},{match:/\.\.\./,relevance:0},W,{match:"\\$"+t,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[q]},O,ge,Z,ee,{match:/\$[(.]/}]}}const dt="[A-Za-z$_][0-9A-Za-z$_]*",er=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends","using"],tr=["true","false","null","undefined","NaN","Infinity"],nr=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],rr=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],ar=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],sr=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],ir=[].concat(ar,nr,rr);function Js(a){const r=a.regex,e=(B,{after:I})=>{const j="</"+B[0].slice(1);return B.input.indexOf(j,I)!==-1},t=dt,n={begin:"<>",end:"</>"},s=/<[A-Za-z0-9\\._:-]+\s*\/>/,i={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(B,I)=>{const j=B[0].length+B.index,F=B.input[j];if(F==="<"||F===","){I.ignoreMatch();return}F===">"&&(e(B,{after:j})||I.ignoreMatch());let ce;const Ee=B.input.substring(j);if(ce=Ee.match(/^\s*=/)){I.ignoreMatch();return}if((ce=Ee.match(/^\s+extends\s+/))&&ce.index===0){I.ignoreMatch();return}}},o={$pattern:dt,keyword:er,literal:tr,built_in:ir,"variable.language":sr},l="[0-9](_?[0-9])*",c=`\\.(${l})`,u="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",p={className:"number",variants:[{begin:`(\\b(${u})((${c})|\\.)?|(${c}))[eE][+-]?(${l})\\b`},{begin:`\\b(${u})\\b((${c})\\b|\\.)?|(${c})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},h={className:"subst",begin:"\\$\\{",end:"\\}",keywords:o,contains:[]},f={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"xml"}},g={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"css"}},b={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[a.BACKSLASH_ESCAPE,h],subLanguage:"graphql"}},v={className:"string",begin:"`",end:"`",contains:[a.BACKSLASH_ESCAPE,h]},T={className:"comment",variants:[a.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:t+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),a.C_BLOCK_COMMENT_MODE,a.C_LINE_COMMENT_MODE]},w=[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,f,g,b,v,{match:/\$\d+/},p];h.contains=w.concat({begin:/\{/,end:/\}/,keywords:o,contains:["self"].concat(w)});const H=[].concat(T,h.contains),D=H.concat([{begin:/(\s*)\(/,end:/\)/,keywords:o,contains:["self"].concat(H)}]),q={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:D},Z={variants:[{match:[/class/,/\s+/,t,/\s+/,/extends/,/\s+/,r.concat(t,"(",r.concat(/\./,t),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,t],scope:{1:"keyword",3:"title.class"}}]},V={relevance:0,match:r.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...nr,...rr]}},ie={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},ue={variants:[{match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[q],illegal:/%/},ge={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function $(B){return r.concat("(?!",B.join("|"),")")}const O={match:r.concat(/\b/,$([...ar,"super","import"].map(B=>`${B}\\s*\\(`)),t,r.lookahead(/\s*\(/)),className:"title.function",relevance:0},W={begin:r.concat(/\./,r.lookahead(r.concat(t,/(?![0-9A-Za-z$_(])/))),end:t,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},ee={match:[/get|set/,/\s+/,t,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},q]},ae="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+a.UNDERSCORE_IDENT_RE+")\\s*=>",pe={match:[/const|var|let/,/\s+/,t,/\s*/,/=\s*/,/(async\s*)?/,r.lookahead(ae)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[q]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:o,exports:{PARAMS_CONTAINS:D,CLASS_REFERENCE:V},illegal:/#(?![$_A-z])/,contains:[a.SHEBANG({label:"shebang",binary:"node",relevance:5}),ie,a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,f,g,b,v,T,{match:/\$\d+/},p,V,{scope:"attr",match:t+r.lookahead(":"),relevance:0},pe,{begin:"("+a.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[T,a.REGEXP_MODE,{className:"function",begin:ae,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:a.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:D}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:n.begin,end:n.end},{match:s},{begin:i.begin,"on:begin":i.isTrulyOpeningTag,end:i.end}],subLanguage:"xml",contains:[{begin:i.begin,end:i.end,skip:!0,contains:["self"]}]}]},ue,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+a.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[q,a.inherit(a.TITLE_MODE,{begin:t,className:"title.function"})]},{match:/\.\.\./,relevance:0},W,{match:"\\$"+t,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[q]},O,ge,Z,ee,{match:/\$[(.]/}]}}function or(a){const r=a.regex,e=Js(a),t=dt,n=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],s={begin:[/namespace/,/\s+/,a.IDENT_RE],beginScope:{1:"keyword",3:"title.class"}},i={beginKeywords:"interface",end:/\{/,excludeEnd:!0,keywords:{keyword:"interface extends",built_in:n},contains:[e.exports.CLASS_REFERENCE]},o={className:"meta",relevance:10,begin:/^\s*['"]use strict['"]/},l=["type","interface","public","private","protected","implements","declare","abstract","readonly","enum","override","satisfies"],c={$pattern:dt,keyword:er.concat(l),literal:tr,built_in:ir.concat(n),"variable.language":sr},u={className:"meta",begin:"@"+t},p=(b,v,E)=>{const T=b.contains.findIndex(w=>w.label===v);if(T===-1)throw new Error("can not find mode to replace");b.contains.splice(T,1,E)};Object.assign(e.keywords,c),e.exports.PARAMS_CONTAINS.push(u);const h=e.contains.find(b=>b.scope==="attr"),f=Object.assign({},h,{match:r.concat(t,r.lookahead(/\s*\?:/))});e.exports.PARAMS_CONTAINS.push([e.exports.CLASS_REFERENCE,h,f]),e.contains=e.contains.concat([u,s,i,f]),p(e,"shebang",a.SHEBANG()),p(e,"use_strict",o);const g=e.contains.find(b=>b.label==="func.def");return g.relevance=0,Object.assign(e,{name:"TypeScript",aliases:["ts","tsx","mts","cts"]}),e}function lr(a){const r=a.regex,e=r.concat(/[\p{L}_]/u,r.optional(/[\p{L}0-9_.-]*:/u),/[\p{L}0-9_.-]*/u),t=/[\p{L}0-9._:-]+/u,n={className:"symbol",begin:/&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;/},s={begin:/\s/,contains:[{className:"keyword",begin:/#?[a-z_][a-z1-9_-]+/,illegal:/\n/}]},i=a.inherit(s,{begin:/\(/,end:/\)/}),o=a.inherit(a.APOS_STRING_MODE,{className:"string"}),l=a.inherit(a.QUOTE_STRING_MODE,{className:"string"}),c={endsWithParent:!0,illegal:/</,relevance:0,contains:[{className:"attr",begin:t,relevance:0},{begin:/=\s*/,relevance:0,contains:[{className:"string",endsParent:!0,variants:[{begin:/"/,end:/"/,contains:[n]},{begin:/'/,end:/'/,contains:[n]},{begin:/[^\s"'=<>`]+/}]}]}]};return{name:"HTML, XML",aliases:["html","xhtml","rss","atom","xjb","xsd","xsl","plist","wsf","svg"],case_insensitive:!0,unicodeRegex:!0,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,relevance:10,contains:[s,l,o,i,{begin:/\[/,end:/\]/,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,contains:[s,i,l,o]}]}]},a.COMMENT(/<!--/,/-->/,{relevance:10}),{begin:/<!\[CDATA\[/,end:/\]\]>/,relevance:10},n,{className:"meta",end:/\?>/,variants:[{begin:/<\?xml/,relevance:10,contains:[l]},{begin:/<\?[a-z][a-z0-9]+/}]},{className:"tag",begin:/<style(?=\s|>)/,end:/>/,keywords:{name:"style"},contains:[c],starts:{end:/<\/style>/,returnEnd:!0,subLanguage:["css","xml"]}},{className:"tag",begin:/<script(?=\s|>)/,end:/>/,keywords:{name:"script"},contains:[c],starts:{end:/<\/script>/,returnEnd:!0,subLanguage:["javascript","handlebars","xml"]}},{className:"tag",begin:/<>|<\/>/},{className:"tag",begin:r.concat(/</,r.lookahead(r.concat(e,r.either(/\/>/,/>/,/\s/)))),end:/\/?>/,contains:[{className:"name",begin:e,relevance:0,starts:c}]},{className:"tag",begin:r.concat(/<\//,r.lookahead(r.concat(e,/>/))),contains:[{className:"name",begin:e,relevance:0},{begin:/>/,relevance:0,endsParent:!0}]}]}}const Qs=a=>({IMPORTANT:{scope:"meta",begin:"!important"},BLOCK_COMMENT:a.C_BLOCK_COMMENT_MODE,HEXCOLOR:{scope:"number",begin:/#(([0-9a-fA-F]{3,4})|(([0-9a-fA-F]{2}){3,4}))\b/},FUNCTION_DISPATCH:{className:"built_in",begin:/[\w-]+(?=\()/},ATTRIBUTE_SELECTOR_MODE:{scope:"selector-attr",begin:/\[/,end:/\]/,illegal:"$",contains:[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE]},CSS_NUMBER_MODE:{scope:"number",begin:a.NUMBER_RE+"(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?",relevance:0},CSS_VARIABLE:{className:"attr",begin:/--[A-Za-z_][A-Za-z0-9_-]*/}}),ei=["a","abbr","address","article","aside","audio","b","blockquote","body","button","canvas","caption","cite","code","dd","del","details","dfn","div","dl","dt","em","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","html","i","iframe","img","input","ins","kbd","label","legend","li","main","mark","menu","nav","object","ol","optgroup","option","p","picture","q","quote","samp","section","select","source","span","strong","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","ul","var","video"],ti=["defs","g","marker","mask","pattern","svg","switch","symbol","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feFlood","feGaussianBlur","feImage","feMerge","feMorphology","feOffset","feSpecularLighting","feTile","feTurbulence","linearGradient","radialGradient","stop","circle","ellipse","image","line","path","polygon","polyline","rect","text","use","textPath","tspan","foreignObject","clipPath"],ni=[...ei,...ti],ri=["any-hover","any-pointer","aspect-ratio","color","color-gamut","color-index","device-aspect-ratio","device-height","device-width","display-mode","forced-colors","grid","height","hover","inverted-colors","monochrome","orientation","overflow-block","overflow-inline","pointer","prefers-color-scheme","prefers-contrast","prefers-reduced-motion","prefers-reduced-transparency","resolution","scan","scripting","update","width","min-width","max-width","min-height","max-height"].sort().reverse(),ai=["active","any-link","blank","checked","current","default","defined","dir","disabled","drop","empty","enabled","first","first-child","first-of-type","fullscreen","future","focus","focus-visible","focus-within","has","host","host-context","hover","indeterminate","in-range","invalid","is","lang","last-child","last-of-type","left","link","local-link","not","nth-child","nth-col","nth-last-child","nth-last-col","nth-last-of-type","nth-of-type","only-child","only-of-type","optional","out-of-range","past","placeholder-shown","read-only","read-write","required","right","root","scope","target","target-within","user-invalid","valid","visited","where"].sort().reverse(),si=["after","backdrop","before","cue","cue-region","first-letter","first-line","grammar-error","marker","part","placeholder","selection","slotted","spelling-error"].sort().reverse(),ii=["accent-color","align-content","align-items","align-self","alignment-baseline","all","anchor-name","animation","animation-composition","animation-delay","animation-direction","animation-duration","animation-fill-mode","animation-iteration-count","animation-name","animation-play-state","animation-range","animation-range-end","animation-range-start","animation-timeline","animation-timing-function","appearance","aspect-ratio","backdrop-filter","backface-visibility","background","background-attachment","background-blend-mode","background-clip","background-color","background-image","background-origin","background-position","background-position-x","background-position-y","background-repeat","background-size","baseline-shift","block-size","border","border-block","border-block-color","border-block-end","border-block-end-color","border-block-end-style","border-block-end-width","border-block-start","border-block-start-color","border-block-start-style","border-block-start-width","border-block-style","border-block-width","border-bottom","border-bottom-color","border-bottom-left-radius","border-bottom-right-radius","border-bottom-style","border-bottom-width","border-collapse","border-color","border-end-end-radius","border-end-start-radius","border-image","border-image-outset","border-image-repeat","border-image-slice","border-image-source","border-image-width","border-inline","border-inline-color","border-inline-end","border-inline-end-color","border-inline-end-style","border-inline-end-width","border-inline-start","border-inline-start-color","border-inline-start-style","border-inline-start-width","border-inline-style","border-inline-width","border-left","border-left-color","border-left-style","border-left-width","border-radius","border-right","border-right-color","border-right-style","border-right-width","border-spacing","border-start-end-radius","border-start-start-radius","border-style","border-top","border-top-color","border-top-left-radius","border-top-right-radius","border-top-style","border-top-width","border-width","bottom","box-align","box-decoration-break","box-direction","box-flex","box-flex-group","box-lines","box-ordinal-group","box-orient","box-pack","box-shadow","box-sizing","break-after","break-before","break-inside","caption-side","caret-color","clear","clip","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","color-scheme","column-count","column-fill","column-gap","column-rule","column-rule-color","column-rule-style","column-rule-width","column-span","column-width","columns","contain","contain-intrinsic-block-size","contain-intrinsic-height","contain-intrinsic-inline-size","contain-intrinsic-size","contain-intrinsic-width","container","container-name","container-type","content","content-visibility","counter-increment","counter-reset","counter-set","cue","cue-after","cue-before","cursor","cx","cy","direction","display","dominant-baseline","empty-cells","enable-background","field-sizing","fill","fill-opacity","fill-rule","filter","flex","flex-basis","flex-direction","flex-flow","flex-grow","flex-shrink","flex-wrap","float","flood-color","flood-opacity","flow","font","font-display","font-family","font-feature-settings","font-kerning","font-language-override","font-optical-sizing","font-palette","font-size","font-size-adjust","font-smooth","font-smoothing","font-stretch","font-style","font-synthesis","font-synthesis-position","font-synthesis-small-caps","font-synthesis-style","font-synthesis-weight","font-variant","font-variant-alternates","font-variant-caps","font-variant-east-asian","font-variant-emoji","font-variant-ligatures","font-variant-numeric","font-variant-position","font-variation-settings","font-weight","forced-color-adjust","gap","glyph-orientation-horizontal","glyph-orientation-vertical","grid","grid-area","grid-auto-columns","grid-auto-flow","grid-auto-rows","grid-column","grid-column-end","grid-column-start","grid-gap","grid-row","grid-row-end","grid-row-start","grid-template","grid-template-areas","grid-template-columns","grid-template-rows","hanging-punctuation","height","hyphenate-character","hyphenate-limit-chars","hyphens","icon","image-orientation","image-rendering","image-resolution","ime-mode","initial-letter","initial-letter-align","inline-size","inset","inset-area","inset-block","inset-block-end","inset-block-start","inset-inline","inset-inline-end","inset-inline-start","isolation","justify-content","justify-items","justify-self","kerning","left","letter-spacing","lighting-color","line-break","line-height","line-height-step","list-style","list-style-image","list-style-position","list-style-type","margin","margin-block","margin-block-end","margin-block-start","margin-bottom","margin-inline","margin-inline-end","margin-inline-start","margin-left","margin-right","margin-top","margin-trim","marker","marker-end","marker-mid","marker-start","marks","mask","mask-border","mask-border-mode","mask-border-outset","mask-border-repeat","mask-border-slice","mask-border-source","mask-border-width","mask-clip","mask-composite","mask-image","mask-mode","mask-origin","mask-position","mask-repeat","mask-size","mask-type","masonry-auto-flow","math-depth","math-shift","math-style","max-block-size","max-height","max-inline-size","max-width","min-block-size","min-height","min-inline-size","min-width","mix-blend-mode","nav-down","nav-index","nav-left","nav-right","nav-up","none","normal","object-fit","object-position","offset","offset-anchor","offset-distance","offset-path","offset-position","offset-rotate","opacity","order","orphans","outline","outline-color","outline-offset","outline-style","outline-width","overflow","overflow-anchor","overflow-block","overflow-clip-margin","overflow-inline","overflow-wrap","overflow-x","overflow-y","overlay","overscroll-behavior","overscroll-behavior-block","overscroll-behavior-inline","overscroll-behavior-x","overscroll-behavior-y","padding","padding-block","padding-block-end","padding-block-start","padding-bottom","padding-inline","padding-inline-end","padding-inline-start","padding-left","padding-right","padding-top","page","page-break-after","page-break-before","page-break-inside","paint-order","pause","pause-after","pause-before","perspective","perspective-origin","place-content","place-items","place-self","pointer-events","position","position-anchor","position-visibility","print-color-adjust","quotes","r","resize","rest","rest-after","rest-before","right","rotate","row-gap","ruby-align","ruby-position","scale","scroll-behavior","scroll-margin","scroll-margin-block","scroll-margin-block-end","scroll-margin-block-start","scroll-margin-bottom","scroll-margin-inline","scroll-margin-inline-end","scroll-margin-inline-start","scroll-margin-left","scroll-margin-right","scroll-margin-top","scroll-padding","scroll-padding-block","scroll-padding-block-end","scroll-padding-block-start","scroll-padding-bottom","scroll-padding-inline","scroll-padding-inline-end","scroll-padding-inline-start","scroll-padding-left","scroll-padding-right","scroll-padding-top","scroll-snap-align","scroll-snap-stop","scroll-snap-type","scroll-timeline","scroll-timeline-axis","scroll-timeline-name","scrollbar-color","scrollbar-gutter","scrollbar-width","shape-image-threshold","shape-margin","shape-outside","shape-rendering","speak","speak-as","src","stop-color","stop-opacity","stroke","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke-width","tab-size","table-layout","text-align","text-align-all","text-align-last","text-anchor","text-combine-upright","text-decoration","text-decoration-color","text-decoration-line","text-decoration-skip","text-decoration-skip-ink","text-decoration-style","text-decoration-thickness","text-emphasis","text-emphasis-color","text-emphasis-position","text-emphasis-style","text-indent","text-justify","text-orientation","text-overflow","text-rendering","text-shadow","text-size-adjust","text-transform","text-underline-offset","text-underline-position","text-wrap","text-wrap-mode","text-wrap-style","timeline-scope","top","touch-action","transform","transform-box","transform-origin","transform-style","transition","transition-behavior","transition-delay","transition-duration","transition-property","transition-timing-function","translate","unicode-bidi","user-modify","user-select","vector-effect","vertical-align","view-timeline","view-timeline-axis","view-timeline-inset","view-timeline-name","view-transition-name","visibility","voice-balance","voice-duration","voice-family","voice-pitch","voice-range","voice-rate","voice-stress","voice-volume","white-space","white-space-collapse","widows","width","will-change","word-break","word-spacing","word-wrap","writing-mode","x","y","z-index","zoom"].sort().reverse();function oi(a){const r=a.regex,e=Qs(a),t={begin:/-(webkit|moz|ms|o)-(?=[a-z])/},n="and or not only",s=/@-?\w[\w]*(-\w+)*/,i="[a-zA-Z-][a-zA-Z0-9_-]*",o=[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE];return{name:"CSS",case_insensitive:!0,illegal:/[=|'\$]/,keywords:{keyframePosition:"from to"},classNameAliases:{keyframePosition:"selector-tag"},contains:[e.BLOCK_COMMENT,t,e.CSS_NUMBER_MODE,{className:"selector-id",begin:/#[A-Za-z0-9_-]+/,relevance:0},{className:"selector-class",begin:"\\."+i,relevance:0},e.ATTRIBUTE_SELECTOR_MODE,{className:"selector-pseudo",variants:[{begin:":("+ai.join("|")+")"},{begin:":(:)?("+si.join("|")+")"}]},e.CSS_VARIABLE,{className:"attribute",begin:"\\b("+ii.join("|")+")\\b"},{begin:/:/,end:/[;}{]/,contains:[e.BLOCK_COMMENT,e.HEXCOLOR,e.IMPORTANT,e.CSS_NUMBER_MODE,...o,{begin:/(url|data-uri)\(/,end:/\)/,relevance:0,keywords:{built_in:"url data-uri"},contains:[...o,{className:"string",begin:/[^)]/,endsWithParent:!0,excludeEnd:!0}]},e.FUNCTION_DISPATCH]},{begin:r.lookahead(/@/),end:"[{;]",relevance:0,illegal:/:/,contains:[{className:"keyword",begin:s},{begin:/\s/,endsWithParent:!0,excludeEnd:!0,relevance:0,keywords:{$pattern:/[a-z-]+/,keyword:n,attribute:ri.join(" ")},contains:[{begin:/[a-z-]+(?=:)/,className:"attribute"},...o,e.CSS_NUMBER_MODE]}]},{className:"selector-tag",begin:"\\b("+ni.join("|")+")\\b"}]}}function li(a){const r=a.regex,e=new RegExp("[\\p{XID_Start}_]\\p{XID_Continue}*","u"),t=["and","as","assert","async","await","break","case","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","match","nonlocal|10","not","or","pass","raise","return","try","while","with","yield"],o={$pattern:/[A-Za-z]\w+|__\w+__/,keyword:t,built_in:["__import__","abs","all","any","ascii","bin","bool","breakpoint","bytearray","bytes","callable","chr","classmethod","compile","complex","delattr","dict","dir","divmod","enumerate","eval","exec","filter","float","format","frozenset","getattr","globals","hasattr","hash","help","hex","id","input","int","isinstance","issubclass","iter","len","list","locals","map","max","memoryview","min","next","object","oct","open","ord","pow","print","property","range","repr","reversed","round","set","setattr","slice","sorted","staticmethod","str","sum","super","tuple","type","vars","zip"],literal:["__debug__","Ellipsis","False","None","NotImplemented","True"],type:["Any","Callable","Coroutine","Dict","List","Literal","Generic","Optional","Sequence","Set","Tuple","Type","Union"]},l={className:"meta",begin:/^(>>>|\.\.\.) /},c={className:"subst",begin:/\{/,end:/\}/,keywords:o,illegal:/#/},u={begin:/\{\{/,relevance:0},p={className:"string",contains:[a.BACKSLASH_ESCAPE],variants:[{begin:/([uU]|[bB]|[rR]|[bB][rR]|[rR][bB])?'''/,end:/'''/,contains:[a.BACKSLASH_ESCAPE,l],relevance:10},{begin:/([uU]|[bB]|[rR]|[bB][rR]|[rR][bB])?"""/,end:/"""/,contains:[a.BACKSLASH_ESCAPE,l],relevance:10},{begin:/([fF][rR]|[rR][fF]|[fF])'''/,end:/'''/,contains:[a.BACKSLASH_ESCAPE,l,u,c]},{begin:/([fF][rR]|[rR][fF]|[fF])"""/,end:/"""/,contains:[a.BACKSLASH_ESCAPE,l,u,c]},{begin:/([uU]|[rR])'/,end:/'/,relevance:10},{begin:/([uU]|[rR])"/,end:/"/,relevance:10},{begin:/([bB]|[bB][rR]|[rR][bB])'/,end:/'/},{begin:/([bB]|[bB][rR]|[rR][bB])"/,end:/"/},{begin:/([fF][rR]|[rR][fF]|[fF])'/,end:/'/,contains:[a.BACKSLASH_ESCAPE,u,c]},{begin:/([fF][rR]|[rR][fF]|[fF])"/,end:/"/,contains:[a.BACKSLASH_ESCAPE,u,c]},a.APOS_STRING_MODE,a.QUOTE_STRING_MODE]},h="[0-9](_?[0-9])*",f=`(\\b(${h}))?\\.(${h})|\\b(${h})\\.`,g=`\\b|${t.join("|")}`,b={className:"number",relevance:0,variants:[{begin:`(\\b(${h})|(${f}))[eE][+-]?(${h})[jJ]?(?=${g})`},{begin:`(${f})[jJ]?`},{begin:`\\b([1-9](_?[0-9])*|0+(_?0)*)[lLjJ]?(?=${g})`},{begin:`\\b0[bB](_?[01])+[lL]?(?=${g})`},{begin:`\\b0[oO](_?[0-7])+[lL]?(?=${g})`},{begin:`\\b0[xX](_?[0-9a-fA-F])+[lL]?(?=${g})`},{begin:`\\b(${h})[jJ](?=${g})`}]},v={className:"comment",begin:r.lookahead(/# type:/),end:/$/,keywords:o,contains:[{begin:/# type:/},{begin:/#/,end:/\b\B/,endsWithParent:!0}]},E={className:"params",variants:[{className:"",begin:/\(\s*\)/,skip:!0},{begin:/\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:o,contains:["self",l,b,p,a.HASH_COMMENT_MODE]}]};return c.contains=[p,b,l],{name:"Python",aliases:["py","gyp","ipython"],unicodeRegex:!0,keywords:o,illegal:/(<\/|\?)|=>/,contains:[l,b,{scope:"variable.language",match:/\bself\b/},{beginKeywords:"if",relevance:0},{match:/\bor\b/,scope:"keyword"},p,v,a.HASH_COMMENT_MODE,{match:[/\bdef/,/\s+/,e],scope:{1:"keyword",3:"title.function"},contains:[E]},{variants:[{match:[/\bclass/,/\s+/,e,/\s*/,/\(\s*/,e,/\s*\)/]},{match:[/\bclass/,/\s+/,e]}],scope:{1:"keyword",3:"title.class",6:"title.class.inherited"}},{className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,E,p]}]}}function ci(a){const r={className:"attr",begin:/"(\\.|[^\\"\r\n])*"(?=\s*:)/,relevance:1.01},e={match:/[{}[\],:]/,className:"punctuation",relevance:0},t=["true","false","null"],n={scope:"literal",beginKeywords:t.join(" ")};return{name:"JSON",aliases:["jsonc"],keywords:{literal:t},contains:[r,e,a.QUOTE_STRING_MODE,n,a.C_NUMBER_MODE,a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE],illegal:"\\S"}}function cr(a){const r=a.regex,e={},t={begin:/\$\{/,end:/\}/,contains:["self",{begin:/:-/,contains:[e]}]};Object.assign(e,{className:"variable",variants:[{begin:r.concat(/\$[\w\d#@][\w\d_]*/,"(?![\\w\\d])(?![$])")},t]});const n={className:"subst",begin:/\$\(/,end:/\)/,contains:[a.BACKSLASH_ESCAPE]},s=a.inherit(a.COMMENT(),{match:[/(^|\s)/,/#.*$/],scope:{2:"comment"}}),i={begin:/<<-?\s*(?=\w+)/,starts:{contains:[a.END_SAME_AS_BEGIN({begin:/(\w+)/,end:/(\w+)/,className:"string"})]}},o={className:"string",begin:/"/,end:/"/,contains:[a.BACKSLASH_ESCAPE,e,n]};n.contains.push(o);const l={match:/\\"/},c={className:"string",begin:/'/,end:/'/},u={match:/\\'/},p={begin:/\$?\(\(/,end:/\)\)/,contains:[{begin:/\d+#[0-9a-f]+/,className:"number"},a.NUMBER_MODE,e]},h=["fish","bash","zsh","sh","csh","ksh","tcsh","dash","scsh"],f=a.SHEBANG({binary:`(${h.join("|")})`,relevance:10}),g={className:"function",begin:/\w[\w\d_]*\s*\(\s*\)\s*\{/,returnBegin:!0,contains:[a.inherit(a.TITLE_MODE,{begin:/\w[\w\d_]*/})],relevance:0},b=["if","then","else","elif","fi","time","for","while","until","in","do","done","case","esac","coproc","function","select"],v=["true","false"],E={match:/(\/[a-z._-]+)+/},T=["break","cd","continue","eval","exec","exit","export","getopts","hash","pwd","readonly","return","shift","test","times","trap","umask","unset"],w=["alias","bind","builtin","caller","command","declare","echo","enable","help","let","local","logout","mapfile","printf","read","readarray","source","sudo","type","typeset","ulimit","unalias"],H=["autoload","bg","bindkey","bye","cap","chdir","clone","comparguments","compcall","compctl","compdescribe","compfiles","compgroups","compquote","comptags","comptry","compvalues","dirs","disable","disown","echotc","echoti","emulate","fc","fg","float","functions","getcap","getln","history","integer","jobs","kill","limit","log","noglob","popd","print","pushd","pushln","rehash","sched","setcap","setopt","stat","suspend","ttyctl","unfunction","unhash","unlimit","unsetopt","vared","wait","whence","where","which","zcompile","zformat","zftp","zle","zmodload","zparseopts","zprof","zpty","zregexparse","zsocket","zstyle","ztcp"],D=["chcon","chgrp","chown","chmod","cp","dd","df","dir","dircolors","ln","ls","mkdir","mkfifo","mknod","mktemp","mv","realpath","rm","rmdir","shred","sync","touch","truncate","vdir","b2sum","base32","base64","cat","cksum","comm","csplit","cut","expand","fmt","fold","head","join","md5sum","nl","numfmt","od","paste","ptx","pr","sha1sum","sha224sum","sha256sum","sha384sum","sha512sum","shuf","sort","split","sum","tac","tail","tr","tsort","unexpand","uniq","wc","arch","basename","chroot","date","dirname","du","echo","env","expr","factor","groups","hostid","id","link","logname","nice","nohup","nproc","pathchk","pinky","printenv","printf","pwd","readlink","runcon","seq","sleep","stat","stdbuf","stty","tee","test","timeout","tty","uname","unlink","uptime","users","who","whoami","yes"];return{name:"Bash",aliases:["sh","zsh"],keywords:{$pattern:/\b[a-z][a-z0-9._-]+\b/,keyword:b,literal:v,built_in:[...T,...w,"set","shopt",...H,...D]},contains:[f,a.SHEBANG(),g,p,s,i,E,o,l,c,u,e]}}function dr(a){const r=a.regex,e={begin:/<\/?[A-Za-z_]/,end:">",subLanguage:"xml",relevance:0},t={begin:"^[-\\*]{3,}",end:"$"},n={className:"code",variants:[{begin:"(`{3,})[^`](.|\\n)*?\\1`*[ ]*"},{begin:"(~{3,})[^~](.|\\n)*?\\1~*[ ]*"},{begin:"```",end:"```+[ ]*$"},{begin:"~~~",end:"~~~+[ ]*$"},{begin:"`.+?`"},{begin:"(?=^( {4}|\\t))",contains:[{begin:"^( {4}|\\t)",end:"(\\n)$"}],relevance:0}]},s={className:"bullet",begin:"^[ 	]*([*+-]|(\\d+\\.))(?=\\s+)",end:"\\s+",excludeEnd:!0},i={begin:/^\[[^\n]+\]:/,returnBegin:!0,contains:[{className:"symbol",begin:/\[/,end:/\]/,excludeBegin:!0,excludeEnd:!0},{className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]},o=/[A-Za-z][A-Za-z0-9+.-]*/,l={variants:[{begin:/\[.+?\]\[.*?\]/,relevance:0},{begin:/\[.+?\]\(((data|javascript|mailto):|(?:http|ftp)s?:\/\/).*?\)/,relevance:2},{begin:r.concat(/\[.+?\]\(/,o,/:\/\/.*?\)/),relevance:2},{begin:/\[.+?\]\([./?&#].*?\)/,relevance:1},{begin:/\[.*?\]\(.*?\)/,relevance:0}],returnBegin:!0,contains:[{match:/\[(?=\])/},{className:"string",relevance:0,begin:"\\[",end:"\\]",excludeBegin:!0,returnEnd:!0},{className:"link",relevance:0,begin:"\\]\\(",end:"\\)",excludeBegin:!0,excludeEnd:!0},{className:"symbol",relevance:0,begin:"\\]\\[",end:"\\]",excludeBegin:!0,excludeEnd:!0}]},c={className:"strong",contains:[],variants:[{begin:/_{2}(?!\s)/,end:/_{2}/},{begin:/\*{2}(?!\s)/,end:/\*{2}/}]},u={className:"emphasis",contains:[],variants:[{begin:/\*(?![*\s])/,end:/\*/},{begin:/_(?![_\s])/,end:/_/,relevance:0}]},p=a.inherit(c,{contains:[]}),h=a.inherit(u,{contains:[]});c.contains.push(h),u.contains.push(p);let f=[e,l];return[c,u,p,h].forEach(E=>{E.contains=E.contains.concat(f)}),f=f.concat(c,u),{name:"Markdown",aliases:["md","mkdown","mkd"],contains:[{className:"section",variants:[{begin:"^#{1,6}",end:"$",contains:f},{begin:"(?=^.+?\\n[=-]{2,}$)",contains:[{begin:"^[=-]*$"},{begin:"^",end:"\\n",contains:f}]}]},e,s,c,u,{className:"quote",begin:"^>\\s+",contains:f,end:"$"},n,t,l,i,{scope:"literal",match:/&([a-zA-Z0-9]+|#[0-9]{1,7}|#[Xx][0-9a-fA-F]{1,6});/}]}}de.registerLanguage("javascript",Qn);de.registerLanguage("js",Qn);de.registerLanguage("typescript",or);de.registerLanguage("ts",or);de.registerLanguage("html",lr);de.registerLanguage("xml",lr);de.registerLanguage("css",oi);de.registerLanguage("python",li);de.registerLanguage("json",ci);de.registerLanguage("bash",cr);de.registerLanguage("shell",cr);de.registerLanguage("markdown",dr);de.registerLanguage("md",dr);G.setOptions({gfm:!0,breaks:!1});const ht=new G.Renderer;ht.heading=function({text:a,depth:r}){const e=a.toLowerCase().replace(/<[^>]+>/g,"").replace(/[^\w一-鿿]+/g,"-").replace(/^-|-$/g,"");return`<h${r} id="${e}">${a}</h${r}>`};function We(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}ht.code=function({text:a,lang:r}){if(r==="mermaid")return`<div class="mermaid">${a}</div>`;const e=r&&de.getLanguage(r);let t="";const n=e?`language-${r}`:"language-plaintext";if(e)try{t=de.highlight(a,{language:r}).value}catch{t=We(a)}else t=We(a);return`<div class="code-block-wrapper"><div class="code-block-header">${r?`<span class="code-lang-label">${We(r)}</span>`:""}<button class="code-copy-btn" onclick="navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('code').textContent).then(()=>{this.textContent='已复制';setTimeout(()=>{this.textContent='复制'},1500)})">复制</button></div><pre><code class="hljs ${n}">${t}</code></pre></div>`};ht.image=function({href:a,title:r,text:e}){let t;/^https?:\/\//.test(a)?t=a:t=`/images/${a.split("/").pop()||a}`;const n=r?` title="${We(r)}"`:"";return`<img src="${t}" alt="${We(e)}"${n}>`};G.use(qs());G.use({renderer:ht});function di(a){return G.parse(a)}class ui extends HTMLElement{constructor(){super(...arguments);y(this,"_toc",[]);y(this,"_activeId","");y(this,"_article",null);y(this,"_renderedHtml","");y(this,"_scrollHandler",null);y(this,"_headingOffsets",[])}connectedCallback(){const t=new URLSearchParams(window.location.search).get("slug")||window.location.hash.replace("#/","");this._article=Lt.find(n=>n.slug===t)||Lt[0]||null;try{this.render(),this._article&&(this._buildTOC(),this._cloneTOCToDrawer(),this._setupScrollTracking(),this._setupMobileDrawer())}catch(n){console.error("[uem-article] Error in connectedCallback:",n)}}disconnectedCallback(){this._scrollHandler&&window.removeEventListener("scroll",this._scrollHandler)}_buildTOC(){const e=this.querySelector("#article-toc-list");if(!e||!this._article)return;const t=this.querySelector("#article-body");t&&(this._toc=[],t.querySelectorAll("h2, h3").forEach(n=>{const s=n.getAttribute("id")||"";this._toc.push({id:s,text:n.textContent||"",level:n.tagName==="H2"?2:3})}),e.innerHTML=this._toc.map((n,s)=>{const i=n.level===3?"pl-4":"",o=s===0?"toc-active":"toc-inactive";return`
          <a href="#${n.id}"
             data-toc-id="${n.id}"
        ...
        </section>`;return}this._renderedHtml=di(this._article.content);const e=this._renderedHtml;this.innerHTML=`
    ...
    `,this._renderMermaid(),this._setupImageLightbox()}async _renderMermaid(){const e=this.querySelectorAll(".mermaid");if(e.length!==0)try{const{default:t}=await es(async()=>{const{default:n}=await import("./mermaid.core-dYyMsJdp.js").then(s=>s.aH);return{default:n}},[]);t.initialize({startOnLoad:!1,theme:document.documentElement.classList.contains("dark")?"dark":"default",securityLevel:"loose",fontFamily:"'Hanken Grotesk', sans-serif"}),await t.run({nodes:e})}catch(t){console.warn("[uem-article] mermaid render error:",t)}}_cloneTOCToDrawer(){const e=this.querySelector("#article-toc-list"),t=this.querySelector("#toc-drawer-list");e&&t&&(t.innerHTML=e.innerHTML)}_getStyles(){return`
      /* ── 文章正文排版 ── */
      .article-prose h2 {
    ...
    `}}customElements.define("uem-article",ui);class pi extends HTMLElement{connectedCallback(){this.render()}render(){const r=on.related.map(t=>`
        <li>
    ...
    `}}customElements.define("uem-footer",pi);class hi extends HTMLElement{constructor(){super(...arguments);y(this,"_clickCount",0);y(this,"_clickTimer",null);y(this,"_inputBuffer",[]);y(this,"_isActive",!1);y(this,"_clickHandler",null);y(this,"_keydownHandler",null)}connectedCallback(){this.setupStyles(),this.setupEventListeners(),console.log('[UEM-Stu] Win气泡彩蛋已加载。提示：连击 Logo 3次 或键盘输入 "win" 触发！')}disconnectedCallback(){this._clickHandler&&document.removeEventListener("click",this._clickHandler),this._keydownHandler&&window.removeEventListener("keydown",this._keydownHandler)}setupStyles(){const e=document.createElement("style");e.textContent=`
    ...
    `,this.appendChild(e)}setupEventListeners(){this._clickHandler=e=>{e.target.closest('uem-header img[alt="UEM-Stu Logo"]')&&this.handleLogoClick()},document.addEventListener("click",this._clickHandler),this._keydownHandler=e=>{const t=document.activeElement;t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)||e.key.length===1&&/[a-zA-Z]/.test(e.key)&&(this._inputBuffer.push(e.key.toLowerCase()),this._inputBuffer.length>5&&this._inputBuffer.shift(),this._inputBuffer.join("").endsWith("win")&&(this.triggerWinEasterEgg(),this._inputBuffer=[]))},window.addEventListener("keydown",this._keydownHandler)}handleLogoClick(){this._clickCount++,this._clickTimer&&window.clearTimeout(this._clickTimer),this._clickCount>=3?(this.triggerWinEasterEgg(),this._clickCount=0):this._clickTimer=window.setTimeout(()=>{this._clickCount=0},1500)}triggerWinEasterEgg(){if(this._isActive)return;this._isActive=!0,console.log("🚀 迎大(win)！冲鸭！全新交互彩蛋触发成功！"),window.scrollTo({top:0,behavior:"smooth"});const e=document.querySelector("uem-hero #hero-content-wrapper"),t=document.querySelector("uem-hero #hero-easter-egg-container");setTimeout(()=>{e&&(e.style.opacity="0",e.style.transform="translateY(-30px) scale(0.96)",e.style.pointerEvents="none")},150),setTimeout(()=>{this.spawnWinBubbles()},200),setTimeout(()=>{t&&(t.innerHTML=`
          <div 
            style="
              opacity: 0;
        ...
        `,t.style.opacity="1",t.style.transform="translateY(0)",requestAnimationFrame(()=>{const n=t.querySelector(".easter-egg-line1"),s=t.querySelector(".easter-egg-line2");n&&(n.style.opacity="1",n.style.transform="translateY(0)"),s&&(s.style.opacity="1",s.style.transform="translateY(0)")}))},1e3),setTimeout(()=>{this.restoreHero()},6e3)}spawnWinBubbles(){const t=document.createDocumentFragment(),n=[];for(let s=0;s<50;s++){const i=document.createElement("div");i.className="win-bubble-wrapper";const o=document.createElement("div"),l=Math.random()>.5?"bubble-right":"bubble-left";o.className=`win-bubble ${l}`,o.textContent="win";const c=Math.floor(Math.random()*53)+32;o.style.width=`${c}px`,o.style.height=`${c*.72}px`,o.style.fontSize=`${c*.32}px`;const u=Math.random()*90+5,p=Math.random()*80+10;i.style.left=`${u}vw`,i.style.top=`${p}vh`;const h=(Math.random()-.5)*90,f=-Math.random()*120-40;i.style.setProperty("--tx-end",`${h}px`),i.style.setProperty("--ty-end",`${f}px`);const g=Math.random()*1.6,b=Math.random()*.8+2.2;i.style.animation=`win-fly ${b}s cubic-bezier(0.16, 1, 0.3, 1) ${g}s forwards`,o.style.animation=`win-scale-fade ${b}s cubic-bezier(0.25, 1, 0.5, 1) ${g}s forwards`,i.appendChild(o),t.appendChild(i),n.push(i)}document.body.appendChild(t),setTimeout(()=>{n.forEach(s=>s.remove())},5500)}restoreHero(){const e=document.querySelector("uem-hero #hero-content-wrapper"),t=document.querySelector("uem-hero #hero-easter-egg-container");t&&(t.style.opacity="0",t.style.transform="translateY(12px)"),setTimeout(()=>{t&&(t.innerHTML=""),e&&(e.style.opacity="1",e.style.transform="translateY(0) scale(1)",e.style.pointerEvents="auto"),this._isActive=!1},1e3)}}customElements.define("uem-easter-egg",hi);if(typeof window<"u"){document.addEventListener("gesturestart",r=>{r.preventDefault()}),document.addEventListener("touchstart",r=>{r.touches.length>1&&r.preventDefault()},{passive:!1});let a=0;document.addEventListener("touchend",r=>{const e=Date.now();e-a<=300&&r.preventDefault(),a=e},{passive:!1})}export{es as _,Fs as g};
